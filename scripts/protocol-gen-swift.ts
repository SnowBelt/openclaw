...
const DEFAULTED_OPTIONAL_INIT_PARAM_ENTRIES: readonly [string, readonly string[]][] = [
  ...
  [
    "SessionsPatchParams",
    ["agentId", "category", "archived", "pinned", "expectedModelOverrideIsFallback"],
  ],
  ["PccProject", ["revision"]],
  ["PccMilestone", ["revision"]],
  ["PccSubMilestone", ["revision"]],
  ["PccPermissionGrant", ["revision"]],
  ["PccModelRunReceipt", ["milestoneId", "subMilestoneId", "effort", "usage"]],
  ["PccProjectAiUsageSummary", ["codexSharePercent", "recordingStartedAt"]],
  ["PccProjectsGetResult", ["aiUsage"]],
  ["PccProjectsUpsertParams", ["planningRunId", "expectedRevision"]],
  ["PccProjectPlanCommitParams", ["planningRunId"]],
  ["PccPlansGenerateParams", ["plannerMode"]],
  ["PccPlanningRun", ["queuePosition", "usage"]],
  ["PccPlansStartParams", ["plannerMode"]],
  ["PccExecutionGetParams", ["planId"]],
  ["PccExecutionControlParams", ["expectedRevision"]],
  ["PccAttachment", ["revision"]],
  ["PccAttachmentsUpdateParams", ["expectedRevision"]],
  ["PccAttachmentsClarifyResult", ["usage"]],
  ["PccMilestonesUpsertParams", ["expectedRevision"]],
  ["PccSubMilestonesUpsertParams", ["expectedRevision"]],
  ["PccPermissionsUpsertParams", ["expectedRevision"]],
  ["PccSummaryGetResult", ["privateTeamPolicy"]],
  ["PccChangedEvent", ["actor", "projectId", "recordId"]],
  ["PccPresenceEntry", ["projectId", "editing"]],
  ["PccPresenceUpdateParams", ["projectId", "editing"]],
  ...
  ["AgentSummary", ["role", "thinkingLevels", "thinkingOptions", "thinkingDefault"]],
