...
const loadSnesStudioBenchmarkHandlers = lazyHandlerModule(
  () => import("./server-methods/snes-studio-benchmark.js"),
  (module) => module.snesStudioBenchmarkHandlers,
);
const loadSelfImprovementHandlers = lazyHandlerModule(
  () => import("./server-methods/self-improvement.js"),
  (module) => module.selfImprovementHandlers,
);
...
export const coreGatewayHandlers: GatewayRequestHandlers = {
  ...
  ...createLazyCoreHandlers({
    ...
    loadHandlers: loadSnesStudioBenchmarkHandlers,
  }),
  ...createLazyCoreHandlers({
    methods: [
    ...
    loadHandlers: loadSelfImprovementHandlers,
  }),
  ...createLazyCoreHandlers({
  ...
  ...createLazyCoreHandlers({
    methods: [
      ...
      "pcc.execution.get",
      "pcc.execution.pause",
      "pcc.execution.resume",
      "pcc.execution.stop",
      "pcc.execution.review",
