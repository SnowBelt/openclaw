...
export type AgentsRuntimeStatusParams = SchemaType<"AgentsRuntimeStatusParams">;
export type AgentsRuntimeStatusResult = SchemaType<"AgentsRuntimeStatusResult">;
...
export type ProjectsListParams = SchemaType<"ProjectsListParams">;
export type ProjectsGetParams = SchemaType<"ProjectsGetParams">;
export type ProjectsCreateParams = SchemaType<"ProjectsCreateParams">;
export type ProjectsUpdateParams = SchemaType<"ProjectsUpdateParams">;
export type ProjectsDeleteParams = SchemaType<"ProjectsDeleteParams">;
export type ProjectsRestoreParams = SchemaType<"ProjectsRestoreParams">;
export type ProjectsResourcesListParams = SchemaType<"ProjectsResourcesListParams">;
export type ProjectsResourcesAddParams = SchemaType<"ProjectsResourcesAddParams">;
export type ProjectsResourcesUploadParams = SchemaType<"ProjectsResourcesUploadParams">;
export type ProjectsResourcesRemoveParams = SchemaType<"ProjectsResourcesRemoveParams">;
export type ProjectsResourcesReindexParams = SchemaType<"ProjectsResourcesReindexParams">;
export type ProjectsSessionsListParams = SchemaType<"ProjectsSessionsListParams">;
export type ProjectsSessionsAttachParams = SchemaType<"ProjectsSessionsAttachParams">;
export type ProjectsSessionsDetachParams = SchemaType<"ProjectsSessionsDetachParams">;
export type ProjectsContextPreviewParams = SchemaType<"ProjectsContextPreviewParams">;
