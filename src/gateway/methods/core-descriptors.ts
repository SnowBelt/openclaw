...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "operations.snapshot.v2", scope: "operator.read" },
  { name: "operations.action.preview", scope: "dynamic" },
  { name: "operations.action.apply", scope: "dynamic", controlPlaneWrite: true },
  { name: "kalshi.dashboard.snapshot", scope: "operator.read" },
  { name: "patternLab.dashboard.snapshot", scope: "operator.read" },
  { name: "patternLab.assets.approve", scope: "operator.approvals" },
  { name: "snes.benchmark.latest", scope: "operator.read" },
  { name: "snes.glm52.status", scope: "operator.read" },
  { name: "snes.mastery.status", scope: "operator.read" },
  { name: "snes.assetStudio.pipeline", scope: "operator.write" },
  { name: "snes.proof.run", scope: "operator.write" },
  { name: "snes.project.createBlank", scope: "operator.write" },
  { name: "snes.toolchain.status", scope: "operator.read" },
  { name: "snes.visual.artBible", scope: "operator.write" },
  { name: "snes.visual.artManifest", scope: "operator.write" },
  { name: "snes.visual.artSourcePack", scope: "operator.write" },
  { name: "snes.visual.compileArt", scope: "operator.write" },
  { name: "snes.visual.reject", scope: "operator.approvals" },
  { name: "snes.visual.captureProof", scope: "operator.write" },
  { name: "snes.visual.qualityAudit", scope: "operator.write" },
  { name: "snes.visual.runtimeAssetTruth", scope: "operator.write" },
  { name: "snes.visual.approve", scope: "operator.approvals" },
  { name: "snes.production.status", scope: "operator.read" },
  { name: "snes.production.continue", scope: "operator.write" },
  { name: "snes.production.auto", scope: "operator.write" },
  { name: "snes.production.pause", scope: "operator.write" },
  { name: "snes.production.resume", scope: "operator.write" },
  { name: "snes.production.cancel", scope: "operator.write" },
  { name: "snes.production.splitNext", scope: "operator.write" },
  { name: "snes.production.retryBlocked", scope: "operator.write" },
  { name: "snes.stanski.production.status", scope: "operator.read" },
  { name: "snes.stanski.production.continue", scope: "operator.write" },
  { name: "snes.stanski.production.auto", scope: "operator.write" },
  { name: "snes.stanski.production.pause", scope: "operator.write" },
  { name: "snes.stanski.production.resume", scope: "operator.write" },
  { name: "snes.stanski.production.cancel", scope: "operator.write" },
  { name: "snes.stanski.production.splitNext", scope: "operator.write" },
  { name: "snes.stanski.production.retryBlocked", scope: "operator.write" },
  ...
  { name: "pcc.overview.get", scope: "operator.read" },
  { name: "pcc.presence.list", scope: "operator.read" },
  { name: "pcc.presence.update", scope: "operator.write" },
  { name: "pcc.projects.get", scope: "operator.read" },
  { name: "pcc.plans.generate", scope: "operator.write" },
  { name: "pcc.plans.start", scope: "operator.write" },
  { name: "pcc.plans.get", scope: "operator.read" },
  { name: "pcc.plans.cancel", scope: "operator.write" },
  { name: "pcc.execution.start", scope: "operator.write" },
  { name: "pcc.execution.get", scope: "operator.read" },
  { name: "pcc.execution.pause", scope: "operator.write" },
  { name: "pcc.execution.resume", scope: "operator.write" },
  { name: "pcc.execution.stop", scope: "operator.write" },
  { name: "pcc.execution.review", scope: "operator.approvals" },
  { name: "pcc.attachments.upload.begin", scope: "operator.write" },
  { name: "pcc.attachments.upload.chunk", scope: "operator.write" },
  { name: "pcc.attachments.upload.commit", scope: "operator.write" },
  { name: "pcc.attachments.list", scope: "operator.read" },
  { name: "pcc.attachments.read", scope: "operator.read" },
  { name: "pcc.attachments.update", scope: "operator.write" },
  { name: "pcc.attachments.clarify", scope: "operator.write" },
  { name: "pcc.attachments.usage.record", scope: "operator.write" },
  { name: "pcc.attachments.usage.list", scope: "operator.read" },
  { name: "pcc.planningPolicy.get", scope: "operator.read" },
  { name: "pcc.planningPolicy.upsert", scope: "operator.write" },
  { name: "pcc.ledger.repairCanonicalMetadata", scope: "operator.write" },
  { name: "pcc.projects.upsert", scope: "operator.write" },
  { name: "pcc.projects.commitPlan", scope: "operator.write" },
  ...
  { name: "chat.turns.list", scope: "operator.read" },
  { name: "chat.turns.create", scope: "operator.write" },
  { name: "chat.turns.setMode", scope: "operator.write" },
  { name: "chat.turns.cancel", scope: "operator.write" },
  { name: "chat.turns.retry", scope: "operator.write" },
  { name: "executionState.get", scope: "operator.read" },
  ...
  { name: "taskFlows.pause", scope: "operator.write" },
  { name: "taskFlows.resume", scope: "operator.write" },
  { name: "taskFlows.edit", scope: "operator.write" },
  { name: "taskFlows.retry", scope: "operator.write" },
  { name: "taskFlows.stop", scope: "operator.write" },
  ...
  { name: "selfImprovement.health", scope: "operator.read" },
  { name: "selfImprovement.productionCheck", scope: "operator.read" },
  { name: "selfImprovement.recommendations.list", scope: "operator.read" },
  { name: "selfImprovement.recommendations.get", scope: "operator.read" },
  { name: "selfImprovement.proposals.list", scope: "operator.read" },
  { name: "selfImprovement.proposals.get", scope: "operator.read" },
  { name: "selfImprovement.curator.list", scope: "operator.read" },
  { name: "selfImprovement.curator.get", scope: "operator.read" },
  { name: "selfImprovement.proofReceipts.list", scope: "operator.read" },
  { name: "selfImprovement.scan", scope: "operator.write" },
  { name: "selfImprovement.controlDirector.layout.report", scope: "operator.write" },
  { name: "selfImprovement.dashboardInterventions.record", scope: "operator.write" },
  { name: "selfImprovement.maintenance.run", scope: "operator.write" },
  { name: "selfImprovement.models.preflight", scope: "operator.write" },
  { name: "selfImprovement.analysis.run", scope: "operator.write" },
  { name: "selfImprovement.evals.run", scope: "operator.write" },
  { name: "selfImprovement.groups.update", scope: "operator.write" },
  { name: "selfImprovement.recommendations.update", scope: "operator.write" },
  { name: "selfImprovement.proposals.update", scope: "operator.write" },
  { name: "selfImprovement.curator.update", scope: "operator.write" },
  { name: "selfImprovement.proofReceipts.record", scope: "operator.write" },
