...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "selfImprovement.productionCheck", scope: "operator.write" },
  ...
  { name: "selfImprovement.proposals.update", scope: "operator.approvals" },
  { name: "selfImprovement.curator.list", scope: "operator.read" },
  { name: "selfImprovement.curator.get", scope: "operator.read" },
  { name: "selfImprovement.curator.update", scope: "operator.approvals" },
