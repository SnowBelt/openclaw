...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list[].role": "Agent Operational Role",
  ...
  "models.catalogRefresh.enabled": "Refresh Model Catalog Automatically",
  "models.catalogRefresh.intervalMinutes": "Model Catalog Refresh Interval (minutes)",
  "models.routing": "Automatic Model Routing",
  "models.routing.preference": "Automatic Model Preference",
  "models.routing.automaticMetered": "Allow Metered Models Automatically",
  "models.routing.automaticUnknown": "Allow Unclassified Models Automatically",
  "models.routing.automaticMaxCostUsd": "Automatic Metered Attempt Cost Ceiling (USD)",
  "models.routing.automaticDailyMaxCostUsd": "Automatic Metered Daily Cost Ceiling (USD)",
  "models.routing.automaticProjectDailyMaxCostUsd":
    "Automatic Metered Project Daily Cost Ceiling (USD)",
  "models.routing.automaticProfiles": "Automatic Model Purpose Profiles",
  "models.routing.automaticProfiles.general": "General Automatic Models",
  "models.routing.automaticProfiles.vision": "Vision Automatic Models",
  "models.routing.automaticProfiles.coding": "Coding Automatic Models",
  "models.routing.automaticProfiles.reasoning": "Reasoning Automatic Models",
  "models.routing.automaticProfiles.scheduled": "Scheduled Automatic Models",
  "models.routing.automaticProfiles.maintenance": "Maintenance Automatic Models",
  "models.routing.requireCertifiedForAutomatic": "Require Certified Models Automatically",
  "models.routing.certifications": "Model Certification Receipts",
  "models.routing.certifications.*.state": "Model Certification State",
  "models.routing.certifications.*.verifiedAt": "Model Certification Verified At",
  "models.routing.certifications.*.evidence": "Model Certification Evidence",
  ...
  "models.providers.*.route": "Model Provider Route Facts",
  "models.providers.*.route.location": "Model Provider Location",
  "models.providers.*.route.billing": "Model Provider Billing",
  ...
  "models.providers.*.models[].route": "Model Route Facts",
  "models.providers.*.models[].route.location": "Model Location",
  "models.providers.*.models[].route.billing": "Model Billing",
