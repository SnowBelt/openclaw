...
const CUSTOM_RUNTIME_ADDITIONS: readonly CustomRuntimeAdditionInput[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      "test/scripts/custom-runtime-source-migrate.test.ts",
      "test/scripts/custom-runtime-retention-plan.test.ts",
      "test/scripts/custom-runtime-customization-inventory.test.ts",
      "test/scripts/custom-runtime-storage-inventory.test.ts",
      "src/gateway/server-methods/update.test.ts",
    ],
    proofSurfaces: [
      "pnpm check:custom-runtime-capabilities",
      "Update Durability Proof exact-SHA workflow",
      "PCC Update Safety dashboard status",
      "custom runtime customization, retention, and storage inventory hashes",
