...
const CUSTOM_RUNTIME_ADDITIONS: readonly CustomRuntimeAdditionInput[] = [
  ...
  { id: "plugin:codex", kind: "plugin", owner: "Codex plugin" },
  { id: "plugin:discord", kind: "plugin", owner: "Discord plugin" },
  { id: "plugin:ollama", kind: "plugin", owner: "Ollama plugin" },
  { id: "plugin:searxng", kind: "plugin", owner: "SearXNG plugin" },
  {
  ...
  },
  {
    ...
    tests: [
      ...
      "test/scripts/custom-runtime-baseline-certificate.test.ts",
      "test/scripts/custom-runtime-completeness.test.ts",
      ...
      "ui/src/components/update-banner.test.ts",
