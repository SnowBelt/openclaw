...
export const DEFAULT_SELF_IMPROVEMENT_PRIMARY_REVIEW_MODEL =
...
export function getSelfImprovementModelProfile(params: {
  ...
  if (
    modelId === DEFAULT_SELF_IMPROVEMENT_PRIMARY_REVIEW_MODEL ||
    modelId === "ollama/openclaw-control-gemma4-31b-q8"
  ) {
    return {
      ...base,
      local: true,
