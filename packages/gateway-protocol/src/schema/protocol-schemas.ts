...
export const ProtocolSchemas = {
  ...
  ControlDirectorLayoutObservationReportParams: asPublicSchema(
    SelfImprovementProtocol.ControlDirectorLayoutObservationReportParamsSchema,
  ),
  ControlDirectorLayoutObservationReportResult: asPublicSchema(
  ...
  ChatTurnMode: ChatTurnModeSchema,
  ControlDirectorRuntimeCanary: ControlDirectorRuntimeCanarySchema,
  ControlDirectorMemoryHealth: ControlDirectorMemoryHealthSchema,
  ControlDirectorRuntimeLineage: ControlDirectorRuntimeLineageSchema,
  ChatTurnPhase: ChatTurnPhaseSchema,
  ChatTurnSummary: ChatTurnSummarySchema,
  ChatTurnsListParams: ChatTurnsListParamsSchema,
  ChatTurnsListResult: ChatTurnsListResultSchema,
  ChatTurnsCreateParams: ChatTurnsCreateParamsSchema,
  ChatTurnsCreateResult: ChatTurnsCreateResultSchema,
  ChatTurnsSetModeParams: ChatTurnsSetModeParamsSchema,
  ChatTurnsCancelParams: ChatTurnsCancelParamsSchema,
  ChatTurnsRetryParams: ChatTurnsRetryParamsSchema,
  ChatTurnMutationResult: ChatTurnMutationResultSchema,
  ExecutionEvent: ExecutionEventSchema,
  ExecutionStateGetParams: ExecutionStateGetParamsSchema,
  ExecutionStateHealth: ExecutionStateHealthSchema,
  ExecutionStateSnapshot: ExecutionStateSnapshotSchema,
  PursueGoalLease: PursueGoalLeaseSchema,
  PursueGoalJudgeReceipt: PursueGoalJudgeReceiptSchema,
  ...
  TaskFlowsPauseParams: TaskFlowsPauseParamsSchema,
  TaskFlowsResumeParams: TaskFlowsResumeParamsSchema,
  TaskFlowsEditParams: TaskFlowsEditParamsSchema,
  TaskFlowsRetryParams: TaskFlowsRetryParamsSchema,
  TaskFlowsStopParams: TaskFlowsStopParamsSchema,
  TaskFlowMutationResult: TaskFlowMutationResultSchema,
  ...
  PccProjectPlanCommitParams: PccProjectPlanCommitParamsSchema,
  PccProjectPlanCommitResult: PccProjectPlanCommitResultSchema,
  PccPlansGenerateParams: PccPlansGenerateParamsSchema,
  PccPlansGenerateResult: PccPlansGenerateResultSchema,
  PccPlanningRun: PccPlanningRunSchema,
  PccPlansStartParams: PccPlansStartParamsSchema,
  PccPlansStartResult: PccPlansStartResultSchema,
  PccPlansGetParams: PccPlansGetParamsSchema,
  PccPlansGetResult: PccPlansGetResultSchema,
  PccPlansCancelParams: PccPlansCancelParamsSchema,
  PccPlansCancelResult: PccPlansCancelResultSchema,
  PccExecutionStartParams: PccExecutionStartParamsSchema,
  PccExecutionStartResult: PccExecutionStartResultSchema,
  PccExecutionGetParams: PccExecutionGetParamsSchema,
  PccExecutionGetResult: PccExecutionGetResultSchema,
  PccExecutionControlParams: PccExecutionControlParamsSchema,
  PccExecutionReviewParams: PccExecutionReviewParamsSchema,
  PccExecutionPauseResult: PccExecutionPauseResultSchema,
  PccExecutionResumeResult: PccExecutionResumeResultSchema,
  PccExecutionStopResult: PccExecutionStopResultSchema,
  PccExecutionReviewResult: PccExecutionReviewResultSchema,
  PccAttachment: PccAttachmentSchema,
  PccAttachmentUsageReceipt: PccAttachmentUsageReceiptSchema,
  PccAttachmentsUploadBeginParams: PccAttachmentsUploadBeginParamsSchema,
  PccAttachmentsUploadBeginResult: PccAttachmentsUploadBeginResultSchema,
  PccAttachmentsUploadChunkParams: PccAttachmentsUploadChunkParamsSchema,
  PccAttachmentsUploadChunkResult: PccAttachmentsUploadChunkResultSchema,
  PccAttachmentsUploadCommitParams: PccAttachmentsUploadCommitParamsSchema,
  PccAttachmentsUploadCommitResult: PccAttachmentsUploadCommitResultSchema,
  PccAttachmentsListParams: PccAttachmentsListParamsSchema,
  PccAttachmentsListResult: PccAttachmentsListResultSchema,
  PccAttachmentsReadParams: PccAttachmentsReadParamsSchema,
  PccAttachmentsReadResult: PccAttachmentsReadResultSchema,
  PccAttachmentsUpdateParams: PccAttachmentsUpdateParamsSchema,
  PccAttachmentsUpdateResult: PccAttachmentsUpdateResultSchema,
  PccAttachmentsClarifyParams: PccAttachmentsClarifyParamsSchema,
  PccAttachmentsClarifyResult: PccAttachmentsClarifyResultSchema,
  PccAttachmentUsageRecordParams: PccAttachmentUsageRecordParamsSchema,
  PccAttachmentUsageRecordResult: PccAttachmentUsageRecordResultSchema,
  PccAttachmentUsageListParams: PccAttachmentUsageListParamsSchema,
  PccAttachmentUsageListResult: PccAttachmentUsageListResultSchema,
  PccPlanningPolicyGetParams: PccPlanningPolicyGetParamsSchema,
  ...
  PccOverviewGetParams: PccOverviewGetParamsSchema,
  PccOverviewGetResult: PccOverviewGetResultSchema,
  PccChangedEvent: PccChangedEventSchema,
  PccPresenceEntry: PccPresenceEntrySchema,
  PccPresenceUpdateParams: PccPresenceUpdateParamsSchema,
  PccPresenceUpdateResult: PccPresenceUpdateResultSchema,
  PccPresenceListParams: PccPresenceListParamsSchema,
  PccPresenceListResult: PccPresenceListResultSchema,
