      ...
      Type.Object(
        {
          ...
          runtimeGuardConfigured: Type.Boolean(),
          approvalPending: Type.Boolean(),
          pendingCandidateSha: Type.Union([Type.String(), Type.Null()]),
          preparationRunning: Type.Boolean(),
          preparationStatus: Type.Union([
            Type.Literal("blocked"),
            Type.Literal("idle"),
            Type.Literal("preparing"),
            Type.Literal("ready"),
          ...
          preparationReason: Type.Union([Type.String(), Type.Null()]),
          ...
          blockerCodes: Type.Optional(StringListSchema),
          recommendedAction: Type.Optional(Type.String({ maxLength: 1_000 })),
        },
        { additionalProperties: false },
      ),
    ),
