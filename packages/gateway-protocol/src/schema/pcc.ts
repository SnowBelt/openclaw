      ...
      Type.Object(
        {
            ...
            Type.Object(
              {
                mode: Type.Union([
                  ...
                  Type.Literal("external_encrypted"),
                ]),
                localStatus: Type.Union([
                  Type.Literal("unconfigured"),
                  Type.Literal("offline"),
                  Type.Literal("locked"),
                  Type.Literal("ready"),
                ...
                installationReady: Type.Boolean(),
                blockingReasons: StringListSchema,
                advisories: StringListSchema,
              },
              { additionalProperties: false },
            ),
          ),
          brokerConfigured: Type.Boolean(),
          runtimeGuardConfigured: Type.Optional(Type.Boolean()),
          approvalPending: Type.Boolean(),
          pendingCandidateSha: Type.Optional(Type.Union([Type.String(), Type.Null()])),
          preparationRunning: Type.Optional(Type.Boolean()),
          preparationStatus: Type.Optional(
            Type.Union([
              Type.Literal("blocked"),
              Type.Literal("idle"),
              Type.Literal("preparing"),
          ...
          preparationReason: Type.Optional(Type.Union([Type.String(), Type.Null()])),
          ...
          advisories: Type.Optional(StringListSchema),
        },
        { additionalProperties: false },
      ),
    ),
