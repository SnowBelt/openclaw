...
export type ChatTurnMode = SchemaType<"ChatTurnMode">;
export type ChatTurnPhase = SchemaType<"ChatTurnPhase">;
export type ChatTurnSummary = SchemaType<"ChatTurnSummary">;
export type ChatTurnsListParams = SchemaType<"ChatTurnsListParams">;
export type ChatTurnsListResult = SchemaType<"ChatTurnsListResult">;
export type ChatTurnsCreateParams = SchemaType<"ChatTurnsCreateParams">;
export type ChatTurnsCreateResult = SchemaType<"ChatTurnsCreateResult">;
export type ChatTurnsSetModeParams = SchemaType<"ChatTurnsSetModeParams">;
export type ChatTurnsCancelParams = SchemaType<"ChatTurnsCancelParams">;
export type ChatTurnsRetryParams = SchemaType<"ChatTurnsRetryParams">;
export type ChatTurnMutationResult = SchemaType<"ChatTurnMutationResult">;
export type TaskFlowStatus = SchemaType<"TaskFlowStatus">;
export type ExecutionEvent = SchemaType<"ExecutionEvent">;
export type ExecutionStateGetParams = SchemaType<"ExecutionStateGetParams">;
export type ExecutionStateHealth = SchemaType<"ExecutionStateHealth">;
export type ControlDirectorMemoryHealth = SchemaType<"ControlDirectorMemoryHealth">;
export type ControlDirectorRuntimeCanary = SchemaType<"ControlDirectorRuntimeCanary">;
export type ControlDirectorRuntimeLineage = SchemaType<"ControlDirectorRuntimeLineage">;
export type ExecutionStateSnapshot = SchemaType<"ExecutionStateSnapshot">;
export type PursueGoalLease = SchemaType<"PursueGoalLease">;
export type PursueGoalJudgeReceipt = SchemaType<"PursueGoalJudgeReceipt">;
...
export type TaskFlowsPauseParams = SchemaType<"TaskFlowsPauseParams">;
export type TaskFlowsResumeParams = SchemaType<"TaskFlowsResumeParams">;
export type TaskFlowsEditParams = SchemaType<"TaskFlowsEditParams">;
export type TaskFlowsRetryParams = SchemaType<"TaskFlowsRetryParams">;
export type TaskFlowsStopParams = SchemaType<"TaskFlowsStopParams">;
export type TaskFlowMutationResult = SchemaType<"TaskFlowMutationResult">;
...
export type PccPlansStartParams = SchemaType<"PccPlansStartParams">;
export type PccPlansStartResult = SchemaType<"PccPlansStartResult">;
export type PccPlansGetParams = SchemaType<"PccPlansGetParams">;
export type PccPlansGetResult = SchemaType<"PccPlansGetResult">;
export type PccPlansCancelParams = SchemaType<"PccPlansCancelParams">;
export type PccPlansCancelResult = SchemaType<"PccPlansCancelResult">;
export type PccExecutionStartParams = SchemaType<"PccExecutionStartParams">;
export type PccExecutionStartResult = SchemaType<"PccExecutionStartResult">;
export type PccExecutionGetParams = SchemaType<"PccExecutionGetParams">;
export type PccExecutionGetResult = SchemaType<"PccExecutionGetResult">;
export type PccExecutionControlParams = SchemaType<"PccExecutionControlParams">;
export type PccExecutionReviewParams = SchemaType<"PccExecutionReviewParams">;
export type PccExecutionPauseResult = SchemaType<"PccExecutionPauseResult">;
export type PccExecutionResumeResult = SchemaType<"PccExecutionResumeResult">;
export type PccExecutionStopResult = SchemaType<"PccExecutionStopResult">;
export type PccExecutionReviewResult = SchemaType<"PccExecutionReviewResult">;
export type PccAttachment = SchemaType<"PccAttachment">;
export type PccAttachmentUsageReceipt = SchemaType<"PccAttachmentUsageReceipt">;
export type PccAttachmentsUploadBeginParams = SchemaType<"PccAttachmentsUploadBeginParams">;
export type PccAttachmentsUploadBeginResult = SchemaType<"PccAttachmentsUploadBeginResult">;
export type PccAttachmentsUploadChunkParams = SchemaType<"PccAttachmentsUploadChunkParams">;
export type PccAttachmentsUploadChunkResult = SchemaType<"PccAttachmentsUploadChunkResult">;
export type PccAttachmentsUploadCommitParams = SchemaType<"PccAttachmentsUploadCommitParams">;
export type PccAttachmentsUploadCommitResult = SchemaType<"PccAttachmentsUploadCommitResult">;
export type PccAttachmentsListParams = SchemaType<"PccAttachmentsListParams">;
export type PccAttachmentsListResult = SchemaType<"PccAttachmentsListResult">;
export type PccAttachmentsReadParams = SchemaType<"PccAttachmentsReadParams">;
export type PccAttachmentsReadResult = SchemaType<"PccAttachmentsReadResult">;
export type PccAttachmentsUpdateParams = SchemaType<"PccAttachmentsUpdateParams">;
export type PccAttachmentsUpdateResult = SchemaType<"PccAttachmentsUpdateResult">;
export type PccAttachmentsClarifyParams = SchemaType<"PccAttachmentsClarifyParams">;
export type PccAttachmentsClarifyResult = SchemaType<"PccAttachmentsClarifyResult">;
export type PccAttachmentUsageRecordParams = SchemaType<"PccAttachmentUsageRecordParams">;
export type PccAttachmentUsageRecordResult = SchemaType<"PccAttachmentUsageRecordResult">;
export type PccAttachmentUsageListParams = SchemaType<"PccAttachmentUsageListParams">;
export type PccAttachmentUsageListResult = SchemaType<"PccAttachmentUsageListResult">;
export type PccPlanningPolicyGetParams = SchemaType<"PccPlanningPolicyGetParams">;
export type PccPlanningPolicyGetResult = SchemaType<"PccPlanningPolicyGetResult">;
export type PccPlanningPolicyUpsertParams = SchemaType<"PccPlanningPolicyUpsertParams">;
export type PccPlanningPolicyUpsertResult = SchemaType<"PccPlanningPolicyUpsertResult">;
