...
export function createStanskiLevelOneProductionState(
  ...
  const definitionOfDone: SnesStanskiLevelOneChecklistItem[] = [
    ...
    },
    {
      ...
      proof:
        "Receipt goblin starts after the tutorial gap with a slow wind-up and a flat approach.",
      status: "implemented",
    },
    {
      id: "power-up-pacing",
    ...
    },
    {
      ...
      proof:
        "Bridge checkpoint and upper awning secret route are in the deterministic object list.",
      status: "implemented",
    },
    {
      id: "toilet-ending",
  ...
  const sections: SnesStanskiLevelOneSection[] = [
    ...
    },
    {
      ...
      qaExpectation:
        "Bad-breath projectile can defeat the required enemy before the restroom route.",
  ...
  const replayScript: SnesStanskiLevelOneReplayStep[] = [
    ...
    },
    {
      durationFrames: 240,
      expected:
        "Todd reaches toilet, sits, reads newspaper, drops two poops, and fireworks continue.",
      id: "toilet-ending",
      input: ["right", "run"],
      startFrame: 750,
    },
...
export function validateSnesStudioProject(input: SnesStudioProject): SnesValidationIssue[] {
  const project = normalizeSnesStudioProject(input);
