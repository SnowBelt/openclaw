      ...
      <section class="kalshi-routing-strip" aria-label="STS routing controls">
        ...
        <div class="kalshi-grid kalshi-grid--three">
          ...
          ${metricCard(
            ...
            stsWeatherCryptoReallocation != null && stsWeatherCryptoReallocation > 1
              ? "ok"
              : "warn",
          )}
          ${metricCard(
        ...
        <div class="kalshi-grid kalshi-grid--cards">
          ...
          ${metricCard(
            ...
            stsLearningAccelerationEnabled && stsWeatherCryptoBoost && stsWeatherCryptoBoost > 1
              ? `Decay-adjusted backtest boost: +${(stsWeatherCryptoBoost - 1) * 100 + 1e-9 < 1 ? "small" : ((stsWeatherCryptoBoost - 1) * 100).toFixed(0)}% route weight.`
          ...
          ${metricCard(
            ...
            stsWeatherCryptoRawBoost && stsWeatherCryptoRawBoost > 1
              ? `Raw domain evidence suggests ${(stsWeatherCryptoRawBoost - 1) * 100 + 1e-9 < 1 ? "small" : ((stsWeatherCryptoRawBoost - 1) * 100).toFixed(0)}%.`
          ...
          ${metricCard(
            ...
            stsRegimeDecayBest && stsRegimeDecayWorst
              ? `Most conservative guard: ${(performanceNumber(stsRegimeDecayBest[1]?.decay_factor) ?? 0) * 100}%. Most favorable: ${(performanceNumber(stsRegimeDecayWorst[1]?.decay_factor) ?? 0) * 100}%.`
          ...
          ${metricCard(
            ...
            stsLearningVelocityMultiplier != null && stsLearningVelocityMultiplier > 1
              ? "ok"
