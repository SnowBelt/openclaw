        ...
        ${state.tab === "pcc"
          ? renderLazyView(lazyPcc, (m) =>
              m.renderPccDashboard({
                ...
                overview: state.pccOverview,
                presence: state.pccPresence,
                surface: state.pccSurface,
                favorites: state.pccFavorites,
                recentProjectIds: state.pccRecentProjectIds,
                attentionRecordId: state.pccAttentionRecordId,
                ...
                decisionFormOpen: state.pccDecisionFormOpen,
                decisionForm: state.pccDecisionForm,
                ...
                onSetSurface: (surface) => updatePccSurface(state, surface),
                onToggleFavorite: (projectId) => togglePccFavorite(state, projectId),
                onOpenAttention: (projectId, recordId) =>
                  void openPccAttention(state, projectId, recordId),
                ...
                onOpenDecisionForm: () => openPccDecisionForm(state),
                onDecisionFormChange: (patch) => updatePccDecisionForm(state, patch),
                onSaveDecision: () => void savePccDecision(state),
                onCancelDecisionForm: () => cancelPccDecisionForm(state),
                ...
                onConfigureAutopilotMode: (mode) => void configurePccAutopilotLoopMode(state, mode),
                onGenerateAutopilotPrompts: () => void generatePccAutopilotLoopPrompts(state),
