...
export const ja_JP: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "OpenClaw コントロールプレーン",
    title: "オペレーションズルーム",
    subtitle: "注意が必要な項目、正常に動作している項目、およびシステムの稼働状況。",
    refresh: "更新",
    refreshing: "更新中…",
    refreshLabel: "オペレーションズルームを更新",
    updated: "更新済み {time}",
    live: "ライブ",
    stale: "最終既知の情報",
    partial: "部分的なデータ",
    unavailableTitle: "運用データが利用できません",
    actionFailedTitle: "アクションが完了しませんでした",
    staleTitle: "ライブ更新に失敗しました",
    staleDetail: "{time} の最後の正常なスナップショットを表示しています。",
    unavailableSources: "利用できないソース: {sources}。",
    fallbackSources: "フォールバックデータソース: {sources}。",
    loading: "現在の運用状況の構築中…",
    empty: "まだ運用スナップショットが利用できません。",
    now: "現在",
    briefingUnavailable:
      "現在の概要を確認できません。以下のソース固有のステータスをご確認ください。",
    lastKnownBriefing: "最終既知の概要を表示",
    briefingTone: {
      normal: "最新情報",
      attention: "注意が必要",
      urgent: "緊急",
    ...
    reviewUnconfirmed: "レビュー —",
    decisionCount: "{count}件の決定が必要",
    decisionsUnconfirmed: "決定が必要 —",
    workingCount: "現在稼働中 {count}",
    workingCountBounded: "現在稼働中 {count}+",
    workingUnconfirmed: "現在稼働中 —",
    agentsWorkingNowCount: "現在作業中のエージェント {count}",
    agentsWorkingUnconfirmed: "現在作業中のエージェント —",
    openClawWorkCount: "OpenClaw の作業 {count}",
    openClawWorkUnconfirmed: "OpenClaw の作業 —",
    allAgentsCount: "すべてのエージェント {count}",
    agentsUnconfirmed: "すべてのエージェント —",
    agentsCount: "{count}件のエージェント",
    urgentCount: "{count}件の緊急",
    activeAgentsCount: "アクティブなエージェント: {count}",
    workingItemsCount: "作業中アイテム: {count}",
    showingAgents: "{count}件を表示中",
    attentionAgentsCount: "{count}件の注意が必要",
    agentStatusSummary: "{working}件作業中 · {attention}件注意が必要",
    automationCount: "スケジュール: {total} · 失敗: {failing}",
    automations: "自動化",
    system: "システム",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "レビューが必要です",
      title: "注意",
      subtitle: "現在の問題が優先されます。過去のイベントは「もっと見る」に残ります。",
      needsYou: "対応が必要",
      handling: "OpenClaw が処理中",
      watching: "監視中",
      none: "注意を必要とする事項はありません。",
      noCritical: "重大な問題は発生していません。",
      currentCount: "{count} 件の現在問題",
      noneNeedsYou: "保留中の決定や介入はありません。",
      noneHandling: "進行中のアクティブな修復処理はありません。",
      noneWatching: "監視対象はありません。",
      impact: "影響",
      owner: "担当者",
      you: "あなた",
      unassignedOwner: "未割り当て",
      response: "対応状況",
      nextAction: "次のアクション",
      nextActionShort: "次へ",
      highestPriority: "最優先課題",
      whoOwnsThis: "担当者",
      whatHappensNext: "次のステップ",
      continueMonitoring: "監視を続行します。",
      observed: "{time} に観測",
      lastKnown: "最終確認時",
      unconfirmedTitle: "注意ステータスの確認ができません",
      unconfirmedDetail:
        "既知の問題は以下に表示されますが、不完全または最終確認済みのデータでは、新しい問題が含まれていない場合があります。",
      unconfirmedShort: "確認が必要です",
      showingCurrent:
        "この限定スナップショット内の現在の {total} 件の問題のうち {shown} 件を表示しています。ソースビューで関連レコードを確認できます。",
      outsidePreview:
        "現在の {count} 件の問題は、このプレビューの範囲外です。上記のソースビューを開いてください。",
      lastProgress: "最終進捗状況",
      nextCheck: "次回チェック",
      remediationTask: "是正タスク",
      openRemediation: "是正を開く",
      responseStates: {
        unassigned: "未割り当て",
        in_progress: "進行中",
        monitoring: "監視中",
        waiting_for_user: "ユーザーの操作を待機中",
        resolved: "解決済み",
      },
    },
    resolution: {
      ...
      resolveFor: "{title} の推奨される解決策を確認する",
      previewOnly: "推奨のみ。",
      previewOnlyDetail: "適切な修復が承認されるまで、変更は行われません。",
      closePreview: "今はしない",
      notNow: "今はしない",
      recommendedLabel: "推奨される修正:",
      recommendedFix: "推奨される修正",
      whyRecommended: "推奨される理由",
      defaultReason:
        "これは、現在利用可能な証拠によってサポートされている最も安全な次のステップです。",
      confidence: "信頼度",
      confidencePending: "ローカル調査待ち",
      confidenceValue: "{confidence}% の信頼度",
      whatHappened: "発生した事象",
      progress: "進捗状況",
      risk: "問題のリスク",
      changePreview: "変更される内容",
      verification: "OpenClaw が検証する方法",
      verificationPending: "自動変更を実行する前に、決定論的な検証計画が必要です。",
      approval: "承認",
      evidence: "進捗状況の更新",
      localReview: "ローカルレビュー ({confidence}%): {recommendation}",
      judgeReview: "独立した安全性レビュー: {decision} — {reason}",
      approved: "承認済み",
      rejected: "却下済み",
      rollback: "ロールバック計画",
      undoAvailability: "元に戻す機能の有効性",
      undoAvailable: "保護付きプレビューで利用可能",
      undoUnavailable: "直接の元に戻す機能は利用できません",
      viewRepairDetails: "修復の詳細を表示",
      result: "結果",
      undo: "この修復を元に戻す",
      investigate: "ローカル AI で調査",
      reviewEscalation: "Codex でレビュー",
      reviewCancellation: "キャンセルの確認",
      fixThis: "これを修正する",
      investigationPreview:
        "まだ変更はありません。確認して送信するための読み取り専用の調査ドラフトが開きます。",
      cancelPreview: "「{title}」をキャンセルするための保護されたプレビューを準備します。",
      approvalRequired: "変更が実行される前に、すべての変更を承認する必要があります。",
      oneConfirmation:
        "これはレビュー済みで元に戻せる中リスクの修復であるため、簡潔な確認が1回必要です。",
      automaticPolicy:
        "OpenClaw は、この承認済みの修復が範囲限定かつ可逆的であるため、自動的に実行する場合があります。",
      evidenceLocation:
        "進捗状況と証拠は、このイシュー、「前回の訪問以降」セクション、および Workboard に表示されます。",
      investigationRollback:
        "調査は変更を行わないため、現時点では不要です。提案される修正にはロールバック計画を含める必要があります。",
      cancelRollback:
        "キャンセルでは完了した作業を元に戻すことはできません。承認する前に変更プレビューを必ず確認してください。",
      progressLocationLabel: "進捗状況が表示される場所",
      safeguard:
        "高リスク、不可逆、セキュリティ関連、財務、認証情報、リリース、破壊的、新規、または不確実な変更は、引き続き確認が必要です。",
      draftNotice: "下書きを開いても送信されたり、作業が開始されたりすることはありません。",
      nextStepUnknown: "安全な次のステップが確認されていません。変更を行う前に調査してください。",
      stages: {
        needs_review: "レビューが必要です",
        openclaw_handling: "OpenClaw が処理中",
        watching: "OpenClaw が監視中",
        resolved: "解決済み",
      },
      risks: {
        low: "低",
    ...
    working: {
      ...
      title: "現在作業中",
      subtitle:
        "OpenClaw が管理するタスクとワークフローのみ。ローカルの AI プロセスは「システム」の下に表示されます。",
      none: "現在、アクティブに作業中の OpenClaw エージェントはいません。",
      unconfirmed: "データソースが回復するまで、現在の作業を確認できません。",
      unverified: "現在の作業は未確認です",
      countsUnconfirmed: "件数を確認できません",
      itemsCount: "{count}件の作業アイテム",
      itemsCountBounded: "{count}件以上の作業アイテム",
      showingPreview:
        "最新の{shown}件の作業サマリーを表示しています。ワークボードには、管理対象のタスクとワークフローの記録が含まれています。",
      openWorkboard: "ワークボードを開く",
      details: "作業の詳細",
      relatedRuns: "{count}件の関連実行",
      workTotals: "タスクとワークフローの合計",
      tasks: "タスク",
      taskTotals: "アクティブ: {active} · 対応が必要: {failed} · 合計: {total}",
      workflows: "ワークフロー",
      workflowTotals: "アクティブ: {active} · 合計: {total}",
    },
    activityComparison: {
      eyebrow: "現在のアクティビティ",
      title: "実行中のタスク",
      subtitle: "2 つの異なるシグナルを同時に表示します。",
      openClawLabel: "OpenClaw が管理する作業",
      openClawCountOne: "1 人の稼働エージェント",
      openClawCount: "{count} 人の稼働エージェント",
      openClawDetail: "OpenClaw が積極的に管理しているタスクとワークフロー。",
      localAiLabel: "独立したローカル AI",
      localAiCountOne: "1 つのモデルプロセスが読み込まれています",
      localAiCount: "{count} つのモデルプロセスが読み込まれています",
      localAiDetail:
        "この Mac に読み込まれているモデル。プロセスが読み込まれているからといって、必ずしも現在生成中であるとは限りません。",
      unconfirmed: "確認できません",
    },
    ownerAcceptance: {
      eyebrow: "オーナー承認",
      title: "60秒 Operations Room チェック",
      subtitle:
        "タイマーは [開始] をクリックしたときのみ始まります。画面を読み、回答を選択し、最優先の推奨事項を確認してから、変更を加えずに [今はしない] を選択してください。",
      begin: "60秒チェックを開始",
      secondsLeft: "秒残り",
      statusQuestion: "主要なシステムステータスはどれですか？",
      activityQuestion: "現在実行中のものは何ですか？",
      activityAnswer: "OpenClaw: {openClaw} · ローカル AI: {localAi}",
      issueQuestion: "最優先の課題のオーナーは誰で、次に何が行われますか？",
      issueAnswer: "{owner} — {next}",
      issueUnknown: "オーナーまたは次のステップが不明です",
      resolveQuestion: "最優先の推奨事項を確認し、「今はしない」を選択してください。",
      resolvePending: "まだ完了していません",
      resolveDone: "推奨事項を確認し、安全に延期しました",
      finish: "終了してレシートを作成",
      passed: "オーナーチェックに合格しました",
      failed: "オーナーチェックに不合格でした",
      elapsed: "{seconds}秒で完了しました。",
      copyReceipt: "レシートをコピー",
      copied: "レシートをコピーしました",
      copyFailed: "コピーが利用できません。代わりに「レシートのダウンロード」を使用してください。",
      downloadReceipt: "レシートをダウンロード",
    },
    changes: {
      eyebrow: "最近の変更",
      title: "前回の訪問以降",
      none: "前回の訪問以降、意味のある変更はありません。",
      unconfirmed: "データソースが回復するまで、最近の変更を確認できません。",
      firstVisit: "最近の意味のある変更",
      incidentResolved: "問題が解決しました",
      incidentChanged: "問題が変更されました",
      showingNewest:
        "最新の{count}件の変更を表示しています。詳細は利用可能な履歴を開いてください。",
      openActivity: "利用可能な履歴を開く",
      activitySummaryOne: "関連する {runtime} の実行が {result}。",
      activitySummary: "関連する {runtime} の実行が {count} 件、{result}。",
      outcomes: {
        working: "処理中",
        succeeded: "完了",
        blocked: "ブロックされました",
        ...
        unknown: "不明な結果で終了しました",
      },
      remediationOutcomes: {
        completed: "OpenClaw がこの問題を修復し、検証しました",
        rolled_back: "OpenClaw は検証に失敗した修復を自動的に取り消しました",
        failed: "自動修復が停止し、レビューが必要です",
        approval_required: "OpenClaw が停止し、承認を要求しました",
      },
    },
    agents: {
      eyebrow: "ライブルーム",
      title: "エージェント",
      subtitle: "運用優先度を最優先。準備完了のエージェントは折りたたまれた状態になります。",
      searchLabel: "エージェントを検索",
      searchPlaceholder: "エージェントを検索",
      sortLabel: "エージェントの並べ替え",
      sortPriority: "優先度",
      sortName: "名前",
      sortRecent: "最近のアクティビティ",
      noMatches: "検索条件に一致するエージェントはありません。",
      noShownMatches:
        "表示されているエージェントに一致するものはありません。エージェントビュー全体を検索してください。",
      searchResultCount: "{count} 件の一致するエージェントを表示しています。",
      searchResultCountBounded:
        "{count} 件の一致するエージェントを表示しています。エージェントビュー全体にはさらに含まれている可能性があります。",
      unconfirmed: "データソースが回復するまで、エージェントのアクティビティを確認できません。",
      unconfirmedShort: "アクティビティ未確認",
      showing:
        "{total}件中{shown}件を表示しています。緊急およびアクティブなエージェントが優先して表示されます。",
      openAll: "すべてのエージェントを開く",
      urgent: "緊急",
      attention: "対応が必要",
      working: "作業中",
      waiting: "待機またはスケジュール済み",
      recent: "最近変更あり",
      ready: "準備完了",
      off: "オフまたは不明",
      pin: "{name}をピン留め",
      ...
      openAgent: "エージェントを開く",
      reviewIssue: "問題をレビュー",
      whatNeedsAttention: "注意が必要な項目",
      blockedTaskNeedsDecision:
        "{count}件のブロックされたタスクであなたの決定が必要です。エージェントを変更する前に問題をレビューしてください。",
      blockedTasksNeedDecision:
        "{count}件のブロックされたタスクであなたの決定が必要です。エージェントを変更する前に問題をレビューしてください。",
      urgentIssueNeedsDecision: "緊急の問題であなたの決定が必要です。",
      issueBeingHandled: "OpenClaw がこのエージェントの問題を処理しています。",
      issueBeingWatched: "このエージェントの問題が監視されています。",
      technicalDetails: "技術詳細",
      duty: "担当",
      currentWork: "現在の作業",
      lastActivity: "最終アクティビティ",
      taskCounts: "タスク",
      taskCountSummary: "アクティブ: {active} · ブロック中: {blocked}",
      model: "モデル",
      fallback: "フォールバック",
      heartbeat: "ハートビート",
      ram: "RAM",
      inheritedDefault: "継承されたデフォルト",
      noFallback: "明示的なフォールバックなし",
      readyForWork: "作業準備完了",
      noCurrentWork: "なし",
      unavailableRam: "帰属不可",
      browserLocalPins: "ピンは、このブラウザに保存されます。",
    },
    systemHealth: {
      eyebrow: "システム",
      title: "Mac の状態",
      normal: "正常",
      memory: "メモリ容量",
      memoryInUse: "{percent}% が圧力下にあります",
      memoryAvailable: "{percent}% 使用可能",
      memorySummary: "{percent}% メモリ",
      memoryAndLocalAiSummary: "{percent}% メモリ · ローカル AI プロセス: {count}",
      ...
      unavailable: "利用不可",
      memoryBreakdown: "{available} 使用可能 · {free} 即時空き · {total} 合計",
      memoryPressureNote:
    ...
    automationsPanel: {
      eyebrow: "自動化",
      title: "スケジュールされたタスク",
      none: "スケジュールされたタスクは設定されていません。",
      unconfirmed: "データソースが回復するまで、スケジュールされたタスクの確認はできません。",
      openCron: "Cron ジョブを開く",
      showing:
        "{total} 件中 {shown} 件を表示中。すべてのスケジュールされたタスクを確認するには Cron ジョブを開いてください。",
      dueNow: "現在実行予定",
      noNextRun: "次回実行なし",
      runNow: "今すぐ実行",
      pause: "一時停止",
    ...
    more: {
      title: "詳細な運用情報",
      subtitle: "履歴、ワークフロー、スケジュール、機能、モデル、およびホストプロセス。",
      recentHistory: "最近の履歴",
      workflows: "ワークフロー",
      capabilities: "スキル、プラグイン、ツール、モデル",
      processes: "RAM使用量上位のプロセス",
      argumentsPrivate: "引数は一切収集されません。",
      processRowsRejectedOne: "1つのプロセス行を読み取れず除外しました。",
      processRowsRejected: "{count}個のプロセス行を読み取れず除外しました。",
      processesShowing: "{total}件の承認済みプロセスのうち、上位{shown}件を表示しています。",
      configuredActive: "設定済みとアクティブは別々に表示されます。",
      configured: "設定済み",
      notConfigured: "未設定",
      active: "アクティブ",
      inactive: "非アクティブ",
      activityUnverified: "アクティビティ未確認",
      catalogUnavailable: "データソースが回復するまで、このカタログの確認はできません。",
      catalogShowing: "{total}件中{shown}件を表示中",
      shadowMode: "シャドウモード · 自動変更なし",
      catalogued: "{count}件登録済み",
      available: "{count}件利用可能",
      needsSetup: "{count}件の設定が必要",
      availabilityUnverified: "利用可否未確認",
      noHistory: "最近の履歴は記録されていません。",
      noActivityHistory: "このスナップショットにはタスクのアクティビティが記録されていません。",
      activityHistoryUnavailable:
        "このスナップショットからはタスクのアクティビティを確認できません。",
      activityHistory: "タスクのアクティビティ",
      activityCount: "アクティビティグループ: {count}",
      incidentHistory: "インシデント履歴",
      incidentCount: "インシデント記録: {count}",
      historyUnavailable: "このスナップショットにはインシデントの詳細が含まれていません。",
      changed: "{time} に変更",
      transitionCount: "重大度遷移: {count}",
      historyOverflow: "{count} 件の古いインシデントは保持履歴期間外です。",
      historySnapshotBounded:
        "このスナップショットには、{total} 件中 {shown} 件のインシデント記録が含まれています。",
      activitySnapshotBounded:
        "スナップショットの範囲: {total} 件中 {shown} 件のアクティビティグループ。",
      monitorIssue: "バックグラウンドモニターが問題を報告しました",
      monitorStatus: "モニター: 最終試行 {attempt}; 最終成功スウィープ {success}。",
      noWorkflows: "管理対象ワークフローは記録されていません。",
      noProcesses: "プロセスリソースの詳細は利用できません。",
      processesUnavailable: "このスナップショットからはプロセス一覧を確認できません。",
      processesOmitted: "このスナップショットにはプロセス一覧が含まれていません。",
      historySummary: "過去の調査結果: {findings} · インシデント記録: {incidents}",
      workflowSummary: "合計 {total} · アクティブ {active}",
      showing: "{shown} を表示中",
      skills: "スキル",
      plugins: "プラグイン",
      tools: "ツール",
    ...
    actions: {
      details: "詳細",
      detailsFor: "{title} の詳細",
      cancel: "キャンセル",
      cancelWork: "{title}をキャンセル",
      cancelWorkflow: "ワークフローをキャンセル",
      runSchedule: "{title}を今すぐ実行",
      pauseSchedule: "{title}を一時停止",
      enableSchedule: "{title}を有効化",
      unavailable: "データが最新かつ完全になるまで、コントロールは利用できません。",
      cancelled: "アクションがキャンセルされました。変更はありません。",
      confirm:
        "{summary}\n\nリスク: {risk}\n\nこのガード付きアクションは{expires}に期限切れになります。続行しますか？",
      risks: {
        low: "低",
        medium: "中",
        high: "高",
    ...
    counts: {
      exact: "{count}",
      shown: "{total}件中{shown}件を表示中",
      compactShown: "{total}件中{shown}件",
      atLeast: "{count}以上",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "モデル",
        processes: "プロセス",
        eventLoop: "Gateway の応答性",
        monitor: "運用モニター",
        incidentLedger: "インシデント履歴",
      },
      categories: {
        agent: "エージェント",
        workflow: "ワークフロー",
      ...
      dispositions: {
        needs_user: "ユーザーの対応が必要",
        handling: "OpenClaw が処理中",
        watching: "監視中",
        historical: "履歴",
      },
    },
    footer: "決定論的なモニタリングのみ。モデル呼び出しや自動変更は行いません。",
  },
  tabs: {
    agents: "エージェント",
    activity: "アクティビティ",
    overview: "概要",
    operations: "オペレーションルーム",
    workboard: "ワークボード",
    worktrees: "ワークツリー",
    channels: "チャンネル",
    instances: "インスタンス",
  ...
  subtitles: {
    ...
    operations: "エージェント、ワークフロー、機能、モデル、リソースを一覧表示します。",
  ...
  chat: {
    ...
    updating: "更新中…",
    updateNow: "今すぐ更新",
    prepareVerifiedUpdate: "検証済みアップデートを準備",
    preparingVerifiedUpdate: "検証済みアップデートを準備中…",
    installVerifiedUpdate: "検証済みアップデートをインストール",
    exactShaApprovalRequired: "正確な SHA の承認が必要です",
    updateProtectionIncomplete: "アップデート保護を確認してください。",
