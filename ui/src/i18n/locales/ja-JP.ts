...
export const ja_JP: TranslationMap = {
  ...
  operationsRoom: {
    ...
    resolution: {
      resolve: "解決する",
      preview: "解決策のプレビュー",
      resolveFor: "{title} を解決する",
      previewOnly: "プレビューのみ。",
      previewOnlyDetail: "変更は行われていません。",
      closePreview: "プレビューを閉じる — 変更を行わない",
      whatHappened: "発生した事象",
      progress: "進捗状況",
      risk: "問題のリスク",
    ...
    ownerAcceptance: {
      ...
      subtitle:
        "開始をクリックするとタイマーが起動します。画面を読み、回答を選択し、最優先の解決策をプレビューしてから、変更を加えずに閉じます。",
      begin: "60秒チェックを開始",
      secondsLeft: "秒残り",
      ...
      resolveQuestion: "最優先の解決策をプレビューし、変更を加えずに閉じます。",
      resolvePending: "まだ完了していません",
      resolveDone: "プレビューを開き、安全に閉じました",
      finish: "終了してレシートを作成",
