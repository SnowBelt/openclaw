...
export const fa: TranslationMap = {
  ...
  operationsRoom: {
    ...
    resolution: {
      resolve: "حل مشکل",
      preview: "پیش‌نمایش راه‌حل",
      resolveFor: "حل {title}",
      previewOnly: "فقط پیش‌نمایش.",
      previewOnlyDetail: "هیچ تغییری ایجاد نشده است.",
      closePreview: "بستن پیش‌نمایش — بدون اعمال تغییرات",
    ...
    ownerAcceptance: {
      ...
      subtitle:
        "تایمر تنها زمانی شروع می‌شود که روی شروع کلیک کنید. صفحه را بخوانید، پاسخ‌ها را انتخاب کنید، پیش‌نمایش بالاترین اولویت را بررسی کنید، سپس بدون تغییر آن را ببندید.",
      ...
      resolveQuestion: "پیش‌نمایش راه‌حل با بالاترین اولویت را ببینید، سپس بدون تغییر آن را ببندید.",
      resolvePending: "هنوز تکمیل نشده است",
      resolveDone: "پیش‌نمایش باز شد و به‌طور ایمن بسته شد",
