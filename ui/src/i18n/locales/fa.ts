...
export const fa: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "صفحه کنترل OpenClaw",
    title: "اتاق عملیات",
    subtitle: "چه مواردی نیاز به توجه دارند، چه چیزی کار می‌کند و وضعیت سیستم چگونه است.",
    refresh: "بروزرسانی",
    refreshing: "در حال بروزرسانی…",
    refreshLabel: "بروزرسانی اتاق عملیات",
    updated: "به‌روزرسانی‌شده {time}",
    live: "زنده",
    stale: "آخرین مورد شناخته‌شده",
    partial: "داده‌های ناقص",
    unavailableTitle: "داده‌های عملیات در دسترس نیستند",
    actionFailedTitle: "عملیات تکمیل نشد",
    staleTitle: "بروزرسانی زنده ناموفق بود",
    staleDetail: "نمایش آخرین عکس‌العمل موفق از {time}.",
    unavailableSources: "منابع در دسترس نیستند: {sources}.",
    fallbackSources: "منابع داده جایگزین: {sources}.",
    loading: "در حال تهیه تصویر عملیات فعلی…",
    empty: "هنوز هیچ عکس‌العمل عملیاتی در دسترس نیست.",
    now: "اکنون",
    briefingUnavailable: "نمای کلی فعلی قابل تأیید نیست. وضعیت خاص هر منبع را در زیر بررسی کنید.",
    lastKnownBriefing: "نمایش آخرین نمای کلی شناخته‌شده",
    briefingTone: {
      normal: "به‌روز",
    ...
    overallBriefingTone: {
      normal: "کلی: به‌روز",
      attention: "کلی: نیاز به توجه",
      urgent: "کلی: فوری",
      unknown: "کلی: وضعیت نامشخص",
    },
    overviewNav: "نمای کلی عملیات",
    reviewCount: "بررسی {count}",
    reviewUnconfirmed: "بررسی —",
    decisionCount: "تصمیم‌گیری مورد نیاز {count}",
    decisionsUnconfirmed: "تصمیم‌گیری مورد نیاز —",
    workingCount: "در حال کار {count}",
    workingCountBounded: "در حال کار {count}+",
    workingUnconfirmed: "در حال کار —",
    agentsWorkingNowCount: "ایجنت‌های در حال کار {count}",
    agentsWorkingUnconfirmed: "ایجنت‌های در حال کار —",
    openClawWorkCount: "{count} کار OpenClaw",
    openClawWorkUnconfirmed: "کار OpenClaw —",
    allAgentsCount: "همه عوامل {count}",
    agentsUnconfirmed: "همه عوامل —",
    agentsCount: "{count} ایجنت",
    urgentCount: "{count} مورد فوری",
    activeAgentsCount: "عوامل فعال: {count}",
    workingItemsCount: "موارد در حال کار: {count}",
    showingAgents: "نمایش {count}",
    attentionAgentsCount: "{count} مورد نیاز به توجه",
    agentStatusSummary: "{working} در حال کار · {attention} نیاز به توجه",
    automationCount: "زمان‌بندی‌ها: {total} · خطا: {failing}",
    automations: "اتوماسیون‌ها",
    system: "سیستم",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "نیاز به بررسی",
      title: "توجه",
      subtitle: "مسائل فعلی در ابتدا. رویدادهای تاریخی در بخش بیشتر باقی می‌مانند.",
      needsYou: "نیاز به شما دارد",
      handling: "OpenClaw در حال مدیریت است",
      watching: "در حال نظارت",
      none: "هیچ چیزی نیاز به توجه شما ندارد.",
      noCritical: "هیچ مشکل بحرانی فعال نیست.",
      currentCount: "{count} مورد فعلی",
      noneNeedsYou: "هیچ تصمیم یا مداخله‌ای منتظر شما نیست.",
      noneHandling: "هیچ اقدام اصلاحی فعالی در جریان نیست.",
      noneWatching: "هیچ چیزی تحت نظارت نیست.",
      impact: "تأثیر",
      owner: "مالک",
      you: "شما",
      unassignedOwner: "تخصیص‌نیافته",
      response: "پاسخ",
      nextAction: "اقدام بعدی",
      nextActionShort: "بعدی",
      highestPriority: "مشکل با بالاترین اولویت",
      whoOwnsThis: "مسئول این مورد کیست",
      whatHappensNext: "مرحله بعدی چیست",
      continueMonitoring: "ادامه نظارت.",
      observed: "مشاهده شده {time}",
      lastKnown: "آخرین مورد شناخته‌شده",
      unconfirmedTitle: "وضعیت توجه قابل تأیید نیست",
      unconfirmedDetail:
        "مشکلات شناخته‌شده در زیر نمایش داده می‌شوند، اما ممکن است داده‌های ناقص یا آخرین داده‌های شناخته‌شده، مشکلات جدیدتر را حذف کنند.",
      unconfirmedShort: "نیاز به تأیید",
      showingCurrent:
        "نمایش {shown} از {total} مشکل فعلی در این نمای محدود. نماهای منبع رکوردهای مرتبط را ارائه می‌دهند.",
      outsidePreview: "{count} مشکل فعلی خارج از این پیش‌نمایش هستند. یک نمای منبع در بالا باز کنید.",
      lastProgress: "آخرین پیشرفت",
      nextCheck: "بررسی بعدی",
      remediationTask: "وظیفه رفع مشکل",
      openRemediation: "باز کردن رفع مشکل",
      responseStates: {
        unassigned: "تخصیص‌نیافته",
        in_progress: "در حال انجام",
        monitoring: "پایش",
        waiting_for_user: "منتظر شما",
        resolved: "حل‌شده",
      },
    },
    resolution: {
      resolve: "حل مشکل",
      preview: "راه‌حل پیشنهادی",
      recommendation: "راه‌حل پیشنهادی",
      resolveFor: "بررسی راه‌حل پیشنهادی برای {title}",
      previewOnly: "فقط پیشنهاد.",
      previewOnlyDetail: "تا زمانی که یک تعمیر واجد شرایط تأیید نشود، تغییری ایجاد نمی‌شود.",
      closePreview: "الان نه",
      notNow: "الان نه",
      recommendedLabel: "تعمیر پیشنهادی:",
      recommendedFix: "تعمیر پیشنهادی",
      whyRecommended: "چرا این مورد پیشنهاد می‌شود",
      defaultReason: "این امن‌ترین گام بعدی است که توسط شواهد موجود پشتیبانی می‌شود.",
      confidence: "اطمینان",
      confidencePending: "در انتظار بررسی محلی",
      confidenceValue: "{confidence}% اطمینان",
      whatHappened: "چه اتفاقی افتاد",
      progress: "پیشرفت",
      risk: "ریسک مشکل",
      changePreview: "چه چیزی تغییر می‌کند",
      verification: "نحوه تأیید آن توسط OpenClaw",
      verificationPending: "قبل از اجرای هرگونه تغییر خودکار، یک برنامه تأیید قطعی مورد نیاز است.",
      approval: "تأیید شما",
      evidence: "به‌روزرسانی‌های پیشرفت",
      localReview: "بررسی محلی ({confidence}%): {recommendation}",
      judgeReview: "بررسی ایمنی مستقل: {decision} — {reason}",
      approved: "تأیید شده",
      rejected: "رد شده",
      rollback: "برنامه رول‌بک",
      undoAvailability: "دسترسی به لغو تغییرات",
      undoAvailable: "از طریق پیش‌نمایش محافظت‌شده در دسترس است",
      undoUnavailable: "لغو مستقیم در دسترس نیست",
      viewRepairDetails: "مشاهده جزئیات تعمیر",
      result: "نتیجه",
      undo: "لغو این تعمیر",
      investigate: "بررسی با هوش مصنوعی محلی",
      reviewEscalation: "بررسی با Codex",
      reviewCancellation: "بررسی لغو",
      fixThis: "این را برای من تعمیر کن",
      investigationPreview:
        "هنوز تغییری ایجاد نمی‌شود. یک پیش‌نویس تحقیق فقط برای خواندن باز می‌شود تا آن را بررسی و ارسال کنید.",
      cancelPreview: "یک پیش‌نمایش محافظت‌شده برای لغو «{title}» آماده کنید.",
      approvalRequired: "شما باید هر تغییری را قبل از اعمال آن تأیید کنید.",
      oneConfirmation:
        "یک تأییدیه مختصر لازم است زیرا این یک تعمیر با ریسک متوسط، بررسی‌شده و قابل بازگشت است.",
      automaticPolicy:
        "OpenClaw ممکن است این تعمیر تأییدشده را به‌طور خودکار اجرا کند، زیرا محدود و قابل بازگشت است.",
      evidenceLocation:
        "پیشرفت و اثبات در این مسئله، بخش «از آخرین بازدید شما» و Workboard ظاهر می‌شود.",
      investigationRollback:
        "هنوز لازم نیست زیرا بررسی تغییری ایجاد نمی‌کند. هر اصلاح پیشنهادی باید شامل برنامه رول‌بک باشد.",
      cancelRollback:
        "لغو نمی‌تواند کارهای تکمیل‌شده را بازیابی کند. پیش‌نمایش تغییر دقیق را قبل از تأیید آن بررسی کنید.",
      progressLocationLabel: "محل نمایش پیشرفت",
      safeguard:
        "تغییرات پرریسک، غیرقابل بازگشت، حساس از نظر امنیتی، مالی، اعتبارسنجی، انتشار، مخرب، جدید یا نامشخص همچنان نیاز به تأیید شما دارند.",
      draftNotice: "باز کردن پیش‌نویس، آن را ارسال نمی‌کند یا کار را شروع نمی‌کند.",
      nextStepUnknown: "هیچ گام بعدی ایمن تأیید نشده است. قبل از تغییر هر چیزی، بررسی کنید.",
      stages: {
        needs_review: "نیاز به بررسی",
        openclaw_handling: "OpenClaw در حال مدیریت این مورد است",
        watching: "OpenClaw در حال نظارت بر این مورد است",
        resolved: "حل‌شده",
      },
      risks: {
        low: "کم",
    ...
    working: {
      eyebrow: "در حال انجام",
      title: "هم‌اکنون در حال کار",
      subtitle:
        "فقط وظایف و گردش‌کارهای مدیریت‌شده توسط OpenClaw. فرآیندهای هوش مصنوعی محلی در بخش System نمایش داده می‌شوند.",
      none: "هیچ عامل OpenClaw در حال حاضر به‌طور فعال کار نمی‌کند.",
      unconfirmed: "کار فعلی تا زمانی که منابع داده آن بازیابی نشوند، قابل تأیید نیست.",
      unverified: "کار فعلی تأییدنشده",
      countsUnconfirmed: "تعدادها قابل تأیید نیستند",
      itemsCount: "{count} مورد فعال",
      itemsCountBounded: "حداقل {count} مورد فعال",
      showingPreview:
        "نمایش {shown} خلاصه کار اخیر. تابلوی کاری شامل رکوردهای وظیفه و گردش کار مدیریت‌شده است.",
      openWorkboard: "باز کردن تابلوی کاری",
      details: "جزئیات کار",
      relatedRuns: "{count} اجرا مرتبط",
      workTotals: "مجموع وظایف و گردش‌کارها",
      tasks: "وظایف",
      taskTotals: "فعال: {active} · نیاز به توجه: {failed} · مجموع: {total}",
      workflows: "گردش‌کارها",
      workflowTotals: "فعال: {active} · مجموع: {total}",
    },
    activityComparison: {
      eyebrow: "فعالیت فعلی",
      title: "چه چیزی در حال اجراست",
      subtitle: "دو سیگنال متفاوت، نمایش داده شده با هم.",
      openClawLabel: "کارهای مدیریت‌شده توسط OpenClaw",
      openClawCountOne: "۱ عامل در حال کار",
      openClawCount: "{count} عامل در حال کار",
      openClawDetail: "وظایف و گردش‌کارهایی که OpenClaw به‌طور فعال مدیریت می‌کند.",
      localAiLabel: "هوش مصنوعی محلی مستقل",
      localAiCountOne: "۱ فرآیند مدل بارگذاری شده",
      localAiCount: "{count} فرآیند مدل بارگذاری شده",
      localAiDetail:
        "مدل‌های بارگذاری‌شده روی این مک. یک فرآیند بارگذاری‌شده لزوماً به معنای تولید خروجی در لحظه نیست.",
      unconfirmed: "تأیید امکان‌پذیر نیست",
    },
    ownerAcceptance: {
      eyebrow: "تأیید مالک",
      title: "بررسی اتاق عملیات ۶۰ ثانیه‌ای",
      subtitle:
        "تایمر تنها زمانی شروع می‌شود که روی شروع کلیک کنید. صفحه را بخوانید، پاسخ‌ها را انتخاب کنید، پیشنهاد با بالاترین اولویت را بررسی کنید، سپس بدون ایجاد تغییر، گزینه «الان نه» را انتخاب کنید.",
      begin: "شروع بررسی ۶۰ ثانیه‌ای",
      secondsLeft: "ثانیه باقی‌مانده",
      statusQuestion: "وضعیت اصلی سیستم چیست؟",
      activityQuestion: "همین الان چه چیزی در حال اجراست؟",
      activityAnswer: "OpenClaw: {openClaw} · هوش مصنوعی محلی: {localAi}",
      issueQuestion: "مسئول مشکل با بالاترین اولویت کیست و گام بعدی چیست؟",
      issueAnswer: "{owner} — {next}",
      issueUnknown: "هیچ مسئول یا گام بعدی مشخص نیست",
      resolveQuestion: "پیشنهاد با بالاترین اولویت را بررسی کنید، سپس «الان نه» را انتخاب کنید.",
      resolvePending: "هنوز تکمیل نشده است",
      resolveDone: "پیشنهاد بررسی شد و به‌طور ایمن به تعویق افتاد",
      finish: "تکمیل و ایجاد رسید",
      passed: "بررسی مالکیت با موفقیت انجام شد",
      failed: "بررسی مالکیت ناموفق بود",
      elapsed: "در {seconds} ثانیه تکمیل شد.",
      copyReceipt: "رونوشت رسید",
      copied: "رسید رونوشت شد",
      copyFailed: "رونوشت در دسترس نبود. به‌جای آن از دانلود رسید استفاده کنید.",
      downloadReceipt: "دانلود رسید",
    },
    changes: {
      eyebrow: "تغییرات اخیر",
      title: "از آخرین بازدید شما",
      none: "هیچ تغییر معناداری از آخرین بازدید شما رخ نداده است.",
      unconfirmed: "تأیید تغییرات اخیر تا زمان بازیابی منابع داده آن‌ها امکان‌پذیر نیست.",
      firstVisit: "تغییرات معنادار اخیر",
      incidentResolved: "مشکل حل شد",
      incidentChanged: "مشکل تغییر کرد",
      showingNewest: "نمایش {count} تغییر جدیدترین. برای جزئیات بیشتر، تاریخچه موجود را باز کنید.",
      openActivity: "باز کردن تاریخچه موجود",
      activitySummaryOne: "۱ اجرای مرتبط {runtime} با نتیجه‌ی {result}.",
      activitySummary: "{count} اجرای مرتبط {runtime} با نتیجه‌ی {result}.",
      outcomes: {
        working: "هنوز در حال کار است",
        succeeded: "تکمیل شد",
        blocked: "مسدود شد",
        failed: "ناموفق بود",
        cancelled: "لغو شد",
        unknown: "با نتیجه‌ی نامشخصی پایان یافت",
      },
      remediationOutcomes: {
        completed: "OpenClaw این مشکل را تعمیر و تأیید کرد",
        rolled_back: "OpenClaw به‌طور خودکار یک تعمیر که تأیید نشد را برگرداند",
        failed: "تعمیر خودکار متوقف شد و نیاز به بررسی دارد",
        approval_required: "OpenClaw متوقف شد و درخواست تأیید کرد",
      },
    },
    agents: {
      eyebrow: "اتاق زنده",
      title: "عامل‌ها",
      subtitle: "اولویت با عملیات است. عامل‌های آماده جمع می‌شوند.",
      searchLabel: "جستجوی عامل‌ها",
      searchPlaceholder: "جستجوی عامل‌ها",
      sortLabel: "مرتب‌سازی عامل‌ها",
      sortPriority: "اولویت",
      sortName: "نام",
      sortRecent: "فعالیت اخیر",
      noMatches: "هیچ عاملی با این جستجو مطابقت ندارد.",
      noShownMatches: "هیچ عامل نمایش‌داده‌شده‌ای مطابقت ندارد. در نمای کامل عامل‌ها جستجو کنید.",
      searchResultCount: "{count} عامل مطابق نمایش داده شد.",
      searchResultCountBounded:
        "{count} عامل مطابق نمایش داده شد. نمای کامل عامل‌ها ممکن است موارد بیشتری داشته باشد.",
      unconfirmed: "تا زمانی که منبع داده بازیابی نشود، فعالیت عامل تأیید نمی‌شود.",
      unconfirmedShort: "فعالیت تأییدنشده",
      showing: "نمایش {shown} از {total} عامل. عوامل فوری و فعال ابتدا نمایش داده می‌شوند.",
      openAll: "باز کردن همه عوامل",
      urgent: "فوری",
      attention: "نیاز به توجه",
      working: "در حال کار",
      waiting: "در انتظار یا زمان‌بندی‌شده",
      recent: "تغییر اخیر",
      ready: "آماده",
      off: "خاموش یا ناشناخته",
      pin: "سنجاق کردن {name}",
      unpin: "برداشتن سنجاق {name}",
      pinned: "سنجاق‌شده",
      openAgent: "باز کردن عامل",
      reviewIssue: "بررسی مشکل",
      whatNeedsAttention: "چه چیزی نیاز به توجه دارد",
      blockedTaskNeedsDecision:
        "{count} وظیفه مسدود شده به تصمیم شما نیاز دارد. قبل از تغییر ایجنت، مشکل را بررسی کنید.",
      blockedTasksNeedDecision:
        "{count} وظیفه مسدود شده به تصمیم شما نیاز دارند. قبل از تغییر ایجنت، مشکلات را بررسی کنید.",
      urgentIssueNeedsDecision: "یک مشکل فوری به تصمیم شما نیاز دارد.",
      issueBeingHandled: "OpenClaw در حال رسیدگی به مشکلی برای این ایجنت است.",
      issueBeingWatched: "مشکلی برای این ایجنت تحت نظارت است.",
      technicalDetails: "جزئیات فنی",
      duty: "وظیفه",
      currentWork: "کار فعلی",
      lastActivity: "آخرین فعالیت",
      taskCounts: "وظایف",
      taskCountSummary: "فعال: {active} · مسدود: {blocked}",
      model: "مدل",
      fallback: "جایگزین",
      heartbeat: "ضربان قلب",
      ram: "رم",
      inheritedDefault: "پیش‌فرض ارثی",
      noFallback: "بدون جایگزین صریح",
      readyForWork: "آماده برای کار",
      noCurrentWork: "هیچ‌کدام",
      unavailableRam: "قابل تخصیص نیست",
      browserLocalPins: "سنجاق‌ها در این مرورگر ذخیره می‌شوند.",
    },
    systemHealth: {
      eyebrow: "سیستم",
      title: "سلامت مک",
      normal: "عادی",
      memory: "ظرفیت حافظه",
      memoryInUse: "{percent}% تحت فشار",
      memoryAvailable: "{percent}% در دسترس",
      memorySummary: "{percent}% حافظه",
      memoryAndLocalAiSummary: "{percent}% حافظه · فرآیندهای هوش مصنوعی محلی: {count}",
      ...
      cpu: "پردازنده",
      load: "بار {value}",
      responseDelay: "تاخیر پاسخ",
      milliseconds: "{count} میلی‌ثانیه",
      technicalDetails: "جزئیات فنی",
      gatewayRam: "رم Gateway",
      host: "میزبان",
      logicalCores: "هسته‌های منطقی CPU",
      unavailable: "دسترس‌ناپذیر",
      memoryBreakdown: "{available} موجود · {free} بلافاصله آزاد · {total} کل",
      memoryPressureNote:
    ...
    automationsPanel: {
      eyebrow: "اتوماسیون‌ها",
      title: "کارهای زمان‌بندی شده",
      none: "هیچ کار زمان‌بندی شده‌ای پیکربندی نشده است.",
      unconfirmed: "تا زمانی که منبع داده بازیابی نشود، نمی‌توان کارهای زمان‌بندی شده را تأیید کرد.",
      openCron: "باز کردن Cron Jobs",
      showing:
        "نمایش {shown} از {total}. برای بررسی تمام کارهای زمان‌بندی شده، Cron Jobs را باز کنید.",
      dueNow: "هم اکنون سررسید است",
      noNextRun: "اجرای بعدی وجود ندارد",
      runNow: "اجرا هم اکنون",
      pause: "مکث",
      enable: "فعال‌سازی",
    },
    more: {
      title: "جزئیات بیشتر عملیات",
      subtitle: "تاریخچه، گردش کارها، زمان‌بندی‌ها، قابلیت‌ها، مدل‌ها و فرآیندهای میزبان.",
      recentHistory: "تاریخچه اخیر",
      workflows: "گردش کارها",
      capabilities: "مهارت‌ها، افزونه‌ها، ابزارها و مدل‌ها",
      processes: "بیشترین مصرف‌کنندگان RAM",
      argumentsPrivate: "آرگومان‌ها هرگز جمع‌آوری نمی‌شوند.",
      processRowsRejectedOne: "۱ سطر فرآیند قابل خواندن نبود و حذف شد.",
      processRowsRejected: "{count} سطر فرآیند قابل خواندن نبودند و حذف شدند.",
      processesShowing: "نمایش {shown} مورد از بزرگ‌ترین {total} فرآیند پذیرفته‌شده.",
      configuredActive: "پیکربندی‌شده و فعال به‌صورت جداگانه نمایش داده می‌شوند.",
      configured: "پیکربندی‌شده",
      notConfigured: "پیکربندی‌نشده",
      active: "فعال",
      inactive: "غیرفعال",
      activityUnverified: "فعالیت تأیید نشده است",
      catalogUnavailable: "این کاتالوگ تا زمان بازیابی منبع داده‌اش قابل تأیید نیست.",
      catalogShowing: "نمایش {shown} از {total}",
      shadowMode: "حالت سایه · بدون تغییرات خودکار",
      catalogued: "{count} مورد کاتالوگ‌شده",
      available: "{count} مورد در دسترس",
      needsSetup: "{count} مورد نیاز به راه‌اندازی دارند",
      availabilityUnverified: "دسترسی تأیید نشده است",
      noHistory: "هیچ سابقه‌ای اخیراً ثبت نشده است.",
      noActivityHistory: "هیچ فعالیت وظیفه‌ای در این تصویر ثبت نشده است.",
      activityHistoryUnavailable: "نمی‌توان فعالیت وظیفه را از این تصویر تأیید کرد.",
      activityHistory: "فعالیت وظیفه",
      activityCount: "گروه‌های فعالیت: {count}",
      incidentHistory: "سوابق رخداد",
      incidentCount: "رکوردهای رخداد: {count}",
      historyUnavailable: "جزئیات رخداد در این تصویر موجود نیست.",
      changed: "{time} تغییر یافت",
      transitionCount: "تغییرات شدت: {count}",
      historyOverflow: "{count} رخداد قدیمی‌تر خارج از پنجره تاریخچه نگهداری شده هستند.",
      historySnapshotBounded: "این تصویر شامل {shown} از {total} رکورد رخداد است.",
      activitySnapshotBounded: "پوشش تصویر: {shown} از {total} گروه فعالیت.",
      monitorIssue: "مانیتور پس‌زمینه مشکلی را گزارش داد",
      monitorStatus: "مانیتور: آخرین تلاش {attempt}؛ آخرین بررسی موفق {success}.",
      noWorkflows: "هیچ گردش کاری مدیریت‌شده‌ای ثبت نشده است.",
      noProcesses: "جزئیات منابع فرآیند در دسترس نیست.",
      processesUnavailable: "نمی‌توان فهرست فرآیندها را از این تصویر تأیید کرد.",
      processesOmitted: "فهرست فرآیندها در این تصویر گنجانده نشده است.",
      historySummary: "یافته‌های تاریخی: {findings} · رکوردهای رخداد: {incidents}",
      workflowSummary: "{total} مجموع · {active} فعال",
      showing: "نمایش {shown}",
      skills: "مهارت‌ها",
      plugins: "پلاگین‌ها",
      tools: "ابزارها",
      models: "مدل‌ها",
      noSkills: "هیچ مهارتی یافت نشد.",
    ...
    actions: {
      details: "جزئیات",
      detailsFor: "جزئیات {title}",
      cancel: "لغو",
      cancelWork: "لغو {title}",
      cancelWorkflow: "لغو گردش کار",
      runSchedule: "اجرای {title} اکنون",
      pauseSchedule: "توقف {title}",
      enableSchedule: "فعال‌سازی {title}",
      unavailable: "کنترل‌ها تا زمانی که این داده‌ها تازه و کامل شوند، در دسترس نیستند.",
      cancelled: "عمل لغو شد. تغییری ایجاد نشد.",
      confirm:
        "{summary}\n\nریسک: {risk}\n\nاین عمل محافظت‌شده در {expires} منقضی می‌شود. ادامه می‌دهید؟",
      risks: {
        low: "کم",
        medium: "متوسط",
        high: "زیاد",
    ...
    enums: {
      ...
      sources: {
        ...
        models: "مدل‌ها",
        processes: "فرآیندها",
        eventLoop: "پاسخگویی Gateway",
        monitor: "نظارت بر عملیات",
        incidentLedger: "تاریخچه حوادث",
      },
      categories: {
        agent: "عامل",
        workflow: "جریان کار",
      ...
      routes: {
        ...
        subscription: "اشتراک",
        metered: "مترشده",
        unknown: "مسیر ناشناخته",
      },
      processKinds: {
        gateway: "Gateway",
        local_model: "مدل محلی",
        browser: "مرورگر",
        other: "سایر",
      },
      dispositions: {
        needs_user: "نیاز به شما دارد",
        handling: "OpenClaw در حال مدیریت است",
        watching: "در حال نظارت",
        historical: "تاریخی",
      },
    },
    footer: "فقط پایش قطعی. هیچ فراخوانی مدل یا تغییرات خودکار انجام نمی‌شود.",
  },
  tabs: {
    agents: "عامل‌ها",
    activity: "فعالیت",
    overview: "نمای کلی",
    operations: "اتاق عملیات",
  ...
  subtitles: {
    ...
    operations: "نمایی کلی از عامل‌ها، گردش‌کارها، قابلیت‌ها، مدل‌ها و منابع.",
