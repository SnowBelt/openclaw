...
export const pl: TranslationMap = {
  ...
  operationsRoom: {
    ...
    subtitle: "Co wymaga uwagi, co działa i jak system funkcjonuje.",
    refresh: "Odśwież",
    refreshing: "Odświeżanie…",
    refreshLabel: "Odśwież Operations Room",
    updated: "Zaktualizowano {time}",
    live: "Na żywo",
    stale: "Ostatnie znane",
    partial: "Częściowe dane",
    unavailableTitle: "Dane operacyjne niedostępne",
    actionFailedTitle: "Akcja nie została ukończona",
    staleTitle: "Aktualizacja na żywo nie powiodła się",
    staleDetail: "Wyświetlanie ostatniego udanego migawki z {time}.",
    unavailableSources: "Niedostępne źródła: {sources}.",
    fallbackSources: "Zapasowe źródła danych: {sources}.",
    loading: "Tworzenie aktualnego obrazu operacyjnego…",
    empty: "Brak dostępnej migawki operacyjnej.",
    now: "Teraz",
    briefingUnavailable:
      "Nie można potwierdzić bieżącego przeglądu. Sprawdź status poszczególnych źródeł poniżej.",
    lastKnownBriefing: "Pokaż ostatni znany przegląd",
    briefingTone: {
      normal: "Aktualne",
    ...
    overallBriefingTone: {
      normal: "Ogólnie: Aktualne",
      attention: "Ogólnie: Wymaga uwagi",
      urgent: "Ogólnie: Pilne",
      unknown: "Ogólnie: Status nieznany",
    },
    overviewNav: "Przegląd operacji",
    reviewCount: "Do sprawdzenia: {count}",
    reviewUnconfirmed: "Do sprawdzenia —",
    decisionCount: "Decyzji wymaganych {count}",
    decisionsUnconfirmed: "Decyzji wymaganych —",
    workingCount: "Aktywne teraz: {count}",
    workingCountBounded: "Aktywne teraz: {count}+",
    workingUnconfirmed: "Aktywne teraz —",
    agentsWorkingNowCount: "Agentów pracujących teraz {count}",
    agentsWorkingUnconfirmed: "Agentów pracujących teraz —",
    openClawWorkCount: "{count} zadań OpenClaw",
    openClawWorkUnconfirmed: "Zadania OpenClaw —",
    allAgentsCount: "Wszyscy agenci: {count}",
    agentsUnconfirmed: "Wszyscy agenci —",
    agentsCount: "{count} agentów",
    urgentCount: "{count} pilnych",
    activeAgentsCount: "Aktywni agenci: {count}",
    workingItemsCount: "Elementy w pracy: {count}",
    showingAgents: "Wyświetlanie: {count}",
    attentionAgentsCount: "{count} wymaga uwagi",
    agentStatusSummary: "{working} pracuje · {attention} wymaga uwagi",
    automationCount: "Harmonogramy: {total} · Nieudane: {failing}",
    automations: "Automatyzacje",
    system: "System",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "Wymaga przeglądu",
      title: "Uwaga",
      subtitle: "Najpierw bieżące problemy. Zdarzenia historyczne pozostają w sekcji Więcej.",
      needsYou: "Wymaga Twojej uwagi",
      handling: "OpenClaw obsługuje",
      watching: "Obserwowane",
      none: "Nic nie wymaga Twojej uwagi.",
      noCritical: "Brak aktywnego krytycznego problemu.",
      currentCount: "{count} bieżących",
      noneNeedsYou: "Nie oczekuje na Ciebie żadna decyzja ani interwencja.",
      noneHandling: "Brak trwających aktywnych działań naprawczych.",
      noneWatching: "Nic nie jest obserwowane.",
      impact: "Wpływ",
      owner: "Właściciel",
      you: "Ty",
      unassignedOwner: "Nieprzypisane",
      response: "Reakcja",
      nextAction: "Następne działanie",
      nextActionShort: "Następny",
      highestPriority: "Problem o najwyższym priorytecie",
      whoOwnsThis: "Kto jest właścicielem",
      whatHappensNext: "Co dalej",
      continueMonitoring: "Kontynuuj monitorowanie.",
      observed: "Zauważono {time}",
      lastKnown: "Ostatnio znane",
      unconfirmedTitle: "Nie można potwierdzić statusu uwagi",
      unconfirmedDetail:
        "Poniżej wyświetlono znane problemy, jednak niekompletne lub ostatnie znane dane mogą pomijać nowsze problemy.",
      unconfirmedShort: "Wymaga weryfikacji",
      showingCurrent:
        "Wyświetlanie {shown} z {total} bieżących problemów w tym ograniczonym migawce. Widoki źródłowe zapewniają powiązane rekordy.",
      outsidePreview:
        "{count} bieżących problemów znajduje się poza tym podglądem. Otwórz widok źródłowy powyżej.",
      lastProgress: "Ostatni postęp",
      nextCheck: "Następna kontrola",
      remediationTask: "Zadanie naprawcze",
      openRemediation: "Otwórz naprawę",
      responseStates: {
        unassigned: "Nieprzypisane",
        in_progress: "W toku",
        monitoring: "Monitorowanie",
        waiting_for_user: "Oczekiwanie na Ciebie",
        resolved: "Rozwiązane",
      },
    },
    resolution: {
      ...
      judgeReview: "Niezależna recenzja bezpieczeństwa: {decision} — {reason}",
      approved: "Zatwierdzono",
      rejected: "Odrzucono",
      rollback: "Plan cofania",
      undoAvailability: "Dostępność cofania",
      undoAvailable: "Dostępne przez chroniony podgląd",
      undoUnavailable: "Bezpośrednie cofanie jest niedostępne",
      viewRepairDetails: "Wyświetl szczegóły naprawy",
      result: "Wynik",
      undo: "Cofnij tę naprawę",
      ...
      evidenceLocation:
        "Postępy i dowody pojawią się w tym zgłoszeniu, sekcji „Od ostatniej wizyty” oraz na Workboardzie.",
      ...
      nextStepUnknown:
        "Nie potwierdzono bezpiecznego następnego kroku. Przeanalizuj sytuację przed wprowadzeniem jakichkolwiek zmian.",
      stages: {
        needs_review: "Wymaga przeglądu",
        openclaw_handling: "OpenClaw zajmuje się tym",
        watching: "OpenClaw obserwuje to",
        resolved: "Rozwiązane",
      },
      risks: {
        low: "Niska",
    ...
    working: {
      ...
      title: "Praca w toku",
      subtitle:
        "Tylko zadania i przepływy pracy zarządzane przez OpenClaw. Lokalne procesy AI są wyświetlane w sekcji System.",
      none: "Żaden agent OpenClaw nie wykonuje obecnie żadnych zadań.",
      unconfirmed:
        "Bieżącej pracy nie można potwierdzić, dopóki jej źródła danych się nie odzyskają.",
      unverified: "Bieżąca praca niezweryfikowana",
      countsUnconfirmed: "Liczb nie można potwierdzić",
      itemsCount: "{count} aktywnych elementów",
      itemsCountBounded: "Co najmniej {count} aktywnych elementów",
      showingPreview:
        "Wyświetlanie {shown} najnowszych podsumowań pracy. Tablica zadań zawiera zarządzane rekordy zadań i przepływów pracy.",
      openWorkboard: "Otwórz tablicę zadań",
      details: "Szczegóły pracy",
      relatedRuns: "{count} powiązanych uruchomień",
      workTotals: "Suma zadań i przepływów pracy",
      tasks: "Zadania",
      taskTotals: "Aktywne: {active} · Wymagają uwagi: {failed} · Łącznie: {total}",
      workflows: "Przepływy pracy",
      workflowTotals: "Aktywne: {active} · Łącznie: {total}",
    },
    activityComparison: {
      eyebrow: "Aktywność teraz",
      title: "Co jest uruchomione",
      subtitle: "Dwa różne sygnały wyświetlane razem.",
      openClawLabel: "Praca zarządzana przez OpenClaw",
      openClawCountOne: "1 pracujący agent",
      openClawCount: "{count} pracujących agentów",
      openClawDetail: "Zadania i przepływy pracy, które OpenClaw aktywnie zarządza.",
      localAiLabel: "Niezależne lokalne AI",
      localAiCountOne: "1 załadowany proces modelu",
      localAiCount: "{count} załadowanych procesów modeli",
      localAiDetail:
        "Modele załadowane na tym Macu. Załadowany proces nie oznacza koniecznie, że obecnie generuje dane.",
      unconfirmed: "Nie można potwierdzić",
    },
    ownerAcceptance: {
      ...
      activityQuestion: "Co jest obecnie uruchomione?",
      activityAnswer: "OpenClaw: {openClaw} · Lokalne AI: {localAi}",
      issueQuestion: "Kto odpowiada za problem o najwyższym priorytecie i co stanie się dalej?",
      ...
      elapsed: "Ukończono w {seconds} sekund.",
      copyReceipt: "Kopiuj paragon",
      copied: "Paragon skopiowany",
      copyFailed: "Kopiowanie było niedostępne. Zamiast tego użyj opcji Pobierz paragon.",
      downloadReceipt: "Pobierz paragon",
    },
    changes: {
      eyebrow: "Ostatnie zmiany",
      title: "Od ostatniej wizyty",
      none: "Brak istotnych zmian od ostatniej wizyty.",
      unconfirmed: "Ostatnich zmian nie można potwierdzić, dopóki źródła danych się nie przywrócą.",
      firstVisit: "Ostatnie istotne zmiany",
      incidentResolved: "Problem rozwiązany",
      incidentChanged: "Problem zmieniony",
      showingNewest:
        "Wyświetlanie {count} najnowszych zmian. Otwórz dostępną historię, aby uzyskać więcej szczegółów.",
      openActivity: "Otwórz dostępną historię",
      activitySummaryOne: "1 powiązane uruchomienie {runtime} {result}.",
      activitySummary: "{count} powiązanych uruchomień {runtime} {result}.",
      outcomes: {
        working: "nadal działa",
        succeeded: "ukończone",
        blocked: "zablokowane",
        failed: "nieudane",
        cancelled: "anulowane",
        unknown: "zakończone z nieznanym wynikiem",
      },
      remediationOutcomes: {
        completed: "OpenClaw naprawił i zweryfikował ten problem",
        rolled_back: "OpenClaw automatycznie cofnął naprawę, która nie przeszła weryfikacji",
        failed: "Automatyczna naprawa została zatrzymana i wymaga przeglądu",
        approval_required: "OpenClaw został zatrzymany i poprosił o zatwierdzenie",
      },
    },
    agents: {
      eyebrow: "Pomieszczenie na żywo",
      title: "Agenci",
      subtitle: "Priorytet operacyjny na pierwszym miejscu. Gotowi agenci pozostają zwinięci.",
      searchLabel: "Szukaj agentów",
      searchPlaceholder: "Szukaj agentów",
      sortLabel: "Sortuj agentów",
      sortPriority: "Priorytet",
      sortName: "Nazwa",
      sortRecent: "Ostatnia aktywność",
      noMatches: "Żaden agent nie pasuje do tego wyszukiwania.",
      noShownMatches: "Żaden z wyświetlonych agentów nie pasuje. Wyszukaj w pełnym widoku Agentów.",
      searchResultCount: "Wyświetlono {count} pasujących agentów.",
      searchResultCountBounded:
        "{count} pasujących wyświetlonych agentów. Pełny widok Agentów może zawierać więcej.",
      unconfirmed:
        "Nie można potwierdzić aktywności agenta, dopóki jego źródło danych nie zostanie przywrócone.",
      unconfirmedShort: "Aktywność niezweryfikowana",
      showing:
        "Wyświetlanie {shown} z {total} agentów. Pilne i aktywne agenty są wyświetlane jako pierwsze.",
      openAll: "Otwórz wszystkich agentów",
      urgent: "Pilne",
      attention: "Wymaga uwagi",
      working: "Pracuje",
      waiting: "Czeka lub zaplanowane",
      recent: "Ostatnio zmienione",
      ready: "Gotowe",
      off: "Wyłączone lub nieznane",
      pin: "Przypnij {name}",
      unpin: "Odepnij {name}",
      pinned: "Przypięte",
      openAgent: "Otwórz agenta",
      reviewIssue: "Przejrzyj problem",
      whatNeedsAttention: "Co wymaga uwagi",
      blockedTaskNeedsDecision:
        "{count} zablokowane zadanie wymaga Twojej decyzji. Przejrzyj problem przed zmianą agenta.",
      blockedTasksNeedDecision:
        "{count} zablokowanych zadań wymaga Twojej decyzji. Przejrzyj problemy przed zmianą agenta.",
      urgentIssueNeedsDecision: "Pilny problem wymaga Twojej decyzji.",
      issueBeingHandled: "OpenClaw obsługuje problem dla tego agenta.",
      issueBeingWatched: "Problem dla tego agenta jest monitorowany.",
      technicalDetails: "Szczegóły techniczne",
      duty: "Dyżur",
      currentWork: "Bieżąca praca",
      lastActivity: "Ostatnia aktywność",
      taskCounts: "Zadania",
      taskCountSummary: "Aktywne: {active} · Zablokowane: {blocked}",
      model: "Model",
      fallback: "Awaryjne",
      heartbeat: "Sygnal życia",
      ram: "RAM",
      inheritedDefault: "Dziedziczona wartość domyślna",
      noFallback: "Brak jawnego rozwiązania zapasowego",
      readyForWork: "Gotowy do pracy",
      noCurrentWork: "Brak",
      unavailableRam: "Nieprzypisane",
      browserLocalPins: "Szpilki są zapisywane w tej przeglądarce.",
    },
    systemHealth: {
      eyebrow: "System",
      title: "Stan Maca",
      normal: "Normalny",
      memory: "Pojemność pamięci",
      memoryInUse: "{percent}% pod presją",
      memoryAvailable: "{percent}% dostępne",
      memorySummary: "{percent}% pamięci",
      memoryAndLocalAiSummary: "{percent}% pamięci · Procesy lokalnego AI: {count}",
      localModels: "Pamięć lokalnego AI",
      localModelProcessOne: "1 proces modelu · {rss} RSS procesu",
      localModelProcesses: "{count} procesy modelu · {rss} RSS procesu",
      gateway: "Gateway",
      cpu: "CPU",
      load: "Obciążenie {value}",
      responseDelay: "Opóźnienie odpowiedzi",
      milliseconds: "{count} ms",
      technicalDetails: "Szczegóły techniczne",
      gatewayRam: "RAM Gateway",
      host: "Host",
      logicalCores: "Logiczne rdzenie CPU",
      unavailable: "Niedostępne",
      memoryBreakdown: "{available} dostępne · {free} natychmiast wolne · {total} łącznie",
      memoryPressureNote:
        "Presja pamięci mierzy pojemność, którą macOS może udostępnić. RSS procesu lokalnego AI jest wyświetlany osobno i może zawierać strony modeli do odzyskania lub współdzielone.",
      agentRamNote: "Pamięć RAM na agenta jest niedostępna, gdy agenci współdzielą proces Gateway.",
    },
    automationsPanel: {
      eyebrow: "Automatyzacje",
      title: "Zaplanowana praca",
      none: "Nie skonfigurowano zaplanowanej pracy.",
      unconfirmed:
        "Zaplanowanej pracy nie można potwierdzić, dopóki źródło danych się nie odzyska.",
      openCron: "Otwórz zadania Cron",
      showing:
        "Wyświetlanie {shown} z {total}. Otwórz zadania Cron, aby przeglądać całą zaplanowaną pracę.",
      dueNow: "Termin teraz",
      noNextRun: "Brak kolejnego uruchomienia",
      runNow: "Uruchom teraz",
      pause: "Wstrzymaj",
      enable: "Włącz",
    },
    more: {
      title: "Więcej szczegółów operacji",
      subtitle: "Historia, przepływy pracy, harmonogramy, możliwości, modele i procesy hosta.",
      recentHistory: "Ostatnia historia",
      workflows: "Przepływy pracy",
      capabilities: "Skills, wtyczki, narzędzia i modele",
      processes: "Największe zużycie pamięci RAM",
      argumentsPrivate: "Argumenty nie są nigdy zbierane.",
      processRowsRejectedOne: "Nie udało się odczytać 1 wiersza procesu i został on wykluczony.",
      processRowsRejected:
        "Nie udało się odczytać {count} wierszy procesów i zostały one wykluczone.",
      processesShowing: "Wyświetlanie {shown} największych z {total} zaakceptowanych procesów.",
      configuredActive: "Skonfigurowane i aktywne są wyświetlane osobno.",
      configured: "Skonfigurowane",
      notConfigured: "Nie skonfigurowane",
      active: "Aktywne",
      inactive: "Nieaktywne",
      activityUnverified: "Aktywność niezweryfikowana",
      catalogUnavailable:
        "Nie można potwierdzić tego katalogu, dopóki jego źródło danych nie zostanie przywrócone.",
      catalogShowing: "Wyświetlanie {shown} z {total}",
      shadowMode: "Tryb cieni · brak automatycznych zmian",
      catalogued: "{count} skatalogowanych",
      available: "{count} dostępnych",
      needsSetup: "{count} wymaga konfiguracji",
      availabilityUnverified: "Dostępność niezweryfikowana",
      noHistory: "Nie zarejestrowano ostatniej historii.",
      noActivityHistory: "W tym migawce nie ma zarejestrowanej aktywności zadań.",
      activityHistoryUnavailable:
        "Nie można potwierdzić aktywności zadań na podstawie tej migawki.",
      activityHistory: "Aktywność zadań",
      activityCount: "Grupy aktywności: {count}",
      incidentHistory: "Historia incydentów",
      incidentCount: "Rekordy incydentów: {count}",
      historyUnavailable: "Szczegóły incydentów nie są dostępne w tej migawce.",
      changed: "Zmieniono {time}",
      transitionCount: "Przejścia poziomu krytyczności: {count}",
      historyOverflow:
        "{count} starszych incydentów znajduje się poza oknem przechowywanej historii.",
      historySnapshotBounded: "Ta migawka zawiera {shown} z {total} rekordów incydentów.",
      activitySnapshotBounded: "Zakres migawki: {shown} z {total} grup aktywności.",
      monitorIssue: "Monitor w tle zgłosił problem",
      monitorStatus: "Monitor: ostatnia próba {attempt}; ostatnie udane skanowanie {success}.",
      noWorkflows: "Nie zarejestrowano zarządzanych przepływów pracy.",
      noProcesses: "Szczegóły zasobów procesów są niedostępne.",
      processesUnavailable:
        "Nie można potwierdzić inwentaryzacji procesów na podstawie tej migawki.",
      processesOmitted: "Inwentaryzacja procesów nie została uwzględniona w tej migawce.",
      historySummary: "Wyniki historyczne: {findings} · Rekordy incydentów: {incidents}",
      workflowSummary: "Łącznie: {total} · Aktywne: {active}",
      showing: "wyświetlanie {shown}",
      skills: "Skills",
      plugins: "Wtyczki",
      tools: "Narzędzia",
      models: "Modele",
      noSkills: "Nie znaleziono żadnych Skills.",
      noPlugins: "Nie znaleziono żadnych wtyczek.",
      noTools: "Nie znaleziono żadnych narzędzi.",
    ...
    actions: {
      details: "Szczegóły",
      detailsFor: "Szczegóły dla {title}",
      cancel: "Anuluj",
      cancelWork: "Anuluj {title}",
      cancelWorkflow: "Anuluj przepływ pracy",
      runSchedule: "Uruchom {title} teraz",
      pauseSchedule: "Wstrzymaj {title}",
      enableSchedule: "Włącz {title}",
      unavailable: "Sterowanie jest niedostępne, dopóki te dane nie będą aktualne i kompletne.",
      cancelled: "Akcja anulowana. Nie wprowadzono zmian.",
      confirm: "{summary}\n\nRyzyko: {risk}\n\nTa chroniona akcja wygasa {expires}. Kontynuować?",
      risks: {
        low: "Niska",
        medium: "Średnia",
        high: "Wysoka",
    ...
    counts: {
      exact: "{count}",
      shown: "Wyświetlanie {shown} z {total}",
      compactShown: "{shown} z {total}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "Modele",
        processes: "Procesy",
        eventLoop: "Responsywność Gateway",
        monitor: "Monitor operacyjny",
        incidentLedger: "Historia incydentów",
      },
      categories: {
        agent: "Agent",
      ...
      dispositions: {
        needs_user: "Wymaga Twojej uwagi",
        handling: "OpenClaw obsługuje",
        watching: "Obserwowanie",
        historical: "Historyczne",
      },
    },
    footer: "Tylko deterministyczne monitorowanie. Bez wywołań modelu ani automatycznych mutacji.",
  },
  tabs: {
    agents: "Agenci",
    activity: "Aktywność",
  ...
  subtitles: {
    ...
    operations: "Agenci, przepływy pracy, możliwości, modele i zasoby w jednym miejscu.",
  ...
  workboard: {
    ...
    dispatch: "Wyślij gotowe zadania",
    dispatchSummary:
  ...
  chat: {
    ...
    prepareVerifiedUpdate: "Przygotuj zweryfikowaną aktualizację",
    preparingVerifiedUpdate: "Przygotowywanie zweryfikowanej aktualizacji…",
    installVerifiedUpdate: "Zainstaluj zweryfikowaną aktualizację",
    exactShaApprovalRequired: "Wymagana akceptacja dokładnego SHA",
    updateProtectionIncomplete: "Ochrona aktualizacji wymaga uwagi.",
    ...
    modelPicker: {
      ...
      unavailable: "Niedostępne — wybierz inny model",
      contentionWarning: "Używane przez innego aktywnego agenta — może działać wolniej",
    },
    pairingQrExpired: {
