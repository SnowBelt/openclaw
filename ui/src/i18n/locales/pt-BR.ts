...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    pcc: "Goals, milestones, ownership, and proof.",
  ...
  pcc: {
    ...
    subtitle: "Turn a goal into visible work, milestones, and verifiable proof.",
    projectLabel: "Project",
    noProjects: "No projects yet",
    emptyTitle: "Start your first project",
    emptyDescription:
      "Create a project to track a goal, its milestones, and the evidence that proves it works.",
    projectEyebrow: "Selected project",
    noGoal: "No goal description yet.",
    progressLabel: "Project completion",
    milestones: "{complete} of {total} milestones complete",
    owner: "Owner: {owner}",
    updated: "Updated {time}",
    blocked: "{count} milestone(s) blocked. Review the blocker before continuing.",
    needsApproval: "{count} milestone(s) need approval before work can continue.",
    milestonesTitle: "Milestones",
    milestonesHint: "Each milestone keeps its status and blocker visible.",
    noMilestones: "No milestones have been recorded for this project yet.",
    createProject: "Create project",
    titleLabel: "Project title",
    goalLabel: "Objetivo",
    createAction: "Create project",
    planTitle: "Planning",
    planHint: "Use the approved planning runtime to propose the next bounded work.",
    planLabel: "What should happen next?",
    planPlaceholder: "Describe the next outcome or correction",
    startPlan: "Start plan",
    planning: "Planning…",
    runStatus: "Planning run {id}: {status}",
    refresh: "Refresh Project Command Center",
    disconnected: "Connect to the Gateway to load Project Command Center data.",
    goalControlsTitle: "Guided work loop",
    goalControlsHint:
      "Start, pause, resume, or retry bounded work. Progress and proof stay attached to this project.",
    goalActions: {
      start: "Start work",
    ...
    proofTitle: "Evidence and next steps",
    proofHint: "The server record is the source of truth for actions, permissions, and proof.",
    evidenceCount: "{count} evidence item(s)",
    nextActionsTitle: "Next actions",
    proofGapsTitle: "Proof gaps",
    permissionsTitle: "Permissions",
    evidenceTitle: "Evidence",
    receiptsAndAttachments: "Receipts and attachments",
    receiptsAndAttachmentsCount: "{count} completion receipt(s)",
    noneRecorded: "Nothing recorded yet.",
    noProofGaps: "No proof gaps recorded.",
    noPermissions: "No permissions currently required.",
    noAttachments: "No attachments recorded.",
    attachmentsUnavailable: "Attachments could not be loaded",
    ownerAcceptance: {
      title: "Owner acceptance",
      hint: "A single timed check confirms that this project is understandable without coaching.",
      ready: "Ready",
      running: "In progress",
      ...
      readyDescription:
        "When you are ready, begin the timer and use this page naturally without assistance for 60 seconds.",
      begin: "Begin 60-second acceptance",
      beginNew: "Begin a new attempt",
      finish: "Record acceptance",
      cancel: "Cancel and record attempt",
      timer: "Elapsed: {seconds}s",
      remaining: "{seconds}s remaining",
      submittingDescription: "Saving the anonymous acceptance receipt…",
      completeDescription: "Owner acceptance passed and the receipt is attached to this project.",
      failedDescription: "This attempt did not complete. The attempt remains recorded.",
      privacy: "Only an anonymous participant hash, timing, outcome, and receipt are stored.",
    },
  },
  activity: {
    title: "Atividade",
