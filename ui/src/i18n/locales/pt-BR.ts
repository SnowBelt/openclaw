...
export const pt_BR: TranslationMap = {
  ...
  sessionsView: {
    ...
    truthAuditStatusPassed: "Passed",
    truthAuditStatusBlocked: "Blocked",
    truthAuditStatusNotRequired: "Not required",
    truthAuditMatchMatched: "matched",
    truthAuditMatchMissing: "missing",
    truthAuditRun: "Run {runId}",
    truthAuditPayloads: "{checked} checked · {rewritten} rewritten",
    truthAuditMissing: "Missing:",
    truthAuditNoClaims: "No truth claims recorded for this audit.",
    truthAuditClaimHash: "Claim hash",
    truthAuditRequiredEvidence: "Required evidence",
    truthAuditEvidence: "Evidence",
    truthAuditMissingCondition: "Missing condition",
    truthAuditRewriteAction: "Rewrite action",
    truthAuditHiddenClaims: "{count} more claims hidden",
  },
  agents: {
    noAgents: "No agents",
    copyId: "Copy ID",
  ...
  subtitles: {
    ...
    musicStudio: "Crie prompts, arranje, toque e finalize músicas originais.",
  ...
  overview: {
    ...
    cards: {
      ...
      judgeGuardOpenSessions: "Sessões",
      ...
      truthAudit: "Truth Audit",
      truthAuditSubtitle: "Control Director truth claims blocked or rewritten before delivery.",
      truthAuditOpenSessions: "Sessões",
      truthAuditOpenSession: "Open session transcript",
      truthAuditPassed: "PASSED",
      truthAuditBlocked: "BLOCKED",
      truthAuditNotRequired: "NOT REQUIRED",
