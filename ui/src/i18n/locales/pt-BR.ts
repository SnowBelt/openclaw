...
export const pt_BR: TranslationMap = {
  ...
  operationsRoom: {
    ...
    working: {
      ...
      subtitle: "Resultados ativos, agrupados sem repetir instruções brutas.",
      none: "Nenhum agente está trabalhando ativamente no momento.",
      unconfirmed:
    ...
    systemHealth: {
      ...
      memoryAndLocalAiSummary: "{percent}% memory · Local AI: {count} running",
