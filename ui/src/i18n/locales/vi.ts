...
export const vi: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "Mặt phẳng điều khiển OpenClaw",
    title: "Phòng Vận hành",
    subtitle: "Những gì cần chú ý, những gì đang hoạt động và tình trạng hệ thống.",
    refresh: "Làm mới",
    refreshing: "Đang làm mới…",
    refreshLabel: "Làm mới Phòng Vận hành",
    updated: "Đã cập nhật {time}",
    live: "Trực tiếp",
    stale: "Lần cuối biết đến",
    partial: "Dữ liệu không đầy đủ",
    unavailableTitle: "Không có dữ liệu vận hành",
    actionFailedTitle: "Hành động chưa hoàn thành",
    staleTitle: "Cập nhật trực tiếp thất bại",
    staleDetail: "Hiển thị bản chụp thành công cuối cùng từ {time}.",
    unavailableSources: "Nguồn không khả dụng: {sources}.",
    fallbackSources: "Nguồn dữ liệu dự phòng: {sources}.",
    loading: "Đang xây dựng bức tranh vận hành hiện tại…",
    empty: "Chưa có bản chụp vận hành nào khả dụng.",
    now: "Bây giờ",
    briefingUnavailable:
      "Không thể xác nhận tổng quan hiện tại. Xem trạng thái cụ thể của nguồn bên dưới.",
    lastKnownBriefing: "Hiển thị tổng quan lần cuối biết đến",
    briefingTone: {
      normal: "Đã cập nhật",
      attention: "Cần chú ý",
      urgent: "Khẩn cấp",
    ...
    overallBriefingTone: {
      normal: "Tổng quan: Đã cập nhật",
      attention: "Tổng quan: Cần chú ý",
      urgent: "Tổng quan: Khẩn cấp",
      unknown: "Tổng quan: Trạng thái không xác định",
    },
    overviewNav: "Tổng quan hoạt động",
    reviewCount: "Đang xem xét {count}",
    reviewUnconfirmed: "Đang xem xét —",
    decisionCount: "Cần quyết định {count}",
    decisionsUnconfirmed: "Cần quyết định —",
    workingCount: "Đang làm việc {count}",
    workingCountBounded: "Đang làm việc {count}+",
    ...
    urgentCount: "{count} khẩn cấp",
    activeAgentsCount: "Agents đang hoạt động: {count}",
    workingItemsCount: "Mục đang xử lý: {count}",
    showingAgents: "Hiển thị {count}",
    attentionAgentsCount: "{count} cần chú ý",
    agentStatusSummary: "{working} đang làm việc · {attention} cần chú ý",
    automationCount: "Lịch trình: {total} · Lỗi: {failing}",
    ...
    attention: {
      eyebrow: "Cần xem xét",
      title: "Chú ý",
      subtitle: "Các vấn đề hiện tại được ưu tiên. Các sự kiện lịch sử nằm trong mục Khác.",
      needsYou: "Cần bạn xử lý",
      handling: "OpenClaw đang xử lý",
      watching: "Đang theo dõi",
      none: "Không có gì cần chú ý.",
      noCritical: "Không có vấn đề nghiêm trọng nào đang hoạt động.",
      currentCount: "{count} hiện tại",
      noneNeedsYou: "Không có quyết định hoặc can thiệp nào đang chờ bạn.",
      noneHandling: "Không có biện pháp khắc phục nào đang được thực hiện.",
      noneWatching: "Không có gì đang được theo dõi.",
      impact: "Tác động",
      ...
      highestPriority: "Vấn đề ưu tiên cao nhất",
      whoOwnsThis: "Ai chịu trách nhiệm",
      whatHappensNext: "Tiếp theo sẽ diễn ra gì",
      continueMonitoring: "Tiếp tục giám sát.",
      observed: "Quan sát thấy {time}",
      lastKnown: "Biết đến lần cuối",
      unconfirmedTitle: "Không thể xác nhận trạng thái chú ý",
      unconfirmedDetail:
        "Các vấn đề đã biết được hiển thị bên dưới, nhưng dữ liệu không đầy đủ hoặc dữ liệu cuối cùng có thể bỏ sót các vấn đề mới hơn.",
      unconfirmedShort: "Cần xác minh",
      showingCurrent:
        "Hiển thị {shown} trong số {total} vấn đề hiện tại trong bản chụp giới hạn này. Các chế độ xem nguồn cung cấp các bản ghi liên quan.",
      outsidePreview:
        "{count} vấn đề hiện tại nằm ngoài bản xem trước này. Mở một chế độ xem nguồn ở trên.",
      lastProgress: "Tiến độ cuối cùng",
      nextCheck: "Kiểm tra tiếp theo",
      remediationTask: "Nhiệm vụ khắc phục",
      openRemediation: "Mở khắc phục",
      responseStates: {
        unassigned: "Chưa được chỉ định",
        in_progress: "Đang thực hiện",
        monitoring: "Đang giám sát",
        waiting_for_user: "Đang chờ bạn",
        resolved: "Đã giải quyết",
      },
    },
    resolution: {
      ...
      judgeReview: "Đánh giá an toàn độc lập: {decision} — {reason}",
      approved: "Đã phê duyệt",
      rejected: "Bị từ chối",
      rollback: "Kế hoạch hoàn tác",
      undoAvailability: "Khả năng hoàn tác",
      undoAvailable: "Có sẵn thông qua xem trước được bảo vệ",
      undoUnavailable: "Không có tùy chọn Hoàn tác trực tiếp",
      viewRepairDetails: "Xem chi tiết sửa chữa",
      result: "Kết quả",
      undo: "Hoàn tác sửa chữa này",
    ...
    working: {
      ...
      countsUnconfirmed: "Không thể xác nhận số lượng",
      itemsCount: "{count} mục đang hoạt động",
      itemsCountBounded: "Ít nhất {count} mục đang hoạt động",
      showingPreview:
        "Hiển thị {shown} tóm tắt công việc gần đây. Workboard chứa các bản ghi nhiệm vụ và quy trình làm việc được quản lý.",
      openWorkboard: "Mở Workboard",
      details: "Chi tiết công việc",
      relatedRuns: "{count} lần chạy liên quan",
      workTotals: "Tổng số nhiệm vụ và quy trình làm việc",
      tasks: "Nhiệm vụ",
      taskTotals: "Hoạt động: {active} · Cần chú ý: {failed} · Tổng: {total}",
      workflows: "Quy trình làm việc",
      workflowTotals: "Hoạt động: {active} · Tổng: {total}",
    },
    activityComparison: {
      eyebrow: "Hoạt động hiện tại",
      title: "Đang chạy gì",
      subtitle: "Hai tín hiệu khác nhau, hiển thị cùng lúc.",
      openClawLabel: "Công việc do OpenClaw quản lý",
      openClawCountOne: "1 tác nhân đang làm việc",
      openClawCount: "{count} tác nhân đang làm việc",
      openClawDetail: "Các nhiệm vụ và quy trình mà OpenClaw đang quản lý tích cực.",
      localAiLabel: "AI cục bộ độc lập",
      localAiCountOne: "1 tiến trình mô hình đã tải",
      localAiCount: "{count} tiến trình mô hình đã tải",
      localAiDetail:
        "Các mô hình được tải trên Mac này. Một tiến trình đã tải không nhất thiết có nghĩa là nó đang tạo ra nội dung ngay lúc này.",
      unconfirmed: "Không thể xác nhận",
    },
    ownerAcceptance: {
      ...
      activityQuestion: "Đang chạy gì ngay bây giờ?",
      activityAnswer: "OpenClaw: {openClaw} · AI cục bộ: {localAi}",
      ...
      elapsed: "Hoàn thành trong {seconds} giây.",
      copyReceipt: "Sao chép biên lai",
      copied: "Đã sao chép biên lai",
      copyFailed: "Không thể sao chép. Hãy dùng Tải xuống biên lai thay thế.",
      downloadReceipt: "Tải xuống biên lai",
    },
    changes: {
      eyebrow: "Thay đổi gần đây",
      title: "Kể từ lần bạn truy cập trước",
      none: "Không có thay đổi đáng kể kể từ lần bạn truy cập trước.",
      unconfirmed:
        "Không thể xác nhận các thay đổi gần đây cho đến khi nguồn dữ liệu của chúng được khôi phục.",
      firstVisit: "Các thay đổi đáng kể gần đây",
      incidentResolved: "Vấn đề đã được giải quyết",
      incidentChanged: "Vấn đề đã thay đổi",
      showingNewest: "Hiển thị {count} thay đổi mới nhất. Mở lịch sử có sẵn để xem chi tiết.",
      openActivity: "Mở lịch sử có sẵn",
      activitySummaryOne: "1 lần chạy {runtime} liên quan {result}.",
      activitySummary: "{count} lần chạy {runtime} liên quan {result}.",
      outcomes: {
        ...
        failed: "thất bại",
        cancelled: "đã hủy",
        unknown: "kết thúc với kết quả không xác định",
      },
      remediationOutcomes: {
        completed: "OpenClaw đã sửa chữa và xác minh vấn đề này",
        rolled_back: "OpenClaw tự động hoàn tác một lần sửa chữa không được xác minh",
        failed: "Sửa chữa tự động bị dừng và cần xem xét",
        approval_required: "OpenClaw đã dừng và yêu cầu phê duyệt",
      },
    },
    agents: {
      eyebrow: "Phòng trực tiếp",
      title: "Agents",
      subtitle: "Ưu tiên vận hành hàng đầu. Các agent sẵn sàng sẽ được thu gọn.",
      searchLabel: "Tìm kiếm agents",
      searchPlaceholder: "Tìm kiếm agents",
      sortLabel: "Sắp xếp agents",
      sortPriority: "Ưu tiên",
      sortName: "Tên",
      sortRecent: "Hoạt động gần đây",
      noMatches: "Không có agent nào khớp với tìm kiếm này.",
      noShownMatches: "Không có agent hiển thị nào khớp. Hãy tìm trong chế độ xem Agents đầy đủ.",
      searchResultCount: "{count} agents khớp được hiển thị.",
      searchResultCountBounded:
        "{count} agents khớp được hiển thị. Chế độ xem Agents đầy đủ có thể bao gồm nhiều hơn.",
      unconfirmed:
        "Không thể xác nhận hoạt động của Agent cho đến khi nguồn dữ liệu của nó được khôi phục.",
      unconfirmedShort: "Hoạt động chưa xác minh",
      showing:
        "Hiển thị {shown} trong tổng số {total} agent. Các agent khẩn cấp và đang hoạt động sẽ xuất hiện trước.",
      openAll: "Mở tất cả agent",
      urgent: "Khẩn cấp",
      attention: "Cần chú ý",
      working: "Đang làm việc",
      waiting: "Đang chờ hoặc đã lên lịch",
      recent: "Mới thay đổi",
      ready: "Sẵn sàng",
      off: "Tắt hoặc không xác định",
      pin: "Ghim {name}",
      unpin: "Bỏ ghim {name}",
      pinned: "Đã ghim",
      openAgent: "Mở agent",
      reviewIssue: "Xem xét vấn đề",
      whatNeedsAttention: "Điều gì cần chú ý",
      blockedTaskNeedsDecision:
        "{count} tác vụ bị chặn cần quyết định của bạn. Xem xét vấn đề trước khi thay đổi tác nhân.",
      blockedTasksNeedDecision:
        "{count} tác vụ bị chặn cần quyết định của bạn. Xem xét các vấn đề trước khi thay đổi tác nhân.",
      urgentIssueNeedsDecision: "Một vấn đề khẩn cấp cần quyết định của bạn.",
      issueBeingHandled: "OpenClaw đang xử lý một vấn đề cho tác nhân này.",
      issueBeingWatched: "Một vấn đề cho tác nhân này đang được theo dõi.",
      technicalDetails: "Chi tiết kỹ thuật",
      duty: "Nhiệm vụ",
      currentWork: "Công việc hiện tại",
      lastActivity: "Hoạt động gần nhất",
      taskCounts: "Tác vụ",
      taskCountSummary: "Đang hoạt động: {active} · Bị chặn: {blocked}",
      model: "Mô hình",
      fallback: "Dự phòng",
      heartbeat: "Nhịp tim",
      ram: "RAM",
      inheritedDefault: "Mặc định kế thừa",
      noFallback: "Không có phương án dự phòng rõ ràng",
      readyForWork: "Sẵn sàng làm việc",
      noCurrentWork: "Không",
      unavailableRam: "Không thể quy thuộc",
      browserLocalPins: "Các ghim được lưu trong trình duyệt này.",
    },
    systemHealth: {
      eyebrow: "Hệ thống",
    ...
    automationsPanel: {
      eyebrow: "Tự động hóa",
      title: "Công việc được lên lịch",
      none: "Chưa cấu hình công việc nào được lên lịch.",
      unconfirmed:
        "Không thể xác nhận công việc được lên lịch cho đến khi nguồn dữ liệu của nó phục hồi.",
      openCron: "Mở Cron Jobs",
      showing:
        "Hiển thị {shown} trong số {total}. Mở Cron Jobs để xem lại tất cả công việc được lên lịch.",
      dueNow: "Đến hạn ngay bây giờ",
      noNextRun: "Không có lần chạy tiếp theo",
      runNow: "Chạy ngay",
      pause: "Tạm dừng",
      enable: "Bật",
    },
    more: {
      title: "Chi tiết hoạt động khác",
      subtitle: "Lịch sử, quy trình làm việc, lịch trình, khả năng, mô hình và tiến trình máy chủ.",
      recentHistory: "Lịch sử gần đây",
      workflows: "Quy trình làm việc",
      capabilities: "Skills, plugins, tools, and models",
      processes: "Các tiến trình tiêu thụ RAM nhiều nhất",
      argumentsPrivate: "Arguments không bao giờ được thu thập.",
      processRowsRejectedOne: "1 hàng tiến trình không thể đọc và đã bị loại trừ.",
      processRowsRejected: "{count} hàng tiến trình không thể đọc và đã bị loại trừ.",
      processesShowing: "Hiển thị {shown} lớn nhất trong số {total} tiến trình được chấp nhận.",
      configuredActive: "Đã cấu hình và đang hoạt động được hiển thị riêng biệt.",
      configured: "Đã cấu hình",
      notConfigured: "Chưa cấu hình",
      active: "Hoạt động",
      inactive: "Không hoạt động",
      activityUnverified: "Hoạt động chưa được xác minh",
      catalogUnavailable:
        "Danh mục này không thể xác nhận cho đến khi nguồn dữ liệu của nó phục hồi.",
      catalogShowing: "Hiển thị {shown} trong số {total}",
      shadowMode: "Chế độ Shadow · không có thay đổi tự động",
      catalogued: "{count} đã được liệt kê",
      available: "{count} khả dụng",
      needsSetup: "{count} cần thiết lập",
      availabilityUnverified: "Khả dụng chưa được xác minh",
      noHistory: "Không có lịch sử gần đây nào được ghi lại.",
      noActivityHistory: "Không có hoạt động tác vụ nào được ghi lại trong bản chụp này.",
      activityHistoryUnavailable: "Không thể xác nhận hoạt động tác vụ từ bản chụp này.",
      activityHistory: "Hoạt động tác vụ",
      activityCount: "Nhóm hoạt động: {count}",
      incidentHistory: "Lịch sử sự cố",
      incidentCount: "Bản ghi sự cố: {count}",
      historyUnavailable: "Chi tiết sự cố không khả dụng trong bản chụp này.",
      changed: "Đã thay đổi {time}",
      transitionCount: "Chuyển đổi mức độ nghiêm trọng: {count}",
      historyOverflow: "{count} sự cố cũ hơn nằm ngoài cửa sổ lịch sử được lưu giữ.",
      historySnapshotBounded: "Bản chụp này bao gồm {shown} trong số {total} bản ghi sự cố.",
      activitySnapshotBounded: "Phạm vi bản chụp: {shown} trong số {total} nhóm hoạt động.",
      monitorIssue: "Trình giám sát nền đã báo cáo một vấn đề",
      monitorStatus:
        "Trình giám sát: lần thử gần nhất {attempt}; lần quét thành công gần nhất {success}.",
      noWorkflows: "Không có quy trình làm việc được quản lý nào được ghi lại.",
      noProcesses: "Chi tiết tài nguyên tiến trình không khả dụng.",
      processesUnavailable: "Không thể xác nhận danh mục tiến trình từ bản chụp này.",
      processesOmitted: "Danh mục tiến trình không được bao gồm trong bản chụp này.",
      historySummary: "Kết quả lịch sử: {findings} · Bản ghi sự cố: {incidents}",
      workflowSummary: "Tổng cộng {total} · Đang hoạt động {active}",
      showing: "hiển thị {shown}",
      skills: "Skills",
      plugins: "Plugins",
      tools: "Tools",
      models: "Models",
      noSkills: "Không tìm thấy Skills nào.",
      noPlugins: "Không tìm thấy Plugins nào.",
      noTools: "Không tìm thấy Tools nào.",
      noModels: "Không tìm thấy Models nào.",
    ...
    actions: {
      details: "Chi tiết",
      detailsFor: "Chi tiết cho {title}",
      cancel: "Hủy",
      cancelWork: "Hủy {title}",
      cancelWorkflow: "Hủy quy trình làm việc",
      runSchedule: "Chạy {title} ngay",
      pauseSchedule: "Tạm dừng {title}",
      enableSchedule: "Bật {title}",
      unavailable: "Các điều khiển không khả dụng cho đến khi dữ liệu này mới và đầy đủ.",
      cancelled: "Hành động đã bị hủy. Không có gì thay đổi.",
      confirm:
        "{summary}\n\nRủi ro: {risk}\n\nHành động được bảo vệ này hết hạn vào {expires}. Tiếp tục?",
      risks: {
        low: "Thấp",
        medium: "Trung bình",
        high: "Cao",
    ...
    counts: {
      exact: "{count}",
      shown: "Hiển thị {shown} trong tổng số {total}",
      compactShown: "{shown} của {total}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "Mô hình",
        processes: "Quy trình",
        eventLoop: "Khả năng phản hồi của Gateway",
        monitor: "Trình theo dõi hoạt động",
        incidentLedger: "Lịch sử sự cố",
      },
      categories: {
        agent: "Tác nhân",
      ...
      routes: {
        ...
        metered: "Tính phí theo lượng",
        unknown: "Không xác định được tuyến đường",
      },
      processKinds: {
        gateway: "Gateway",
        local_model: "Mô hình nội bộ",
        browser: "Trình duyệt",
        other: "Khác",
      },
      dispositions: {
        needs_user: "Cần bạn xử lý",
        handling: "OpenClaw đang xử lý",
        watching: "Đang theo dõi",
        historical: "Lịch sử",
      },
    },
    footer: "Chỉ giám sát xác định. Không có cuộc gọi mô hình hoặc đột biến tự động.",
  },
  tabs: {
    agents: "Agent",
    activity: "Hoạt động",
    overview: "Tổng quan",
    operations: "Phòng điều hành",
  ...
  subtitles: {
    ...
    operations: "Xem nhanh các tác nhân, quy trình, khả năng, mô hình và tài nguyên.",
