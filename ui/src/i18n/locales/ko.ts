...
export const ko: TranslationMap = {
  ...
  operationsRoom: {
    ...
    resolution: {
      ...
      preview: "해결 방안 미리보기",
      resolveFor: "{title} 해결",
      previewOnly: "미리보기 전용입니다.",
      previewOnlyDetail: "변경 사항이 없습니다.",
      closePreview: "미리보기 닫기 — 변경하지 않음",
      whatHappened: "발생 사항",
      progress: "진행 상황",
      risk: "이슈 위험도",
      changePreview: "변경 사항",
    ...
    ownerAcceptance: {
      ...
      subtitle:
        "시작을 클릭하면 타이머가 시작됩니다. 화면을 읽고, 답을 선택하고, 최우선 해결책을 미리 본 후 변경 없이 닫으세요.",
      begin: "60초 점검 시작",
      secondsLeft: "초 남음",
      ...
      resolveQuestion: "최우선 해결책을 미리 본 후 변경 없이 닫으세요.",
      resolvePending: "아직 완료되지 않음",
      resolveDone: "미리 보기 열기 및 안전하게 닫기 완료",
      finish: "완료 및 영수증 생성",
      passed: "소유자 점검 통과",
      failed: "소유자 점검 불통과",
