...
export const ko: TranslationMap = {
  ...
  chat: {
    ...
    updating: "업데이트 중…",
    updateNow: "지금 업데이트",
    prepareVerifiedUpdate: "검증된 업데이트 준비",
    preparingVerifiedUpdate: "검증된 업데이트 준비 중…",
    installVerifiedUpdate: "검증된 업데이트 설치",
    exactShaApprovalRequired: "정확한 SHA 승인이 필요합니다",
    updateProtectionIncomplete: "업데이트 보호를 확인해야 합니다.",
