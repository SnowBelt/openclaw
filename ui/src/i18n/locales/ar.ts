...
export const ar: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "مستوى التحكم في OpenClaw",
    title: "غرفة العمليات",
    subtitle: "ما يحتاج إلى انتباهك، وما يعمل بشكل صحيح، وكيفية أداء النظام.",
    refresh: "تحديث",
    refreshing: "جارٍ التحديث…",
    refreshLabel: "تحديث غرفة العمليات",
    updated: "تم التحديث {time}",
    live: "مباشر",
    stale: "آخر معلوم",
    partial: "بيانات جزئية",
    unavailableTitle: "بيانات العمليات غير متاحة",
    actionFailedTitle: "لم يكتمل الإجراء",
    staleTitle: "فشل التحديث المباشر",
    staleDetail: "عرض آخر لقطة ناجحة من {time}.",
    unavailableSources: "المصادر غير المتاحة: {sources}.",
    fallbackSources: "مصادر البيانات البديلة: {sources}.",
    loading: "جارٍ بناء صورة العمليات الحالية…",
    empty: "لا توجد لقطة عمليات متاحة بعد.",
    now: "الآن",
    briefingUnavailable: "لا يمكن تأكيد النظرة العامة الحالية. راجع الحالة الخاصة بكل مصدر أدناه.",
    lastKnownBriefing: "عرض آخر نظرة عامة معروفة",
    briefingTone: {
      normal: "محدّث",
    ...
    overallBriefingTone: {
      normal: "بشكل عام: محدّث",
      attention: "بشكل عام: يحتاج إلى انتباهك",
      urgent: "بشكل عام: عاجل",
      unknown: "بشكل عام: الحالة غير معروفة",
    },
    overviewNav: "نظرة عامة على العمليات",
    reviewCount: "مراجعة {count}",
    reviewUnconfirmed: "مراجعة —",
    decisionCount: "قرارات مطلوبة {count}",
    decisionsUnconfirmed: "قرارات مطلوبة —",
    workingCount: "يعمل الآن {count}",
    workingCountBounded: "يعمل الآن {count}+",
    workingUnconfirmed: "يعمل الآن —",
    agentsWorkingNowCount: "وكلاء يعملون الآن {count}",
    agentsWorkingUnconfirmed: "وكلاء يعملون الآن —",
    openClawWorkCount: "عمل OpenClaw {count}",
    openClawWorkUnconfirmed: "عمل OpenClaw —",
    allAgentsCount: "جميع الوكلاء {count}",
    agentsUnconfirmed: "جميع الوكلاء —",
    agentsCount: "{count} وكيل",
    urgentCount: "{count} عاجل",
    activeAgentsCount: "الوكلاء النشطون: {count}",
    workingItemsCount: "العناصر قيد العمل: {count}",
    showingAgents: "عرض {count}",
    attentionAgentsCount: "{count} يحتاجون إلى انتباه",
    agentStatusSummary: "{working} قيد العمل · {attention} يحتاج انتباهك",
    automationCount: "الجداول الزمنية: {total} · الفاشلة: {failing}",
    automations: "الأتمتة",
    system: "النظام",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "يحتاج إلى مراجعة",
      title: "انتباه",
      subtitle: "المشكلات الحالية أولاً. تظل الأحداث التاريخية في المزيد.",
      needsYou: "يحتاج إليك",
      handling: "OpenClaw يتعامل مع الأمر",
      watching: "مراقبة",
      none: "لا شيء يحتاج إلى انتباهك.",
      noCritical: "لا توجد مشكلة حرجة نشطة.",
      currentCount: "{count} حالي",
      noneNeedsYou: "لا يوجد قرار أو تدخل في انتظارك.",
      noneHandling: "لا يوجد إجراء علاجي نشط قيد التنفيذ.",
      noneWatching: "لا شيء يتم مراقبته.",
      impact: "الأثر",
      owner: "المالك",
      you: "أنت",
      unassignedOwner: "غير مُسند",
      response: "الاستجابة",
      nextAction: "الإجراء التالي",
      nextActionShort: "التالي",
      highestPriority: "أعلى أولوية للمشكلة",
      whoOwnsThis: "من المسؤول عن هذا؟",
      whatHappensNext: "ما الذي سيحدث بعد ذلك؟",
      continueMonitoring: "متابعة المراقبة.",
      observed: "تم ملاحظته {time}",
      lastKnown: "آخر معلوم",
      unconfirmedTitle: "لا يمكن تأكيد حالة الانتباه",
      unconfirmedDetail:
        "يتم عرض المشكلات المعروفة أدناه، لكن البيانات غير المكتملة أو الأخيرة المعروفة قد تحذف المشكلات الأحدث.",
      unconfirmedShort: "يحتاج إلى التحقق",
      showingCurrent:
        "عرض {shown} من أصل {total} مشكلات حالية في هذه اللقطة المحدودة. توفر عروض المصدر السجلات ذات الصلة.",
      outsidePreview: "{count} مشكلات حالية خارج هذا العرض المصغر. افتح عرض مصدر أعلاه.",
      lastProgress: "آخر تقدم",
      nextCheck: "التحقق التالي",
      remediationTask: "مهمة المعالجة",
      openRemediation: "فتح المعالجة",
      responseStates: {
        unassigned: "غير مُسند",
        in_progress: "قيد التنفيذ",
        monitoring: "قيد المراقبة",
        waiting_for_user: "في انتظارك",
        resolved: "تم الحل",
      },
    },
    resolution: {
      resolve: "حل",
      preview: "الحل الموصى به",
      recommendation: "الحل الموصى به",
      resolveFor: "مراجعة الحل الموصى به لـ {title}",
      previewOnly: "توصية فقط.",
      previewOnlyDetail: "لا يحدث أي تغيير حتى يتم الموافقة على إصلاح مؤهل.",
      closePreview: "ليس الآن",
      notNow: "ليس الآن",
      recommendedLabel: "الإصلاح الموصى به:",
      recommendedFix: "الإصلاح الموصى به",
      whyRecommended: "لماذا يُوصى بهذا",
      defaultReason: "هذه هي الخطوة التالية الأكثر أماناً المدعومة بالأدلة المتاحة حالياً.",
      confidence: "مستوى الثقة",
      confidencePending: "قيد التحقيق المحلي",
      confidenceValue: "{confidence}% ثقة",
      whatHappened: "ماذا حدث",
      progress: "التقدم",
      risk: "مخاطر المشكلة",
      changePreview: "ما الذي سيتغير",
      verification: "كيف سيقوم OpenClaw بالتحقق من ذلك",
      verificationPending: "يتطلب الأمر خطة تحقق حتمية قبل تشغيل أي تغيير تلقائي.",
      approval: "موافقتك",
      evidence: "تحديثات التقدم",
      localReview: "مراجعة محلية ({confidence}%): {recommendation}",
      judgeReview: "مراجعة أمان مستقلة: {decision} — {reason}",
      approved: "تمت الموافقة",
      rejected: "مرفوض",
      rollback: "خطة التراجع",
      undoAvailability: "إمكانية التراجع",
      undoAvailable: "متاح من خلال معاينة محمية",
      undoUnavailable: "لا يتوفر تراجع مباشر",
      viewRepairDetails: "عرض تفاصيل الإصلاح",
      result: "النتيجة",
      undo: "تراجع عن هذا الإصلاح",
      investigate: "التحقيق باستخدام الذكاء الاصطناعي المحلي",
      reviewEscalation: "مراجعة مع Codex",
      reviewCancellation: "مراجعة الإلغاء",
      fixThis: "إصلاح هذا لي",
      investigationPreview:
        "لا يتغير أي شيء بعد. سيتم فتح مسودة تحقيق للقراءة فقط لمراجعتها وإرسالها.",
      cancelPreview: 'تحضير معاينة محمية لإلغاء "{title}".',
      approvalRequired: "يجب الموافقة على أي تغيير قبل حدوثه.",
      oneConfirmation: "يُطلب تأكيد موجز واحد لأن هذا إصلاح متوسط المخاطر مُراجع وقابل للعكس.",
      automaticPolicy: "قد يقوم OpenClaw بتشغيل هذا الإصلاح المعتمد تلقائيًا لأنه محدود وقابل للعكس.",
      evidenceLocation: 'ستظهر التقدم والأدلة في هذه المشكلة، وقسم "منذ زيارتك الأخيرة"، وWorkboard.',
      investigationRollback:
        "غير مطلوب بعد لأن التحقيق لا يجري أي تغييرات. يجب أن يتضمن أي إصلاح مقترح خطة التراجع.",
      cancelRollback:
        "لا يمكن للإلغاء استعادة العمل المكتمل. راجع معاينة التغيير الدقيقة قبل الموافقة عليها.",
      progressLocationLabel: "مكان ظهور التقدم",
      safeguard:
        "لا تزال التغييرات عالية الخطورة، أو غير القابلة للعكس، أو الحساسة أمنياً، أو المالية، أو المتعلقة بالبيانات الاعتمادية، أو الإصدارات، أو المدمرة، أو الجديدة، أو غير المؤكدة تتطلب تأكيدك.",
      draftNotice: "فتح المسودة لا يعني إرسالها أو بدء العمل.",
      nextStepUnknown: "لم يتم تأكيد الخطوة التالية الآمنة. قم بالتحقيق قبل تغيير أي شيء.",
      stages: {
        needs_review: "يحتاج إلى مراجعة",
        openclaw_handling: "OpenClaw يتعامل مع هذا",
        watching: "OpenClaw يراقب هذا",
        resolved: "تم الحل",
      },
      risks: {
        low: "منخفضة",
    ...
    working: {
      ...
      title: "يعمل الآن",
      subtitle:
        "مهام وسير عمل مُدارة بواسطة OpenClaw فقط. تظهر عمليات الذكاء الاصطناعي المحلية تحت النظام.",
      none: "لا يوجد وكيل OpenClaw يعمل بنشاط الآن.",
      unconfirmed: "لا يمكن تأكيد العمل الحالي حتى تستعيد مصادر البيانات عملها.",
      unverified: "العمل الحالي غير موثّق",
      countsUnconfirmed: "لا يمكن تأكيد الأرقام",
      itemsCount: "{count} عناصر قيد العمل",
      itemsCountBounded: "على الأقل {count} عناصر قيد العمل",
      showingPreview:
        "عرض {shown} من ملخصات الأعمال الأخيرة. يحتوي لوحة المهام على سجلات المهام وسير العمل المُدارة.",
      openWorkboard: "فتح لوحة المهام",
      details: "تفاصيل العمل",
      relatedRuns: "{count} عمليات تشغيل ذات صلة",
      workTotals: "إجماليات المهام وسير العمل",
      tasks: "المهام",
      taskTotals: "نشطة: {active} · تحتاج انتباهاً: {failed} · الإجمالي: {total}",
      workflows: "سير العمل",
      workflowTotals: "نشطة: {active} · الإجمالي: {total}",
    },
    activityComparison: {
      eyebrow: "النشاط الآن",
      title: "ما الذي قيد التشغيل",
      subtitle: "إشارتان مختلفتان، معروجتان معًا.",
      openClawLabel: "عمل مُدار بواسطة OpenClaw",
      openClawCountOne: "وكيل عمل واحد",
      openClawCount: "{count} وكلاء عمل",
      openClawDetail: "المهام وسير العمل التي يديرها OpenClaw بنشاط.",
      localAiLabel: "ذكاء اصطناعي محلي مستقل",
      localAiCountOne: "عملية نموذج واحدة محمّلة",
      localAiCount: "{count} عمليات نموذج محمّلة",
      localAiDetail:
        "نماذج محمّلة على هذا الجهاز Mac. لا يعني تحميل العملية بالضرورة أنها تقوم بالتوليد الآن.",
      unconfirmed: "لا يمكن التأكيد",
    },
    ownerAcceptance: {
      eyebrow: "قبول المالك",
      title: "فحص غرفة العمليات لمدة 60 ثانية",
      subtitle:
        'يبدأ المؤقت فقط عند النقر على البدء. اقرأ الشاشة، واختر الإجابات، واستعرض التوصية ذات الأولوية الأعلى، ثم اختر "ليس الآن" دون إجراء أي تغيير.',
      begin: "بدء الفحص لمدة 60 ثانية",
      secondsLeft: "ثوانٍ متبقية",
      statusQuestion: "ما هو حالة النظام الأساسية الوحيدة؟",
      activityQuestion: "ما الذي قيد التشغيل الآن؟",
      activityAnswer: "OpenClaw: {openClaw} · الذكاء الاصطناعي المحلي: {localAi}",
      issueQuestion: "من يمتلك المشكلة ذات الأولوية الأعلى، وماذا يحدث بعد ذلك؟",
      issueAnswer: "{owner} — {next}",
      issueUnknown: "لا يوجد مالك أو خطوة تالية معروفة",
      resolveQuestion: 'راجع أعلى توصية من حيث الأولوية، ثم اختر "ليس الآن".',
      resolvePending: "لم يكتمل بعد",
      resolveDone: "تمت مراجعة التوصية وتأجيلها بأمان",
      finish: "إنشاء وإنهاء الإيصال",
      passed: "اجتاز فحص المالك",
      failed: "لم يجتز فحص المالك",
      elapsed: "اكتمل في {seconds} ثانية.",
      copyReceipt: "نسخ الإيصال",
      copied: "تم نسخ الإيصال",
      copyFailed: "لم يكن النسخ متاحاً. استخدم تنزيل الإيصال بدلاً من ذلك.",
      downloadReceipt: "تنزيل الإيصال",
    },
    changes: {
      eyebrow: "التغييرات الأخيرة",
      title: "منذ زيارتك الأخيرة",
      none: "لا توجد تغييرات جوهرية منذ زيارتك الأخيرة.",
      unconfirmed: "لا يمكن تأكيد التغييرات الأخيرة حتى تستعيد مصادر البيانات عملها.",
      firstVisit: "التغييرات الجوهرية الأخيرة",
      incidentResolved: "تم حل المشكلة",
      incidentChanged: "تغيرت المشكلة",
      showingNewest: "عرض أحدث {count} تغيير. افتح السجل المتاح لمزيد من التفاصيل.",
      openActivity: "فتح السجل المتاح",
      activitySummaryOne: "تشغيل {runtime} واحد مرتبط {result}.",
      activitySummary: "{count} تشغيلات {runtime} مرتبطة {result}.",
      outcomes: {
        working: "لا يزال قيد العمل",
        succeeded: "اكتمل",
        blocked: "كان محجوباً",
        failed: "فشل",
        cancelled: "تم إلغاؤه",
        unknown: "انتهى بنتيجة غير معروفة",
      },
      remediationOutcomes: {
        completed: "أصلح OpenClaw هذه المشكلة وتم التحقق منها",
        rolled_back: "لغى OpenClaw تلقائياً إصلاحاً لم يتم التحقق منه",
        failed: "توقف الإصلاح التلقائي ويحتاج إلى مراجعة",
        approval_required: "توقف OpenClaw وطلب الموافقة",
      },
    },
    agents: {
      eyebrow: "غرفة مباشرة",
      title: "الوكلاء",
      subtitle: "الأولوية التشغيلية أولاً. تظل الوكلاء الجاهزة مطوية.",
      searchLabel: "البحث عن وكلاء",
      searchPlaceholder: "البحث عن وكلاء",
      sortLabel: "ترتيب الوكلاء",
      sortPriority: "الأولوية",
      sortName: "الاسم",
      sortRecent: "النشاط الأخير",
      noMatches: "لا يتطابق أي وكيل مع هذا البحث.",
      noShownMatches: "لا يتطابق أي من الوكلاء المعروضة. ابحث في عرض الوكلاء الكامل.",
      searchResultCount: "تم عرض {count} من الوكلاء المتطابقة.",
      searchResultCountBounded:
        "{count} من الوكلاء المتطابقة المعروضة. قد يتضمن عرض الوكلاء الكامل المزيد.",
      unconfirmed: "لا يمكن تأكيد نشاط الوكيل حتى يتعافى مصدر بياناته.",
      unconfirmedShort: "النشاط غير موثق",
      showing: "عرض {shown} من أصل {total} وكيل. تظهر الوكلاء العاجلة والنشطة أولاً.",
      openAll: "فتح جميع الوكلاء",
      urgent: "عاجل",
      attention: "يحتاج إلى انتباه",
      working: "يعمل",
      waiting: "في الانتظار أو مجدول",
      recent: "تم تغييره مؤخراً",
      ready: "جاهز",
      off: "متوقف أو غير معروف",
      pin: "تثبيت {name}",
      unpin: "إلغاء تثبيت {name}",
      pinned: "مثبّتة",
      openAgent: "فتح الوكيل",
      reviewIssue: "مراجعة المشكلة",
      whatNeedsAttention: "ما الذي يحتاج إلى انتباهك",
      blockedTaskNeedsDecision:
        "مهمة {count} متوقفة تحتاج إلى قرارك. راجع المشكلة قبل تغيير الوكيل.",
      blockedTasksNeedDecision:
        "مهام {count} متوقفة تحتاج إلى قرارك. راجع المشكلات قبل تغيير الوكيل.",
      urgentIssueNeedsDecision: "مشكلة عاجلة تحتاج إلى قرارك.",
      issueBeingHandled: "OpenClaw يتعامل مع مشكلة لهذا الوكيل.",
      issueBeingWatched: "مشكلة هذا الوكيل قيد المراقبة.",
      technicalDetails: "التفاصيل التقنية",
      duty: "الواجب",
      currentWork: "العمل الحالي",
      lastActivity: "آخر نشاط",
      taskCounts: "المهام",
      taskCountSummary: "نشطة: {active} · معطلة: {blocked}",
      model: "النموذج",
      fallback: "الخيار البديل",
      heartbeat: "نبض القلب",
      ram: "الذاكرة العشوائية (RAM)",
      inheritedDefault: "افتراضي موروّث",
      noFallback: "لا يوجد بديل صريح",
      readyForWork: "جاهز للعمل",
      noCurrentWork: "بدون",
      unavailableRam: "غير قابل للتحديد",
      browserLocalPins: "يتم حفظ الدبابيس في هذا المتصفح.",
    },
    systemHealth: {
      eyebrow: "النظام",
      title: "صحة جهاز Mac",
      normal: "طبيعي",
      memory: "سعة الذاكرة",
      memoryInUse: "{percent}% تحت الضغط",
      memoryAvailable: "{percent}% متاح",
      memorySummary: "{percent}% من الذاكرة",
      memoryAndLocalAiSummary: "{percent}% من الذاكرة · عمليات الذكاء الاصطناعي المحلي: {count}",
      ...
      cpu: "المعالج (CPU)",
      load: "حمولة {value}",
      responseDelay: "تأخر الاستجابة",
      milliseconds: "{count} مللي ثانية",
      technicalDetails: "التفاصيل التقنية",
      gatewayRam: "ذاكرة Gateway العشوائية",
      host: "المضيف",
      logicalCores: "أنوية وحدة المعالجة المركزية المنطقية",
      unavailable: "غير متاح",
      memoryBreakdown: "{available} متاح · {free} فارغ فوراً · {total} إجمالي",
      memoryPressureNote:
    ...
    automationsPanel: {
      eyebrow: "الأتمتة",
      title: "العمل المجدول",
      none: "لم يتم تكوين عمل مجدول.",
      unconfirmed: "لا يمكن تأكيد العمل المجدول حتى يتعافى مصدر بياناته.",
      openCron: "فتح مهام Cron",
      showing: "عرض {shown} من {total}. افتح مهام Cron لمراجعة كل العمل المجدول.",
      dueNow: "مستحق الآن",
      noNextRun: "لا يوجد تشغيل تالي",
      runNow: "تشغيل الآن",
      pause: "إيقاف مؤقت",
      enable: "تفعيل",
    },
    more: {
      title: "المزيد من تفاصيل العمليات",
      subtitle: "السجل، وسير العمل، والجداول الزمنية، والإمكانيات، والنماذج، وعملات المضيف.",
      recentHistory: "السجل الأخير",
      workflows: "سير العمل",
      capabilities: "المهارات والإضافات والأدوات والنماذج",
      processes: "أكبر مستهلكي ذاكرة الوصول العشوائي (RAM)",
      argumentsPrivate: "لا يتم جمع الحجج أبداً.",
      processRowsRejectedOne: "تعذر قراءة صف عملية واحد وتم استبعاده.",
      processRowsRejected: "تعذر قراءة {count} من صفوف العمليات وتم استبعادها.",
      processesShowing: "عرض أكبر {shown} من أصل {total} عملية مقبولة.",
      configuredActive: "يتم عرض المكونة والنشطة بشكل منفصل.",
      configured: "مُكوّنة",
      notConfigured: "غير مُكوّنة",
      active: "نشطة",
      inactive: "غير نشطة",
      activityUnverified: "النشاط غير موثّق",
      catalogUnavailable: "لا يمكن تأكيد هذا الكتالوج حتى يتعافى مصدر بياناته.",
      catalogShowing: "عرض {shown} من أصل {total}",
      shadowMode: "وضع الظل · لا تغييرات تلقائية",
      catalogued: "{count} مُدوَّنة",
      available: "{count} متاحة",
      needsSetup: "{count} تحتاج إلى إعداد",
      availabilityUnverified: "التوفر غير موثّق",
      noHistory: "لم يتم تسجيل أي سجل حديث.",
      noActivityHistory: "لم يتم تسجيل أي نشاط للمهام في هذه اللقطة.",
      activityHistoryUnavailable: "لا يمكن تأكيد نشاط المهام من هذه اللقطة.",
      activityHistory: "نشاط المهام",
      activityCount: "مجموعات النشاط: {count}",
      incidentHistory: "سجل الحوادث",
      incidentCount: "سجلات الحوادث: {count}",
      historyUnavailable: "تفاصيل الحوادث غير متاحة في هذه اللقطة.",
      changed: "تم التغيير {time}",
      transitionCount: "انتقالات الخطورة: {count}",
      historyOverflow: "{count} حوادث أقدم خارج نافذة السجل المحفوظ.",
      historySnapshotBounded: "تتضمن هذه اللقطة {shown} من أصل {total} سجل حادث.",
      activitySnapshotBounded: "تغطية اللقطة: {shown} من أصل {total} مجموعة نشاط.",
      monitorIssue: "أبلغ المراقب الخلفي عن مشكلة",
      monitorStatus: "المراقب: آخر محاولة {attempt}؛ آخر مسح ناجح {success}.",
      noWorkflows: "لم يتم تسجيل سير عمل مُدار.",
      noProcesses: "تفاصيل موارد العمليات غير متاحة.",
      processesUnavailable: "لا يمكن تأكيد جرد العمليات من هذه اللقطة.",
      processesOmitted: "لم يتم تضمين جرد العمليات في هذه اللقطة.",
      historySummary: "النتائج التاريخية: {findings} · سجلات الحوادث: {incidents}",
      workflowSummary: "{total} إجمالي · {active} نشط",
      showing: "عرض {shown}",
      skills: "المهارات",
      plugins: "الإضافات",
      tools: "الأدوات",
      models: "النماذج",
      noSkills: "لم يتم اكتشاف أي مهارات.",
      noPlugins: "لم يتم اكتشاف أي إضافات.",
      noTools: "لم يتم اكتشاف أي أدوات.",
      noModels: "لم يتم اكتشاف أي نماذج.",
      cpuPercent: "{percent}% وحدة المعالجة المركزية",
    },
    status: {
      healthy: "سليم",
      working: "يعمل",
    ...
    actions: {
      ...
      cancel: "إلغاء",
      cancelWork: "إلغاء {title}",
      cancelWorkflow: "إلغاء سير العمل",
      runSchedule: "تشغيل {title} الآن",
      pauseSchedule: "إيقاف {title}",
      enableSchedule: "تفعيل {title}",
      unavailable: "التحكم غير متاح حتى تصبح البيانات حديثة وكاملة.",
      cancelled: "تم إلغاء الإجراء. لم يتم تغيير أي شيء.",
      confirm:
        "{summary}\n\nالمخاطر: {risk}\n\nينتهي هذا الإجراء المحمي في {expires}. هل تريد المتابعة؟",
      risks: {
        low: "منخفضة",
        medium: "متوسطة",
        high: "مرتفعة",
    ...
    enums: {
      ...
      sources: {
        ...
        models: "النماذج",
        processes: "العمليات",
        eventLoop: "استجابة Gateway",
        monitor: "مراقبة العمليات",
        incidentLedger: "سجل الحوادث",
      },
      categories: {
        agent: "الوكيل",
        workflow: "سير العمل",
      ...
      dispositions: {
        needs_user: "يحتاج إليك",
        handling: "OpenClaw يتعامل مع الأمر",
        watching: "مراقبة",
        historical: "تاريخي",
      },
    },
    footer: "المراقبة الحتمية فقط. لا توجد مكالمات نموذج أو تحولات تلقائية.",
  },
  tabs: {
    agents: "الوكلاء",
    activity: "النشاط",
  ...
  subtitles: {
    ...
    operations: "الوكلاء وسير العمل والإمكانات والنماذج والموارد في لمحة.",
  ...
  chat: {
    ...
    prepareVerifiedUpdate: "تحضير تحديث تم التحقق منه",
    preparingVerifiedUpdate: "جارٍ تحضير تحديث تم التحقق منه…",
    installVerifiedUpdate: "تثبيت تحديث تم التحقق منه",
    exactShaApprovalRequired: "مطلوب اعتماد SHA الدقيق",
    updateProtectionIncomplete: "تحتاج حماية التحديث إلى انتباهك.",
