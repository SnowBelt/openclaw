...
export const ar: TranslationMap = {
  ...
  operationsRoom: {
    ...
    resolution: {
      ...
      previewOnlyDetail: "لم يتم إجراء أي تغييرات.",
      closePreview: "إغلاق المعاينة — لا تُجرِ أي تغييرات",
    ...
    ownerAcceptance: {
      ...
      subtitle:
        'يبدأ المؤقت فقط عند النقر على "بدء". اقرأ الشاشة، واختر الإجابات، واستعرض ملخص الحل ذو الأولوية الأعلى، ثم أغلقه دون إجراء تغييرات.',
      ...
      resolveQuestion: "معاينة الحل ذي الأولوية الأعلى، ثم إغلاقه دون إجراء تغييرات.",
      resolvePending: "لم يكتمل بعد",
      resolveDone: "تم فتح المعاينة وإغلاقها بأمان",
