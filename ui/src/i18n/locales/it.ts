...
export const it: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "Piano di controllo OpenClaw",
    title: "Sala Operativa",
    subtitle: "Cosa richiede attenzione, cosa funziona e come si comporta il sistema.",
    refresh: "Aggiorna",
    refreshing: "Aggiornamento in corso…",
    refreshLabel: "Aggiorna Sala Operativa",
    updated: "Aggiornato {time}",
    live: "In diretta",
    stale: "Ultimo noto",
    partial: "Dati parziali",
    unavailableTitle: "Dati operativi non disponibili",
    actionFailedTitle: "Azione non completata",
    staleTitle: "Aggiornamento in diretta non riuscito",
    staleDetail: "Visualizzazione dell'ultimo snapshot riuscito da {time}.",
    unavailableSources: "Sorgenti non disponibili: {sources}.",
    fallbackSources: "Sorgenti dati di fallback: {sources}.",
    loading: "Costruzione della panoramica operativa corrente…",
    empty: "Nessuno snapshot operativo è ancora disponibile.",
    now: "Ora",
    briefingUnavailable:
      "Non è possibile confermare la panoramica corrente. Verificare lo stato specifico delle sorgenti di seguito.",
    lastKnownBriefing: "Mostra ultima panoramica nota",
    briefingTone: {
      normal: "Aggiornato",
    ...
    overallBriefingTone: {
      normal: "Complessivo: Aggiornato",
      attention: "Complessivo: Richiede attenzione",
      urgent: "Complessivo: Urgente",
      unknown: "Complessivo: Stato sconosciuto",
    },
    overviewNav: "Panoramica operazioni",
    reviewCount: "In revisione {count}",
    reviewUnconfirmed: "In revisione —",
    decisionCount: "Decisioni necessarie {count}",
    decisionsUnconfirmed: "Decisioni necessarie —",
    workingCount: "Attivi ora {count}",
    workingCountBounded: "Attivi ora {count}+",
    workingUnconfirmed: "Attivi ora —",
    agentsWorkingNowCount: "Agenti in attività ora {count}",
    agentsWorkingUnconfirmed: "Agenti in attività ora —",
    openClawWorkCount: "{count} attività OpenClaw",
    openClawWorkUnconfirmed: "Attività OpenClaw —",
    allAgentsCount: "Tutti gli agenti {count}",
    agentsUnconfirmed: "Tutti gli agenti —",
    agentsCount: "{count} agenti",
    urgentCount: "{count} urgenti",
    activeAgentsCount: "Agenti attivi: {count}",
    workingItemsCount: "Elementi in lavorazione: {count}",
    showingAgents: "Visualizzati {count}",
    attentionAgentsCount: "{count} richiedono attenzione",
    agentStatusSummary: "{working} in attività · {attention} richiedono attenzione",
    automationCount: "Pianificazioni: {total} · In errore: {failing}",
    automations: "Automazioni",
    system: "Sistema",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "Richiede revisione",
      title: "Attenzione",
      subtitle: "Problemi attuali in primo piano. Gli eventi storici rimangono in Altro.",
      needsYou: "Richiede il tuo intervento",
      handling: "OpenClaw sta gestendo",
      watching: "In osservazione",
      none: "Nessuna attenzione richiesta.",
      noCritical: "Nessun problema critico attivo.",
      currentCount: "{count} attuali",
      noneNeedsYou: "Nessuna decisione o intervento è in attesa di te.",
      noneHandling: "Nessuna risoluzione attiva in corso.",
      noneWatching: "Nessun elemento in osservazione.",
      impact: "Impatto",
      owner: "Proprietario",
      you: "Tu",
      unassignedOwner: "Non assegnato",
      response: "Risposta",
      nextAction: "Prossima azione",
      nextActionShort: "Prossimo",
      highestPriority: "Problema con priorità più alta",
      whoOwnsThis: "A chi spetta la responsabilità",
      whatHappensNext: "Cosa succede dopo",
      continueMonitoring: "Continua il monitoraggio.",
      observed: "Osservato {time}",
      lastKnown: "Ultimo noto",
      unconfirmedTitle: "Impossibile confermare lo stato di attenzione",
      unconfirmedDetail:
        "I problemi noti sono mostrati di seguito, ma i dati incompleti o gli ultimi dati conosciuti potrebbero omettere problemi più recenti.",
      unconfirmedShort: "Richiede verifica",
      showingCurrent:
        "Visualizzati {shown} di {total} problemi attuali in questa istantanea limitata. Le viste della fonte forniscono record correlati.",
      outsidePreview:
        "{count} problemi attuali sono al di fuori di questa anteprima. Apri una vista della fonte sopra.",
      lastProgress: "Ultimo avanzamento",
      nextCheck: "Prossimo controllo",
      remediationTask: "Attività di rimedio",
      openRemediation: "Apri rimedio",
      responseStates: {
        unassigned: "Non assegnato",
        in_progress: "In corso",
        monitoring: "Monitoraggio",
        waiting_for_user: "In attesa di te",
        resolved: "Risolto",
      },
    },
    resolution: {
      ...
      judgeReview: "Revisione di sicurezza indipendente: {decision} — {reason}",
      approved: "Approvato",
      rejected: "Rifiutato",
      rollback: "Piano di rollback",
      undoAvailability: "Disponibilità annullamento",
      undoAvailable: "Disponibile tramite anteprima protetta",
      undoUnavailable: "Nessun annullamento diretto disponibile",
      viewRepairDetails: "Visualizza dettagli riparazione",
      result: "Risultato",
      undo: "Annulla questa riparazione",
      ...
      evidenceLocation:
        'I progressi e le prove appariranno in questa issue, nella sezione "Dalla tua ultima visita" e in Workboard.',
      ...
      nextStepUnknown:
        "Nessun passaggio successivo sicuro è confermato. Indagare prima di apportare modifiche.",
      stages: {
        needs_review: "Richiede revisione",
        openclaw_handling: "OpenClaw sta gestendo la situazione",
        watching: "OpenClaw sta monitorando questo",
        resolved: "Risolto",
      },
      risks: {
        low: "Bassa",
    ...
    working: {
      ...
      subtitle:
        "Solo attività e flussi di lavoro gestiti da OpenClaw. I processi AI locali appaiono sotto Sistema.",
      none: "Nessun agente OpenClaw è attualmente in esecuzione.",
      unconfirmed:
        "Il lavoro corrente non può essere confermato finché le sue fonti di dati non si riprenderanno.",
      unverified: "Lavoro corrente non verificato",
      countsUnconfirmed: "I conteggi non possono essere confermati",
      itemsCount: "{count} elementi in lavorazione",
      itemsCountBounded: "Almeno {count} elementi in lavorazione",
      showingPreview:
        "Visualizzati {shown} riepiloghi di lavoro recenti. Il Workboard contiene record di attività e flussi di lavoro gestiti.",
      openWorkboard: "Apri Workboard",
      details: "Dettagli del lavoro",
      relatedRuns: "{count} esecuzioni correlate",
      workTotals: "Totali attività e flussi di lavoro",
      tasks: "Attività",
      taskTotals: "Attive: {active} · Richiedono attenzione: {failed} · Totale: {total}",
      workflows: "Flussi di lavoro",
      workflowTotals: "Attivi: {active} · Totale: {total}",
    },
    activityComparison: {
      eyebrow: "Attività attuale",
      title: "Cosa è in esecuzione",
      subtitle: "Due segnali diversi, visualizzati insieme.",
      openClawLabel: "Lavoro gestito da OpenClaw",
      openClawCountOne: "1 agente attivo",
      openClawCount: "{count} agenti attivi",
      openClawDetail: "Attività e flussi di lavoro che OpenClaw sta gestendo attivamente.",
      localAiLabel: "AI locale indipendente",
      localAiCountOne: "1 processo del modello caricato",
      localAiCount: "{count} processi del modello caricati",
      localAiDetail:
        "Modelli caricati su questo Mac. Un processo caricato non significa necessariamente che stia generando output in questo momento.",
      unconfirmed: "Impossibile confermare",
    },
    ownerAcceptance: {
      ...
      activityQuestion: "Cosa è in esecuzione in questo momento?",
      activityAnswer: "OpenClaw: {openClaw} · AI locale: {localAi}",
      ...
      elapsed: "Completato in {seconds} secondi.",
      copyReceipt: "Copia ricevuta",
      copied: "Ricevuta copiata",
      copyFailed: "La copia non era disponibile. Usa Scarica ricevuta invece.",
      downloadReceipt: "Scarica ricevuta",
    },
    changes: {
      eyebrow: "Modifiche recenti",
      title: "Dalla tua ultima visita",
      none: "Nessuna modifica significativa dalla tua ultima visita.",
      unconfirmed:
        "Le modifiche recenti non possono essere confermate finché le loro origini dati non si riprenderanno.",
      firstVisit: "Modifiche significative recenti",
      incidentResolved: "Problema risolto",
      incidentChanged: "Problema modificato",
      showingNewest:
        "Visualizzate le {count} modifiche più recenti. Apri la cronologia disponibile per maggiori dettagli.",
      openActivity: "Apri cronologia disponibile",
      activitySummaryOne: "1 esecuzione {runtime} correlata {result}.",
      activitySummary: "{count} esecuzioni {runtime} correlate {result}.",
      outcomes: {
        working: "è ancora in corso",
        succeeded: "completata",
        blocked: "bloccata",
        failed: "fallita",
        cancelled: "cancellata",
        unknown: "terminata con un risultato sconosciuto",
      },
      remediationOutcomes: {
        completed: "OpenClaw ha riparato e verificato questo problema",
        rolled_back: "OpenClaw ha annullato automaticamente una riparazione non verificata",
        failed: "La riparazione automatica si è interrotta e richiede una revisione",
        approval_required: "OpenClaw si è interrotto e ha richiesto approvazione",
      },
    },
    agents: {
      eyebrow: "Sala operativa",
      title: "Agenti",
      subtitle: "Priorità operativa prima di tutto. Gli agenti pronti rimangono compressi.",
      searchLabel: "Cerca agenti",
      searchPlaceholder: "Cerca agenti",
      sortLabel: "Ordina agenti",
      sortPriority: "Priorità",
      sortName: "Nome",
      sortRecent: "Attività recente",
      noMatches: "Nessun agente corrisponde a questa ricerca.",
      noShownMatches:
        "Nessun agente visualizzato corrisponde. Cerca nella vista completa degli Agenti.",
      searchResultCount: "{count} agenti corrispondenti visualizzati.",
      searchResultCountBounded:
        "{count} agenti corrispondenti visualizzati. La vista completa degli Agenti potrebbe includerne altri.",
      unconfirmed:
        "L'attività dell'agente non può essere confermata finché la sua origine dati non si riprenderà.",
      unconfirmedShort: "Attività non verificata",
      showing:
        "Visualizzati {shown} di {total} agenti. Gli agenti urgenti e attivi appaiono per primi.",
      openAll: "Apri tutti gli agenti",
      urgent: "Urgente",
      attention: "Richiede attenzione",
      working: "In lavoro",
      waiting: "In attesa o pianificato",
      recent: "Modificato di recente",
      ready: "Pronte",
      off: "Spento o sconosciuto",
      pin: "Fissa {name}",
      unpin: "Sblocca {name}",
      pinned: "Fissate",
      openAgent: "Apri agente",
      reviewIssue: "Esamina il problema",
      whatNeedsAttention: "Cosa richiede attenzione",
      blockedTaskNeedsDecision:
        "{count} attività bloccata richiede la tua decisione. Esamina il problema prima di modificare l'agente.",
      blockedTasksNeedDecision:
        "{count} attività bloccate richiedono la tua decisione. Esamina i problemi prima di modificare l'agente.",
      urgentIssueNeedsDecision: "Un problema urgente richiede la tua decisione.",
      issueBeingHandled: "OpenClaw sta gestendo un problema per questo agente.",
      issueBeingWatched: "Un problema relativo a questo agente è in monitoraggio.",
      technicalDetails: "Dettagli tecnici",
      duty: "Dovere",
      currentWork: "Lavoro corrente",
      lastActivity: "Ultima attività",
      taskCounts: "Compiti",
      taskCountSummary: "Attivi: {active} · Bloccati: {blocked}",
      model: "Modello",
      fallback: "Backup",
      heartbeat: "Heartbeat",
      ram: "RAM",
      inheritedDefault: "Predefinito ereditato",
      noFallback: "Nessun fallback esplicito",
      readyForWork: "Pronto per il lavoro",
      noCurrentWork: "Nessuno",
      unavailableRam: "Non attribuibile",
      browserLocalPins: "I pin sono salvati in questo browser.",
    },
    systemHealth: {
      eyebrow: "Sistema",
      title: "Stato del Mac",
      normal: "Normale",
      memory: "Capacità di memoria",
      memoryInUse: "{percent}% sotto pressione",
      memoryAvailable: "{percent}% disponibile",
      memorySummary: "{percent}% memoria",
      memoryAndLocalAiSummary: "{percent}% memoria · Processi AI locali: {count}",
      localModels: "Memoria AI locale",
      localModelProcessOne: "1 processo del modello · {rss} RSS del processo",
      localModelProcesses: "{count} processi del modello · {rss} RSS del processo",
      gateway: "Gateway",
      cpu: "CPU",
      load: "Carico {value}",
      responseDelay: "Ritardo di risposta",
      milliseconds: "{count} ms",
      technicalDetails: "Dettagli tecnici",
      gatewayRam: "RAM Gateway",
      host: "Host",
      logicalCores: "Core CPU logici",
      unavailable: "Non disponibile",
      memoryBreakdown: "{available} disponibili · {free} immediatamente libere · {total} totali",
      memoryPressureNote:
        "La pressione della memoria misura la capacità che macOS può rendere disponibile. Il RSS del processo AI locale è mostrato separatamente e può includere pagine del modello recuperabili o condivise.",
      agentRamNote:
        "La RAM per agente non è disponibile quando gli agenti condividono il processo Gateway.",
    },
    automationsPanel: {
      eyebrow: "Automazioni",
      title: "Lavori pianificati",
      none: "Nessun lavoro pianificato è configurato.",
      unconfirmed:
        "I lavori pianificati non possono essere confermati finché la loro origine dati non si riprende.",
      openCron: "Apri Cron Jobs",
      showing:
        "Visualizzati {shown} di {total}. Apri Cron Jobs per rivedere tutti i lavori pianificati.",
      dueNow: "Scade ora",
    ...
    more: {
      title: "Altri dettagli sulle operazioni",
      subtitle:
        "Cronologia, flussi di lavoro, pianificazioni, funzionalità, modelli e processi host.",
      recentHistory: "Cronologia recente",
      workflows: "Flussi di lavoro",
      capabilities: "Skills, plugin, strumenti e modelli",
      processes: "Processi con maggiore consumo di RAM",
      argumentsPrivate: "Gli argomenti non vengono mai raccolti.",
      processRowsRejectedOne: "1 riga del processo non è stata letta ed è stata esclusa.",
      processRowsRejected: "{count} righe dei processi non sono state lette e sono state escluse.",
      processesShowing: "Visualizzati i {shown} più grandi tra {total} processi accettati.",
      configuredActive: "Configurati e attivi sono mostrati separatamente.",
      configured: "Configurato",
      notConfigured: "Non configurato",
      active: "Attivo",
      inactive: "Inattivo",
      activityUnverified: "Attività non verificata",
      catalogUnavailable:
        "Questo catalogo non può essere confermato finché la sua origine dati non si riprenderà.",
      catalogShowing: "Visualizzati {shown} di {total}",
      shadowMode: "Modalità ombra · nessuna modifica automatica",
      catalogued: "{count} catalogati",
      available: "{count} disponibili",
      needsSetup: "{count} richiedono configurazione",
      availabilityUnverified: "Disponibilità non verificata",
      noHistory: "Nessuna cronologia recente registrata.",
      noActivityHistory: "Nessuna attività del task è registrata in questa istantanea.",
      activityHistoryUnavailable:
        "L'attività del task non può essere confermata da questa istantanea.",
      activityHistory: "Attività del task",
      activityCount: "Gruppi di attività: {count}",
      incidentHistory: "Cronologia degli incidenti",
      incidentCount: "Registri degli incidenti: {count}",
      historyUnavailable: "I dettagli dell'incidente non sono disponibili in questa istantanea.",
      changed: "Modificato {time}",
      transitionCount: "Transizioni di gravità: {count}",
      historyOverflow:
        "{count} incidenti più vecchi sono al di fuori della finestra di conservazione della cronologia.",
      historySnapshotBounded:
        "Questa istantanea include {shown} di {total} registri degli incidenti.",
      activitySnapshotBounded: "Copertura dell'istantanea: {shown} di {total} gruppi di attività.",
      monitorIssue: "Il monitor in background ha segnalato un problema",
      monitorStatus: "Monitor: ultimo tentativo {attempt}; ultima scansione riuscita {success}.",
      noWorkflows: "Nessun workflow gestito registrato.",
      noProcesses: "I dettagli delle risorse del processo non sono disponibili.",
      processesUnavailable:
        "L'inventario dei processi non può essere confermato da questa istantanea.",
      processesOmitted: "L'inventario dei processi non è stato incluso in questa istantanea.",
      historySummary: "Risultati storici: {findings} · Registri degli incidenti: {incidents}",
      workflowSummary: "{total} totale · {active} attivi",
      showing: "visualizzati {shown}",
      skills: "Skills",
      plugins: "Plugin",
      tools: "Strumenti",
      models: "Modelli",
      noSkills: "Nessuna skill rilevata.",
      noPlugins: "Nessun plugin rilevato.",
      noTools: "Nessuno strumento rilevato.",
      noModels: "Nessun modello rilevato.",
    ...
    actions: {
      details: "Dettagli",
      detailsFor: "Dettagli per {title}",
      cancel: "Annulla",
      cancelWork: "Annulla {title}",
      cancelWorkflow: "Annulla workflow",
      runSchedule: "Esegui {title} ora",
      pauseSchedule: "Metti in pausa {title}",
      enableSchedule: "Abilita {title}",
      unavailable:
        "I controlli non sono disponibili finché questi dati non saranno aggiornati e completi.",
      cancelled: "Azione annullata. Nessun cambiamento.",
      confirm:
        "{summary}\n\nRischio: {risk}\n\nQuesta azione protetta scade {expires}. Continuare?",
      risks: {
        low: "Bassa",
        medium: "Media",
        high: "Alta",
    ...
    counts: {
      exact: "{count}",
      shown: "Visualizzati {shown} di {total}",
      compactShown: "{shown} di {total}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "Modelli",
        processes: "Processi",
        eventLoop: "Reattività di Gateway",
        monitor: "Monitor delle operazioni",
        incidentLedger: "Cronologia incidenti",
      },
      categories: {
        agent: "Agente",
    ...
    footer:
      "Solo monitoraggio deterministico. Nessuna chiamata al modello o mutazioni automatiche.",
  },
  tabs: {
    agents: "Agenti",
    activity: "Attività",
    overview: "Panoramica",
    operations: "Sala operativa",
  ...
  subtitles: {
    ...
    operations: "Agenti, flussi di lavoro, funzionalità, modelli e risorse a colpo d’occhio.",
  ...
  chat: {
    ...
    prepareVerifiedUpdate: "Prepara aggiornamento verificato",
    preparingVerifiedUpdate: "Preparazione dell’aggiornamento verificato…",
    installVerifiedUpdate: "Installa aggiornamento verificato",
    exactShaApprovalRequired: "È richiesta l’approvazione dello SHA esatto",
    updateProtectionIncomplete: "La protezione degli aggiornamenti richiede attenzione.",
    ...
    modelPicker: {
      ...
      unavailable: "Non disponibile – scegli un altro modello",
      contentionWarning: "Utilizzato da un’altra agente attiva – potrebbe essere più lento",
    },
    pairingQrExpired: {
