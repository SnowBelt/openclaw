...
export const it: TranslationMap = {
  ...
  operationsRoom: {
    ...
    working: {
      ...
      subtitle: "Risultati attivi, raggruppati senza ripetere le istruzioni grezze.",
      none: "Nessun agente sta lavorando attivamente al momento.",
      unconfirmed:
