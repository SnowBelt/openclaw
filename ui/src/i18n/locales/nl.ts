...
export const nl: TranslationMap = {
  ...
  sessionsView: {
    ...
    truthAuditMatchMissing: "ontbreekt",
  ...
  subtitles: {
    ...
    musicStudio: "Prompt, arrangeer, speel en rond originele muziek af.",
  ...
  overview: {
    ...
    cards: {
      ...
      judgeGuardOpenSessions: "Sessies",
      ...
      truthAuditOpenSessions: "Sessies",
