...
export const nl: TranslationMap = {
  ...
  operationsRoom: {
    ...
    title: "Operationskamer",
    subtitle: "Wat aandacht nodig heeft, wat werkt en hoe het systeem presteert.",
    refresh: "Vernieuwen",
    refreshing: "Aan het vernieuwen…",
    refreshLabel: "Operationskamer vernieuwen",
    updated: "Bijgewerkt {time}",
    live: "Live",
    stale: "Laatst bekend",
    partial: "Gedeeltelijke gegevens",
    unavailableTitle: "Operationsgegevens niet beschikbaar",
    actionFailedTitle: "Actie niet voltooid",
    staleTitle: "Live-update mislukt",
    staleDetail: "Toont de laatste succesvolle snapshot van {time}.",
    unavailableSources: "Niet-beschikbare bronnen: {sources}.",
    fallbackSources: "Terugvalgegevensbronnen: {sources}.",
    loading: "Huidig operationsbeeld wordt opgebouwd…",
    empty: "Er is nog geen operations-snapshot beschikbaar.",
    now: "Nu",
    briefingUnavailable:
      "Het huidige overzicht kan niet worden bevestigd. Bekijk de bron-specifieke status hieronder.",
    lastKnownBriefing: "Laatst bekende overzicht tonen",
    briefingTone: {
      normal: "Up-to-date",
    ...
    overallBriefingTone: {
      normal: "Algemeen: Up-to-date",
      attention: "Algemeen: Vereist aandacht",
      urgent: "Algemeen: Urgent",
      unknown: "Algemeen: Status onbekend",
    },
    overviewNav: "Overzicht operaties",
    reviewCount: "Beoordelen {count}",
    reviewUnconfirmed: "Beoordelen —",
    decisionCount: "Beslissingen nodig {count}",
    decisionsUnconfirmed: "Beslissingen nodig —",
    workingCount: "Nu actief {count}",
    workingCountBounded: "Nu actief {count}+",
    workingUnconfirmed: "Nu actief —",
    agentsWorkingNowCount: "Agenten actief nu {count}",
    agentsWorkingUnconfirmed: "Agenten actief nu —",
    openClawWorkCount: "OpenClaw-werk {count}",
    openClawWorkUnconfirmed: "OpenClaw-werk —",
    allAgentsCount: "Alle agents {count}",
    agentsUnconfirmed: "Alle agents —",
    agentsCount: "{count} agenten",
    urgentCount: "{count} dringend",
    activeAgentsCount: "Actieve agents: {count}",
    workingItemsCount: "Actieve items: {count}",
    showingAgents: "Weergeven {count}",
    attentionAgentsCount: "{count} vereist aandacht",
    agentStatusSummary: "{working} actief · {attention} vereist aandacht",
    automationCount: "Schema's: {total} · Mislukt: {failing}",
    automations: "Automatiseringen",
    system: "Systeem",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "Beoordeling nodig",
      title: "Aandacht",
      subtitle: "Huidige problemen eerst. Historische gebeurtenissen blijven in Meer.",
      needsYou: "Heeft jou nodig",
      handling: "OpenClaw behandelt dit",
      watching: "In de gaten houden",
      none: "Niets vraagt om je aandacht.",
      noCritical: "Er is geen kritiek probleem actief.",
      currentCount: "{count} huidig",
      noneNeedsYou: "Er wacht geen beslissing of interventie op jou.",
      noneHandling: "Er is geen actieve herstelactie gaande.",
      noneWatching: "Er wordt niets in de gaten gehouden.",
      impact: "Impact",
      owner: "Eigenaar",
      you: "Jij",
      unassignedOwner: "Niet toegewezen",
      response: "Reactie",
      nextAction: "Volgende actie",
      nextActionShort: "Volgende",
      highestPriority: "Probleem met hoogste prioriteit",
      whoOwnsThis: "Wie is verantwoordelijk",
      whatHappensNext: "Wat gebeurt er als volgende stap",
      continueMonitoring: "Blijf monitoren.",
      observed: "Waargenomen {time}",
      lastKnown: "Laatst bekend",
      unconfirmedTitle: "Aandachtsstatus kan niet worden bevestigd",
      unconfirmedDetail:
        "Bekende problemen worden hieronder weergegeven, maar onvolledige of laatst bekende gegevens kunnen nieuwere problemen over het hoofd zien.",
      unconfirmedShort: "Verificatie nodig",
      showingCurrent:
        "{shown} van {total} huidige problemen in deze beperkte momentopname weergegeven. Bronweergaven bieden gerelateerde records.",
      outsidePreview:
        "{count} huidige problemen bevinden zich buiten deze voorbeeldweergave. Open hierboven een bronweergave.",
      lastProgress: "Laatste voortgang",
      nextCheck: "Volgende controle",
      remediationTask: "Oplossingsopdracht",
      openRemediation: "Open oplossing",
      responseStates: {
        unassigned: "Niet toegewezen",
        in_progress: "Bezig",
        monitoring: "Monitoren",
        waiting_for_user: "Wachten op jou",
        resolved: "Opgelost",
      },
    },
    resolution: {
      ...
      judgeReview: "Onafhankelijke veiligheidsbeoordeling: {decision} — {reason}",
      approved: "Goedgekeurd",
      rejected: "Geweigerd",
      rollback: "Terugrolplan",
      undoAvailability: "Beschikbaarheid van ongedaan maken",
      undoAvailable: "Beschikbaar via een beveiligd voorbeeld",
      undoUnavailable: "Er is geen directe optie om dit ongedaan te maken",
      viewRepairDetails: "Bekijk reparatiedetails",
      result: "Resultaat",
      undo: "Maak deze reparatie ongedaan",
      ...
      evidenceLocation:
        'Voortgang en bewijs worden weergegeven in deze kwestie, het gedeelte "Sinds uw laatste bezoek" en Workboard.',
      ...
      nextStepUnknown:
        "Er is geen veilige volgende stap bevestigd. Onderzoek voordat u iets wijzigt.",
      stages: {
        needs_review: "Beoordeling nodig",
        openclaw_handling: "OpenClaw behandelt dit",
        watching: "OpenClaw kijkt mee",
        resolved: "Opgelost",
      },
      risks: {
        low: "Laag",
    ...
    working: {
      eyebrow: "Bezig",
      title: "Nu aan het werk",
      subtitle:
        "Alleen door OpenClaw beheerde taken en workflows. Lokale AI-processen worden weergegeven onder Systeem.",
      none: "Er is momenteel geen OpenClaw-agent actief bezig.",
      unconfirmed: "Huidig werk kan niet worden bevestigd totdat de gegevensbronnen zijn hersteld.",
      unverified: "Huidig werk niet geverifieerd",
      countsUnconfirmed: "Aantallen kunnen niet worden bevestigd",
      itemsCount: "{count} actieve items",
      itemsCountBounded: "Minimaal {count} actieve items",
      showingPreview:
        "Toont {shown} recente werkoverzichten. Workboard bevat beheerde taak- en workflowrecords.",
      openWorkboard: "Open Workboard",
      details: "Werkdetails",
      relatedRuns: "{count} gerelateerde runs",
      workTotals: "Totaal taken en workflows",
      tasks: "Taken",
      taskTotals: "Actief: {active} · Aandacht nodig: {failed} · Totaal: {total}",
      workflows: "Workflows",
      workflowTotals: "Actief: {active} · Totaal: {total}",
    },
    activityComparison: {
      eyebrow: "Activiteit nu",
      title: "Wat er draait",
      subtitle: "Twee verschillende signalen, samen weergegeven.",
      openClawLabel: "Door OpenClaw beheerd werk",
      openClawCountOne: "1 werkende agent",
      openClawCount: "{count} werkende agents",
      openClawDetail: "Taken en workflows die OpenClaw actief beheert.",
      localAiLabel: "Onafhankelijke lokale AI",
      localAiCountOne: "1 modelproces geladen",
      localAiCount: "{count} modelprocessen geladen",
      localAiDetail:
        "Modellen die op deze Mac zijn geladen. Een geladen proces betekent niet noodzakelijkerwijs dat er nu wordt gegenereerd.",
      unconfirmed: "Kan niet bevestigen",
    },
    ownerAcceptance: {
      ...
      activityQuestion: "Wat draait er nu?",
      activityAnswer: "OpenClaw: {openClaw} · Lokale AI: {localAi}",
      issueQuestion:
        "Wie is eigenaar van het probleem met de hoogste prioriteit, en wat gebeurt er vervolgens?",
      ...
      elapsed: "Voltooid in {seconds} seconden.",
      copyReceipt: "Bonnetje kopiëren",
      copied: "Bonnetje gekopieerd",
      copyFailed: "Kopiëren was niet beschikbaar. Gebruik in plaats daarvan Bonnetje downloaden.",
      downloadReceipt: "Bonnetje downloaden",
    },
    changes: {
      eyebrow: "Recente wijzigingen",
      title: "Sinds uw laatste bezoek",
      none: "Geen significante wijzigingen sinds uw laatste bezoek.",
      unconfirmed:
        "Recente wijzigingen kunnen pas worden bevestigd wanneer de gegevensbronnen herstellen.",
      firstVisit: "Recente significante wijzigingen",
      incidentResolved: "Probleem opgelost",
      incidentChanged: "Probleem gewijzigd",
      showingNewest:
        "Toont de {count} nieuwste wijzigingen. Open de beschikbare geschiedenis voor meer details.",
      openActivity: "Open beschikbare geschiedenis",
      activitySummaryOne: "1 gerelateerde {runtime}-uitvoering {result}.",
      activitySummary: "{count} gerelateerde {runtime}-uitvoeringen {result}.",
      outcomes: {
        working: "is nog bezig",
        succeeded: "voltooid",
        blocked: "was geblokkeerd",
        failed: "mislukt",
        cancelled: "is geannuleerd",
        unknown: "eindigde met een onbekend resultaat",
      },
      remediationOutcomes: {
        completed: "OpenClaw heeft dit probleem hersteld en geverifieerd",
        rolled_back:
          "OpenClaw heeft automatisch een herstel ongedaan gemaakt dat niet is geverifieerd",
        failed: "Automatisch herstel gestopt en vereist controle",
        approval_required: "OpenClaw is gestopt en heeft goedkeuring gevraagd",
      },
    },
    agents: {
      eyebrow: "Live-kamer",
      title: "Agents",
      subtitle: "Operationele prioriteit eerst. Klaarstaande agents blijven ingeklapt.",
      searchLabel: "Zoek agents",
      searchPlaceholder: "Zoek agents",
      sortLabel: "Sorteer agents",
      sortPriority: "Prioriteit",
      sortName: "Naam",
      sortRecent: "Recente activiteit",
      noMatches: "Geen agents komen overeen met deze zoekopdracht.",
      noShownMatches:
        "Geen weergegeven agents komen overeen. Zoek in de volledige Agents-weergave.",
      searchResultCount: "{count} overeenkomende agents weergegeven.",
      searchResultCountBounded:
        "{count} overeenkomende weergegeven agents. De volledige Agents-weergave kan er meer bevatten.",
      unconfirmed: "Agentactiviteit kan niet worden bevestigd totdat de gegevensbron is hersteld.",
      unconfirmedShort: "Activiteit niet geverifieerd",
      showing:
        "{shown} van {total} agents weergegeven. Dringende en actieve agents worden eerst getoond.",
      openAll: "Alle agents openen",
      urgent: "Dringend",
      attention: "Vereist aandacht",
      working: "Bezig",
      waiting: "Wachten of gepland",
      recent: "Onlangs gewijzigd",
      ready: "Gereed",
      off: "Uitgeschakeld of onbekend",
      pin: "{name} vastmaken",
      unpin: "{name} losmaken",
      pinned: "Vastgezet",
      openAgent: "Agent openen",
      reviewIssue: "Probleem bekijken",
      whatNeedsAttention: "Wat vereist aandacht",
      blockedTaskNeedsDecision:
        "{count} geblokkeerde taak vereist uw beslissing. Bekijk het probleem voordat u de agent wijzigt.",
      blockedTasksNeedDecision:
        "{count} geblokkeerde taken vereisen uw beslissing. Bekijk de problemen voordat u de agent wijzigt.",
      urgentIssueNeedsDecision: "Een urgent probleem vereist uw beslissing.",
      issueBeingHandled: "OpenClaw behandelt een probleem voor deze agent.",
      issueBeingWatched: "Er wordt gekeurd naar een probleem voor deze agent.",
      technicalDetails: "Technische details",
      duty: "Plicht",
      currentWork: "Huidig werk",
      lastActivity: "Laatste activiteit",
      taskCounts: "Taken",
      taskCountSummary: "Actief: {active} · Geblokkeerd: {blocked}",
      model: "Model",
      fallback: "Terugvaloptie",
      heartbeat: "Heartbeat",
      ram: "RAM",
      inheritedDefault: "Overgeërfd standaard",
      noFallback: "Geen expliciete fallback",
      readyForWork: "Klaar voor werk",
      noCurrentWork: "Geen",
      unavailableRam: "Niet toerekenbaar",
      browserLocalPins: "Pins zijn in deze browser opgeslagen.",
    },
    systemHealth: {
      eyebrow: "Systeem",
      title: "Mac-gezondheid",
      normal: "Normaal",
      memory: "Geheugencapaciteit",
      memoryInUse: "{percent}% onder druk",
      memoryAvailable: "{percent}% beschikbaar",
      memorySummary: "{percent}% geheugen",
      memoryAndLocalAiSummary: "{percent}% geheugen · Lokale AI-processen: {count}",
      ...
      responseDelay: "Responsvertraging",
      ...
      memoryBreakdown: "{available} beschikbaar · {free} direct vrij · {total} totaal",
      memoryPressureNote:
    ...
    automationsPanel: {
      ...
      title: "Gepland werk",
      none: "Er is geen gepland werk geconfigureerd.",
      unconfirmed: "Gepland werk kan niet worden bevestigd totdat de gegevensbron hersteld is.",
      openCron: "Cron-taken openen",
      showing:
        "{shown} van {total} weergegeven. Open Cron-taken om al het geplande werk te bekijken.",
      dueNow: "Nu verschuldigd",
      noNextRun: "Geen volgende uitvoering",
      runNow: "Nu uitvoeren",
      pause: "Pauzeren",
      enable: "Inschakelen",
    },
    more: {
      title: "Meer operationele details",
      subtitle: "Geschiedenis, workflows, schema's, mogelijkheden, modellen en hostprocessen.",
      recentHistory: "Recente geschiedenis",
      workflows: "Workflows",
      capabilities: "Skills, plugins, tools en modellen",
      processes: "Grootste RAM-gebruikers",
      argumentsPrivate: "Argumenten worden nooit verzameld.",
      processRowsRejectedOne: "1 procesregel kon niet worden gelezen en is uitgesloten.",
      processRowsRejected: "{count} procesregels konden niet worden gelezen en zijn uitgesloten.",
      processesShowing:
        "De {shown} grootste van de {total} geaccepteerde processen worden weergegeven.",
      configuredActive: "Geconfigureerd en actief worden apart weergegeven.",
      configured: "Geconfigureerd",
      notConfigured: "Niet geconfigureerd",
      active: "Actief",
      inactive: "Inactief",
      activityUnverified: "Activiteit niet geverifieerd",
      catalogUnavailable:
        "Deze catalogus kan pas worden bevestigd wanneer de gegevensbron hersteld is.",
      catalogShowing: "{shown} van {total} weergegeven",
      shadowMode: "Shadow-modus · geen automatische wijzigingen",
      catalogued: "{count} gecatalogiseerd",
      available: "{count} beschikbaar",
      needsSetup: "{count} moeten worden ingesteld",
      availabilityUnverified: "Beschikbaarheid niet geverifieerd",
      noHistory: "Geen recente geschiedenis geregistreerd.",
      noActivityHistory: "Er is geen taakactiviteit geregistreerd in deze momentopname.",
      activityHistoryUnavailable:
        "Taakactiviteit kan niet worden bevestigd aan de hand van deze momentopname.",
      activityHistory: "Taakactiviteit",
      activityCount: "Activiteitsgroepen: {count}",
      incidentHistory: "Incidentgeschiedenis",
      incidentCount: "Incidentregistraties: {count}",
      historyUnavailable: "Incidentdetails zijn niet beschikbaar in deze momentopname.",
      changed: "Gewijzigd {time}",
      transitionCount: "Zwaarteovergangen: {count}",
      historyOverflow: "{count} oudere incidenten vallen buiten het behouden geschiedenisvenster.",
      historySnapshotBounded:
        "Deze momentopname bevat {shown} van de {total} incidentregistraties.",
      activitySnapshotBounded: "Dekking momentopname: {shown} van de {total} activiteitsgroepen.",
      monitorIssue: "De achtergrondmonitor heeft een probleem gemeld",
      monitorStatus: "Monitor: laatste poging {attempt}; laatste succesvolle scan {success}.",
      noWorkflows: "Geen beheerde workflows geregistreerd.",
      noProcesses: "Details van procesbronnen zijn niet beschikbaar.",
      processesUnavailable:
        "Procesinventarisatie kan niet worden bevestigd aan de hand van deze momentopname.",
      processesOmitted: "Procesinventarisatie was niet opgenomen in deze momentopname.",
      historySummary: "Historische bevindingen: {findings} · Incidentregistraties: {incidents}",
      workflowSummary: "{total} totaal · {active} actief",
      showing: "{shown} weergegeven",
      skills: "Skills",
      plugins: "Plugins",
      tools: "Tools",
      models: "Models",
      noSkills: "Geen skills gevonden.",
      noPlugins: "Geen plugins gevonden.",
      noTools: "Geen tools gevonden.",
      noModels: "Geen models gevonden.",
    ...
    actions: {
      details: "Details",
      detailsFor: "Details voor {title}",
      cancel: "Annuleren",
      cancelWork: "{title} annuleren",
      cancelWorkflow: "Workflow annuleren",
      runSchedule: "{title} nu uitvoeren",
      pauseSchedule: "{title} pauzeren",
      enableSchedule: "{title} inschakelen",
      unavailable:
        "Bedieningselementen zijn niet beschikbaar totdat deze gegevens actueel en compleet zijn.",
      cancelled: "Actie geannuleerd. Er is niets veranderd.",
      confirm:
        "{summary}\n\nRisico: {risk}\n\nDeze beveiligde actie verloopt op {expires}. Doorgaan?",
      risks: {
        low: "Laag",
        medium: "Gemiddeld",
        high: "Hoog",
    ...
    counts: {
      exact: "{count}",
      shown: "{shown} van {total} weergegeven",
      compactShown: "{shown} van {total}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "Modellen",
        processes: "Processen",
        eventLoop: "Gateway-antwoordtijd",
        monitor: "Operatiemonitor",
        incidentLedger: "Incidentgeschiedenis",
      },
      categories: {
        agent: "Agent",
        workflow: "Workflow",
      ...
      routes: {
        ...
        metered: "Gemeten",
        unknown: "Route onbekend",
      },
      processKinds: {
        gateway: "Gateway",
        local_model: "Lokaal model",
        browser: "Browser",
        other: "Overig",
      },
      dispositions: {
        needs_user: "Heeft uw aandacht",
        handling: "OpenClaw is bezig",
        watching: "Aan het bekijken",
        historical: "Historisch",
      },
    },
    footer: "Alleen deterministische monitoring. Geen modelaanroepen of automatische mutaties.",
  },
  tabs: {
    agents: "Agents",
    activity: "Activiteit",
    overview: "Overzicht",
    operations: "Operationeel centrum",
    workboard: "Werkbord",
    worktrees: "Worktrees",
    channels: "Kanalen",
  ...
  subtitles: {
    ...
    operations: "Agenten, workflows, mogelijkheden, modellen en middelen in één oogopslag.",
  ...
  workboard: {
    ...
    dispatch: "Klaarstaand werk toewijzen",
    dispatchSummary:
  ...
  chat: {
    ...
    prepareVerifiedUpdate: "Geverifieerde update voorbereiden",
    preparingVerifiedUpdate: "Geverifieerde update wordt voorbereid…",
    installVerifiedUpdate: "Geverifieerde update installeren",
    exactShaApprovalRequired: "Goedkeuring van de exacte SHA vereist",
    updateProtectionIncomplete: "Updatebeveiliging vereist aandacht.",
