...
export const zh_CN: TranslationMap = {
  ...
  operationsRoom: {
    ...
    resolution: {
      ...
      resolveFor: "解决 {title}",
      previewOnly: "仅预览。",
      previewOnlyDetail: "未进行任何更改。",
      closePreview: "关闭预览 — 不执行任何更改",
      whatHappened: "发生了什么",
      progress: "进度",
      risk: "问题风险",
      changePreview: "变更内容",
    ...
    ownerAcceptance: {
      ...
      subtitle:
        "计时器在您点击“开始”后才启动。阅读屏幕内容，选择答案，预览最高优先级的解决方案，然后在不进行更改的情况下关闭它。",
      begin: "开始 60 秒检查",
      secondsLeft: "剩余秒数",
      ...
      resolveQuestion: "预览最高优先级的解决方案，然后在不进行更改的情况下关闭它。",
      resolvePending: "尚未完成",
      resolveDone: "已打开预览并安全关闭",
      finish: "完成并创建收据",
      passed: "负责人检查通过",
      failed: "负责人检查未通过",
