...
export const zh_CN: TranslationMap = {
  ...
  operationsRoom: {
    ...
    stale: "上次已知状态",
    partial: "部分数据",
    unavailableTitle: "运营数据不可用",
    actionFailedTitle: "操作未完成",
    staleTitle: "实时更新失败",
    staleDetail: "显示来自 {time} 的最后一个成功快照。",
    unavailableSources: "不可用的数据源：{sources}。",
    fallbackSources: "备用数据源：{sources}。",
    loading: "正在构建当前运营视图…",
    empty: "暂无可用的运营快照。",
    now: "现在",
    briefingUnavailable: "无法确认当前概览。请查看下方的特定源状态。",
    lastKnownBriefing: "显示上次已知概览",
    briefingTone: {
      normal: "最新状态",
      attention: "需要关注",
      urgent: "紧急",
    ...
    overviewNav: "运营概览",
    reviewCount: "待审核 {count}",
    reviewUnconfirmed: "待审核 —",
    decisionCount: "需要决策 {count}",
    decisionsUnconfirmed: "需要决策 —",
    workingCount: "正在运行 {count}",
    workingCountBounded: "正在运行 {count}+",
    workingUnconfirmed: "正在运行 —",
    agentsWorkingNowCount: "当前工作的代理 {count}",
    agentsWorkingUnconfirmed: "当前工作的代理 —",
    openClawWorkCount: "OpenClaw 工作项 {count}",
    openClawWorkUnconfirmed: "OpenClaw 工作项 —",
    allAgentsCount: "所有代理 {count}",
    agentsUnconfirmed: "所有代理 —",
    agentsCount: "{count} 个代理",
    urgentCount: "{count} 项紧急",
    activeAgentsCount: "活跃代理：{count}",
    workingItemsCount: "工作项：{count}",
    showingAgents: "显示 {count}",
    attentionAgentsCount: "{count} 需要关注",
    agentStatusSummary: "{working} 工作中 · {attention} 需要关注",
    automationCount: "计划任务：{total} · 失败：{failing}",
    automations: "自动化",
    system: "系统",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "需要审核",
      title: "关注事项",
      subtitle: "优先显示当前问题。历史事件保留在“更多”中。",
      needsYou: "需要您处理",
      handling: "OpenClaw 正在处理",
      watching: "监控中",
      none: "无需您关注的事项。",
      noCritical: "当前无活跃的关键问题。",
      currentCount: "{count} 个当前事项",
      noneNeedsYou: "暂无等待您决策或干预的事项。",
      noneHandling: "暂无正在进行的修复操作。",
      noneWatching: "暂无监控中的事项。",
      impact: "影响",
      owner: "负责人",
      you: "你",
      unassignedOwner: "未分配",
      ...
      nextAction: "下一步操作",
      nextActionShort: "下一步",
      highestPriority: "最高优先级问题",
      whoOwnsThis: "负责人",
      whatHappensNext: "后续步骤",
      continueMonitoring: "继续监控。",
      observed: "{time} 观察到",
      lastKnown: "最后已知状态",
      unconfirmedTitle: "无法确认关注状态",
      unconfirmedDetail: "已知问题显示如下，但不完整或最后已知数据可能会遗漏较新的问题。",
      unconfirmedShort: "需要验证",
      showingCurrent: "在此有限快照中显示 {shown}/{total} 个当前问题。源视图提供相关记录。",
      outsidePreview: "{count} 个当前问题在此预览范围之外。请打开上方的源视图。",
      lastProgress: "上次进度",
      nextCheck: "下次检查",
      remediationTask: "修复任务",
      openRemediation: "打开修复",
      responseStates: {
        unassigned: "未分配",
        in_progress: "进行中",
        monitoring: "监控中",
        waiting_for_user: "等待您操作",
        resolved: "已解决",
      },
    },
    resolution: {
      ...
      resolveFor: "查看 {title} 的推荐解决方案",
      previewOnly: "仅供参考。",
      previewOnlyDetail: "在获得批准的合格修复操作执行之前，不会发生任何更改。",
      closePreview: "暂不",
      notNow: "暂不",
      recommendedLabel: "推荐修复：",
      recommendedFix: "推荐修复",
      whyRecommended: "推荐理由",
      defaultReason: "这是根据当前可用证据支持的最安全的下一步操作。",
      confidence: "置信度",
      confidencePending: "等待本地调查",
      confidenceValue: "{confidence}% 置信度",
      whatHappened: "发生了什么",
      progress: "进度",
      risk: "问题风险",
      changePreview: "变更内容",
      verification: "OpenClaw 的验证方式",
      verificationPending: "在运行任何自动更改之前，需要确定性的验证计划。",
      approval: "您的审批",
      evidence: "进度更新",
      localReview: "本地审查（{confidence}%）：{recommendation}",
      judgeReview: "独立安全审查：{decision} — {reason}",
      approved: "已批准",
      rejected: "已拒绝",
      rollback: "回滚计划",
      undoAvailability: "撤销可用性",
      undoAvailable: "可通过受控预览使用",
      undoUnavailable: "无直接撤销功能可用",
      viewRepairDetails: "查看修复详情",
      result: "结果",
      undo: "撤消此修复",
      investigate: "使用本地 AI 调查",
      reviewEscalation: "使用 Codex 进行审查",
      reviewCancellation: "审核取消",
      fixThis: "为我修复此问题",
      investigationPreview: "目前不会发生任何更改。将打开一个只读的调查草稿供您审核和发送。",
      cancelPreview: "准备受保护的预览以取消“{title}”。",
      approvalRequired: "您必须在任何更改生效前进行批准。",
      oneConfirmation: "由于这是一项经过审查、可逆的中风险修复操作，因此需要一次简洁的确认。",
      automaticPolicy: "OpenClaw 可能会自动运行此已批准的修复，因为它是有限且可逆的。",
      evidenceLocation: "进度和证明将显示在此问题、“自您上次访问以来”部分以及 Workboard 中。",
      investigationRollback:
        "目前尚不需要，因为调查不会进行任何更改。任何建议的修复方案都必须包含回滚计划。",
      cancelRollback: "取消操作无法恢复已完成的工作。请在批准前仔细查看确切的变更预览。",
      progressLocationLabel: "进度显示位置",
      safeguard:
        "高风险、不可逆、安全敏感、财务、凭证、发布、破坏性、新颖或不确定性的更改仍需您确认。",
      draftNotice: "打开草稿不会发送或开始工作。",
      nextStepUnknown: "尚未确认安全的下一步操作。在做出任何更改之前，请先进行调查。",
      stages: {
        needs_review: "需要审核",
        openclaw_handling: "OpenClaw 正在处理此问题",
        watching: "OpenClaw 正在监控此项",
        resolved: "已解决",
      },
      risks: {
        low: "低",
    ...
    working: {
      eyebrow: "进行中",
      title: "正在处理",
      subtitle: "仅限 OpenClaw 管理的任务和工作流。本地 AI 进程显示在“系统”下。",
      none: "当前没有 OpenClaw 代理正在积极工作。",
      unconfirmed: "在数据源恢复之前，无法确认当前工作。",
      unverified: "当前工作未经验证",
      countsUnconfirmed: "数量无法确认",
      itemsCount: "{count} 项正在处理",
      itemsCountBounded: "至少 {count} 项正在处理",
      showingPreview: "显示 {shown} 条最近的工作摘要。工作板包含受管理的任务和流程记录。",
      openWorkboard: "打开工作板",
      details: "工作详情",
      relatedRuns: "{count} 次相关运行",
      workTotals: "任务与流程总计",
      tasks: "任务",
      taskTotals: "活跃：{active} · 需关注：{failed} · 总计：{total}",
      workflows: "流程",
      workflowTotals: "活跃：{active} · 总计：{total}",
    },
    activityComparison: {
      eyebrow: "当前活动",
      title: "正在运行的内容",
      subtitle: "两个不同的信号，合并显示。",
      openClawLabel: "OpenClaw 管理的工作",
      openClawCountOne: "1 个工作代理",
      openClawCount: "{count} 个工作代理",
      openClawDetail: "OpenClaw 正在积极管理的任务和工作流。",
      localAiLabel: "独立本地 AI",
      localAiCountOne: "已加载 1 个模型进程",
      localAiCount: "已加载 {count} 个模型进程",
      localAiDetail: "在此 Mac 上加载的模型。已加载的进程不一定表示当前正在生成内容。",
      unconfirmed: "无法确认",
    },
    ownerAcceptance: {
      eyebrow: "负责人验收",
      title: "60 秒 Operations Room 检查",
      subtitle:
        "计时器在您点击“开始”后才启动。阅读屏幕内容，选择答案，查看最高优先级的推荐建议，然后在不进行任何更改的情况下选择“暂不”。",
      begin: "开始 60 秒检查",
      secondsLeft: "剩余秒数",
      statusQuestion: "主要系统状态是什么？",
      activityQuestion: "当前正在运行什么？",
      activityAnswer: "OpenClaw: {openClaw} · 本地 AI: {localAi}",
      issueQuestion: "谁负责最高优先级的问题，下一步是什么？",
      issueAnswer: "{owner} — {next}",
      issueUnknown: "未知负责人或下一步操作",
      resolveQuestion: "查看优先级最高的建议，然后选择“稍后处理”。",
      resolvePending: "尚未完成",
      resolveDone: "已查看建议并安全推迟",
      finish: "完成并创建收据",
      passed: "负责人检查通过",
      failed: "负责人检查未通过",
      elapsed: "在 {seconds} 秒内完成。",
      copyReceipt: "复制收据",
      copied: "收据已复制",
      copyFailed: "无法复制。请改用“下载收据”。",
    ...
    changes: {
      ...
      title: "自您上次访问以来",
      none: "自您上次访问以来无重大变更。",
      unconfirmed: "在数据源恢复之前，无法确认最近的变更。",
      firstVisit: "最近重大变更",
      incidentResolved: "问题已解决",
      incidentChanged: "问题已变更",
      showingNewest: "显示最新的 {count} 条变更。打开可用历史记录以查看更多详情。",
      openActivity: "打开可用历史记录",
      activitySummaryOne: "1 个相关的 {runtime} 运行 {result}。",
      activitySummary: "{count} 个相关的 {runtime} 运行 {result}。",
      outcomes: {
        working: "仍在运行中",
        succeeded: "已完成",
        blocked: "已被阻塞",
      ...
      remediationOutcomes: {
        completed: "OpenClaw 已修复并验证此问题",
        rolled_back: "OpenClaw 自动撤回了未通过验证的修复",
        failed: "自动修复已停止，需要审查",
        approval_required: "OpenClaw 已停止并请求批准",
      },
    },
    agents: {
      eyebrow: "实时房间",
      title: "智能体",
      subtitle: "操作优先级优先。就绪的智能体会保持折叠状态。",
      searchLabel: "搜索智能体",
      ...
      sortName: "名称",
      sortRecent: "最近活动",
      noMatches: "没有智能体匹配此搜索。",
      noShownMatches: "显示的智能体无匹配项。请在完整的智能体视图中搜索。",
      searchResultCount: "显示 {count} 个匹配的智能体。",
      searchResultCountBounded: "显示 {count} 个匹配的智能体。完整的智能体视图可能包含更多。",
      unconfirmed: "在数据源恢复之前，无法确认代理活动。",
      unconfirmedShort: "活动未验证",
      showing: "显示 {shown}/{total} 个代理。紧急和活动中的代理优先显示。",
      openAll: "打开所有代理",
      urgent: "紧急",
      attention: "需要关注",
      working: "工作中",
      ...
      openAgent: "打开代理",
      reviewIssue: "查看问题",
      whatNeedsAttention: "需要关注的内容",
      blockedTaskNeedsDecision: "{count} 个受阻任务需要你的决策。在更改代理之前，请先查看问题。",
      blockedTasksNeedDecision:
        "{count} 个受阻任务需要你的决策。在更改代理之前，请先查看这些问题。",
      urgentIssueNeedsDecision: "有一个紧急问题需要你的决策。",
      issueBeingHandled: "OpenClaw 正在处理该代理的问题。",
      issueBeingWatched: "该代理的问题正在被监控。",
      technicalDetails: "技术详情",
      duty: "职责",
      currentWork: "当前工作",
      lastActivity: "最近活动",
      taskCounts: "任务",
      taskCountSummary: "活跃：{active} · 阻塞：{blocked}",
      model: "模型",
      fallback: "回退",
      heartbeat: "心跳",
      ram: "内存",
      inheritedDefault: "继承默认值",
      noFallback: "无显式回退",
      readyForWork: "准备就绪",
      noCurrentWork: "无",
      unavailableRam: "不可归因",
      browserLocalPins: "书签保存在此浏览器中。",
    },
    systemHealth: {
      eyebrow: "系统",
      title: "Mac 健康状态",
      normal: "正常",
      memory: "内存容量",
      memoryInUse: "{percent}% 处于压力状态",
      memoryAvailable: "{percent}% 可用",
      memorySummary: "{percent}% 内存",
      memoryAndLocalAiSummary: "{percent}% 内存 · 本地 AI 进程：{count}",
      ...
      technicalDetails: "技术详情",
      gatewayRam: "Gateway 内存",
      host: "主机",
      logicalCores: "逻辑 CPU 核心",
      unavailable: "不可用",
      memoryBreakdown: "{available} 可用 · {free} 立即可用 · {total} 总计",
      memoryPressureNote:
    ...
    automationsPanel: {
      ...
      title: "计划任务",
      none: "未配置计划任务。",
      unconfirmed: "在数据源恢复之前，无法确认计划任务。",
      openCron: "打开 Cron Jobs",
      showing: "显示 {shown} / {total}。打开 Cron Jobs 以查看所有计划任务。",
      dueNow: "即将到期",
      noNextRun: "无下次运行",
      runNow: "立即运行",
      pause: "暂停",
    ...
    more: {
      title: "更多操作详情",
      subtitle: "历史记录、工作流、计划、功能、模型和主机进程。",
      recentHistory: "最近历史",
      workflows: "工作流",
      capabilities: "Skills、插件、工具和模型",
      processes: "占用 RAM 最多的进程",
      argumentsPrivate: "参数永远不会被收集。",
      processRowsRejectedOne: "1 个进程行无法读取，已被排除。",
      processRowsRejected: "{count} 个进程行无法读取，已被排除。",
      processesShowing: "显示 {total} 个已接受进程中最大的 {shown} 个。",
      configuredActive: "已配置和活跃状态将分别显示。",
      configured: "已配置",
      notConfigured: "未配置",
      active: "活跃",
      inactive: "不活跃",
      activityUnverified: "活动状态未验证",
      catalogUnavailable: "在数据源恢复之前，无法确认此目录。",
      catalogShowing: "显示 {total} 中的 {shown}",
      shadowMode: "影子模式 · 无自动更改",
      catalogued: "{count} 已编目",
      available: "{count} 可用",
      needsSetup: "{count} 需要设置",
      availabilityUnverified: "可用性未验证",
      noHistory: "未记录最近的历史。",
      noActivityHistory: "此快照中未记录任何任务活动。",
      activityHistoryUnavailable: "无法从此快照确认任务活动。",
      activityHistory: "任务活动",
      activityCount: "活动组：{count}",
      incidentHistory: "事件历史记录",
      incidentCount: "事件记录：{count}",
      historyUnavailable: "此快照中不可用事件详情。",
      changed: "{time} 变更",
      transitionCount: "严重性转换次数：{count}",
      historyOverflow: "{count} 条较早的事件已超出保留的历史记录窗口。",
      historySnapshotBounded: "此快照包含 {total} 条事件记录中的 {shown} 条。",
      activitySnapshotBounded: "快照覆盖范围：{total} 个活动组中的 {shown} 个。",
      monitorIssue: "后台监控报告出现问题",
      monitorStatus: "监控：上次尝试 {attempt}；上次成功扫描 {success}。",
      noWorkflows: "未记录受管工作流。",
      noProcesses: "进程资源详情不可用。",
      processesUnavailable: "无法从此快照确认进程清单。",
      processesOmitted: "此快照中未包含进程清单。",
      historySummary: "历史发现：{findings} · 事件记录：{incidents}",
      workflowSummary: "总计 {total} · 活跃 {active}",
      showing: "显示 {shown}",
      skills: "Skills",
      plugins: "插件",
      tools: "工具",
    ...
    actions: {
      details: "详情",
      detailsFor: "{title} 的详情",
      cancel: "取消",
      cancelWork: "取消 {title}",
      cancelWorkflow: "取消工作流",
      runSchedule: "立即运行 {title}",
      pauseSchedule: "暂停 {title}",
      enableSchedule: "启用 {title}",
      unavailable: "在数据新鲜且完整之前，控件不可用。",
      cancelled: "操作已取消。未发生任何更改。",
      confirm: "{summary}\n\n风险：{risk}\n\n此受保护的操作将于 {expires} 过期。是否继续？",
      risks: {
        low: "低",
        medium: "中",
        high: "高",
    ...
    counts: {
      exact: "{count}",
      shown: "显示 {total} 中的 {shown}",
      compactShown: "{total} 中的 {shown}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
