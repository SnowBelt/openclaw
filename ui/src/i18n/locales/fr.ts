...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    musicStudio: "Invitez, arrangez, écoutez et finalisez de la musique originale.",
  ...
  overview: {
    ...
    cards: {
      ...
      judgeGuardOpenSessions: "Sessions",
      ...
      truthAuditOpenSessions: "Sessions",
