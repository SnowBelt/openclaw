...
export const id: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "Bidang kontrol OpenClaw",
    title: "Ruang Operasi",
    subtitle: "Apa yang perlu perhatian, apa yang berfungsi, dan bagaimana kinerja sistem.",
    refresh: "Segarkan",
    refreshing: "Menyegarkan…",
    refreshLabel: "Segarkan Ruang Operasi",
    updated: "Diperbarui {time}",
    live: "Langsung",
    stale: "Terakhir diketahui",
    partial: "Data parsial",
    unavailableTitle: "Data operasi tidak tersedia",
    actionFailedTitle: "Tindakan tidak selesai",
    staleTitle: "Pembaruan langsung gagal",
    staleDetail: "Menampilkan snapshot berhasil terakhir dari {time}.",
    unavailableSources: "Sumber yang tidak tersedia: {sources}.",
    fallbackSources: "Sumber data cadangan: {sources}.",
    loading: "Membangun gambaran operasi saat ini…",
    empty: "Belum ada snapshot operasi yang tersedia.",
    now: "Sekarang",
    briefingUnavailable:
      "Ikhtisar saat ini tidak dapat dikonfirmasi. Tinjau status spesifik sumber di bawah ini.",
    lastKnownBriefing: "Tampilkan ikhtisar terakhir yang diketahui",
    briefingTone: {
      normal: "Terbaru",
    ...
    overallBriefingTone: {
      normal: "Secara keseluruhan: Terkini",
      attention: "Secara keseluruhan: Perlu perhatian",
      urgent: "Secara keseluruhan: Mendesak",
      unknown: "Secara keseluruhan: Status tidak diketahui",
    },
    overviewNav: "Ringkasan operasi",
    reviewCount: "Tinjau {count}",
    reviewUnconfirmed: "Tinjau —",
    decisionCount: "Keputusan diperlukan {count}",
    decisionsUnconfirmed: "Keputusan diperlukan —",
    workingCount: "Sedang bekerja {count}",
    workingCountBounded: "Sedang bekerja {count}+",
    workingUnconfirmed: "Sedang bekerja —",
    agentsWorkingNowCount: "Agen bekerja sekarang {count}",
    agentsWorkingUnconfirmed: "Agen bekerja sekarang —",
    openClawWorkCount: "Pekerjaan OpenClaw {count}",
    openClawWorkUnconfirmed: "Pekerjaan OpenClaw —",
    allAgentsCount: "Semua agen {count}",
    agentsUnconfirmed: "Semua agen —",
    agentsCount: "{count} agen",
    urgentCount: "{count} mendesak",
    activeAgentsCount: "Agen aktif: {count}",
    workingItemsCount: "Item kerja: {count}",
    showingAgents: "Menampilkan {count}",
    attentionAgentsCount: "{count} perlu perhatian",
    agentStatusSummary: "{working} bekerja · {attention} perlu perhatian",
    automationCount: "Jadwal: {total} · Gagal: {failing}",
    automations: "Otomasi",
    system: "Sistem",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "Perlu ditinjau",
      title: "Perhatian",
      subtitle: "Masalah saat ini terlebih dahulu. Peristiwa historis tetap di Lainnya.",
      needsYou: "Membutuhkan Anda",
      handling: "OpenClaw sedang menangani",
      watching: "Dipantau",
      none: "Tidak ada yang membutuhkan perhatian Anda.",
      noCritical: "Tidak ada masalah kritis yang aktif.",
      currentCount: "{count} saat ini",
      noneNeedsYou: "Tidak ada keputusan atau intervensi yang menunggu Anda.",
      noneHandling: "Tidak ada perbaikan aktif yang sedang berlangsung.",
      noneWatching: "Tidak ada yang sedang dipantau.",
      impact: "Dampak",
      owner: "Pemilik",
      you: "Anda",
      unassignedOwner: "Belum ditugaskan",
      response: "Respons",
      nextAction: "Tindakan selanjutnya",
      nextActionShort: "Selanjutnya",
      highestPriority: "Masalah prioritas tertinggi",
      whoOwnsThis: "Siapa yang bertanggung jawab atas ini",
      whatHappensNext: "Apa yang terjadi selanjutnya",
      continueMonitoring: "Lanjutkan pemantauan.",
      observed: "Diamati {time}",
      lastKnown: "Terakhir diketahui",
      unconfirmedTitle: "Status perhatian tidak dapat dikonfirmasi",
      unconfirmedDetail:
        "Masalah yang diketahui ditampilkan di bawah, tetapi data yang tidak lengkap atau terakhir diketahui mungkin mengabaikan masalah terbaru.",
      unconfirmedShort: "Perlu verifikasi",
      showingCurrent:
        "Menampilkan {shown} dari {total} masalah saat ini dalam snapshot terbatas ini. Tampilan sumber menyediakan catatan terkait.",
      outsidePreview:
        "{count} masalah saat ini berada di luar pratinjau ini. Buka tampilan sumber di atas.",
      lastProgress: "Kemajuan terakhir",
      nextCheck: "Pemeriksaan berikutnya",
      remediationTask: "Tugas remediasi",
      openRemediation: "Buka remediasi",
      responseStates: {
    ...
    resolution: {
      ...
      judgeReview: "Tinjauan keamanan independen: {decision} — {reason}",
      approved: "Disetujui",
      rejected: "Ditolak",
      rollback: "Rencana rollback",
      undoAvailability: "Ketersediaan Undo",
      undoAvailable: "Tersedia melalui pratinjau yang dijaga",
      undoUnavailable: "Tidak ada Undo langsung yang tersedia",
      viewRepairDetails: "Lihat detail perbaikan",
      result: "Hasil",
      undo: "Urungkan perbaikan ini",
      ...
      evidenceLocation:
        "Progres dan bukti akan muncul di masalah ini, bagian “Sejak kunjungan terakhir Anda”, dan Workboard.",
      ...
      nextStepUnknown:
        "Tidak ada langkah selanjutnya yang aman dikonfirmasi. Selidiki sebelum mengubah apa pun.",
      stages: {
        needs_review: "Perlu ditinjau",
        openclaw_handling: "OpenClaw sedang menangani ini",
        watching: "OpenClaw sedang memantau ini",
        resolved: "Terselesaikan",
      },
      risks: {
        low: "Rendah",
    ...
    working: {
      ...
      subtitle:
        "Hanya tugas dan alur kerja yang dikelola oleh OpenClaw. Proses AI lokal muncul di bawah Sistem.",
      none: "Tidak ada agen OpenClaw yang sedang bekerja secara aktif saat ini.",
      unconfirmed: "Pekerjaan saat ini tidak dapat dikonfirmasi hingga sumber datanya pulih.",
      unverified: "Pekerjaan saat ini belum diverifikasi",
      countsUnconfirmed: "Jumlah tidak dapat dikonfirmasi",
      itemsCount: "{count} item sedang bekerja",
      itemsCountBounded: "Setidaknya {count} item sedang bekerja",
      showingPreview:
        "Menampilkan {shown} ringkasan pekerjaan terbaru. Workboard berisi catatan tugas dan alur kerja yang dikelola.",
      openWorkboard: "Buka Workboard",
      details: "Detail pekerjaan",
      relatedRuns: "{count} eksekusi terkait",
      workTotals: "Total tugas dan alur kerja",
      tasks: "Tugas",
      taskTotals: "Aktif: {active} · Perlu perhatian: {failed} · Total: {total}",
      workflows: "Alur kerja",
      workflowTotals: "Aktif: {active} · Total: {total}",
    },
    activityComparison: {
      eyebrow: "Aktivitas saat ini",
      title: "Yang sedang berjalan",
      subtitle: "Dua sinyal berbeda, ditampilkan bersama.",
      openClawLabel: "Pekerjaan yang dikelola OpenClaw",
      openClawCountOne: "1 agen bekerja",
      openClawCount: "{count} agen bekerja",
      openClawDetail: "Tugas dan alur kerja yang sedang dikelola secara aktif oleh OpenClaw.",
      localAiLabel: "AI lokal independen",
      localAiCountOne: "1 proses model dimuat",
      localAiCount: "{count} proses model dimuat",
      localAiDetail:
        "Model yang dimuat di Mac ini. Proses yang dimuat tidak selalu berarti sedang menghasilkan output saat ini.",
      unconfirmed: "Tidak dapat dikonfirmasi",
    },
    ownerAcceptance: {
      ...
      activityQuestion: "Apa yang sedang berjalan saat ini?",
      activityAnswer: "OpenClaw: {openClaw} · AI Lokal: {localAi}",
      ...
      elapsed: "Selesai dalam {seconds} detik.",
      copyReceipt: "Salin tanda terima",
      copied: "Tanda terima disalin",
      copyFailed: "Penyalinan tidak tersedia. Gunakan Unduh tanda terima sebagai gantinya.",
      downloadReceipt: "Unduh tanda terima",
    },
    changes: {
      eyebrow: "Perubahan terbaru",
      title: "Sejak kunjungan terakhir Anda",
      none: "Tidak ada perubahan signifikan sejak kunjungan terakhir Anda.",
      unconfirmed: "Perubahan terbaru tidak dapat dikonfirmasi hingga sumber datanya pulih.",
      firstVisit: "Perubahan signifikan terbaru",
      incidentResolved: "Masalah terselesaikan",
      incidentChanged: "Masalah berubah",
      showingNewest:
        "Menampilkan {count} perubahan terbaru. Buka riwayat yang tersedia untuk detail lebih lanjut.",
      openActivity: "Buka riwayat yang tersedia",
      activitySummaryOne: "1 {runtime} terkait {result}.",
      activitySummary: "{count} {runtime} terkait {result}.",
      outcomes: {
        working: "masih berjalan",
        succeeded: "selesai",
        blocked: "terblokir",
        failed: "gagal",
        cancelled: "dibatalkan",
        unknown: "berakhir dengan hasil yang tidak diketahui",
      },
      remediationOutcomes: {
        completed: "OpenClaw memperbaiki dan memverifikasi masalah ini",
        rolled_back: "OpenClaw secara otomatis membatalkan perbaikan yang tidak terverifikasi",
        failed: "Perbaikan otomatis berhenti dan perlu ditinjau",
        approval_required: "OpenClaw berhenti dan meminta persetujuan",
      },
    },
    agents: {
      eyebrow: "Ruang langsung",
      title: "Agen",
      subtitle: "Prioritas operasional utama. Agen siap tetap terlipat.",
      searchLabel: "Cari agen",
      searchPlaceholder: "Cari agen",
      sortLabel: "Urutkan agen",
      sortPriority: "Prioritas",
      sortName: "Nama",
      sortRecent: "Aktivitas terbaru",
      noMatches: "Tidak ada agen yang cocok dengan pencarian ini.",
      noShownMatches: "Tidak ada agen yang ditampilkan cocok. Cari di tampilan Agen lengkap.",
      searchResultCount: "{count} agen yang cocok ditampilkan.",
      searchResultCountBounded:
        "{count} agen yang cocok ditampilkan. Tampilan Agen lengkap mungkin mencakup lebih banyak.",
      unconfirmed: "Aktivitas agen tidak dapat dikonfirmasi hingga sumber datanya pulih.",
      unconfirmedShort: "Aktivitas belum diverifikasi",
      showing:
        "Menampilkan {shown} dari {total} agen. Agen mendesak dan aktif muncul terlebih dahulu.",
      openAll: "Buka semua agen",
      urgent: "Mendesak",
      attention: "Perlu perhatian",
      working: "Sedang bekerja",
      waiting: "Menunggu atau dijadwalkan",
      recent: "Baru saja berubah",
      ready: "Siap",
      off: "Nonaktif atau tidak diketahui",
      pin: "Sematkan {name}",
      unpin: "Lepas sematan {name}",
      pinned: "Disematkan",
      openAgent: "Buka agen",
      reviewIssue: "Tinjau masalah",
      whatNeedsAttention: "Apa yang perlu diperhatikan",
      blockedTaskNeedsDecision:
        "{count} tugas terhambat memerlukan keputusan Anda. Tinjau masalah sebelum mengubah agen.",
      blockedTasksNeedDecision:
        "{count} tugas terhambat memerlukan keputusan Anda. Tinjau masalah-masalah tersebut sebelum mengubah agen.",
      urgentIssueNeedsDecision: "Sebuah masalah mendesak memerlukan keputusan Anda.",
      issueBeingHandled: "OpenClaw sedang menangani masalah untuk agen ini.",
      issueBeingWatched: "Masalah untuk agen ini sedang dipantau.",
      technicalDetails: "Detail teknis",
      duty: "Tugas",
      currentWork: "Pekerjaan saat ini",
      lastActivity: "Aktivitas terakhir",
      taskCounts: "Tugas",
      taskCountSummary: "Aktif: {active} · Terblokir: {blocked}",
      model: "Model",
      fallback: "Cadangan",
      heartbeat: "Heartbeat",
      ram: "RAM",
      inheritedDefault: "Default yang diwarisi",
      noFallback: "Tidak ada fallback eksplisit",
      readyForWork: "Siap bekerja",
      noCurrentWork: "Tidak ada",
      unavailableRam: "Tidak dapat dialokasikan",
      browserLocalPins: "Pin disimpan di browser ini.",
    },
    systemHealth: {
      eyebrow: "Sistem",
      title: "Kesehatan Mac",
      normal: "Normal",
      memory: "Kapasitas memori",
      memoryInUse: "{percent}% di bawah tekanan",
      memoryAvailable: "{percent}% tersedia",
      memorySummary: "{percent}% memori",
      memoryAndLocalAiSummary: "{percent}% memori · Proses AI lokal: {count}",
      ...
      cpu: "CPU",
      load: "Beban {value}",
      responseDelay: "Keterlambatan respons",
      ...
      memoryBreakdown: "{available} tersedia · {free} langsung bebas · {total} total",
      memoryPressureNote:
    ...
    automationsPanel: {
      ...
      none: "Tidak ada pekerjaan terjadwal yang dikonfigurasi.",
      unconfirmed: "Pekerjaan terjadwal tidak dapat dikonfirmasi hingga sumber datanya pulih.",
      openCron: "Buka Cron Jobs",
      showing:
        "Menampilkan {shown} dari {total}. Buka Cron Jobs untuk meninjau semua pekerjaan terjadwal.",
      dueNow: "Jatuh tempo sekarang",
      noNextRun: "Tidak ada jadwal berikutnya",
      runNow: "Jalankan sekarang",
      pause: "Jeda",
      enable: "Aktifkan",
    },
    more: {
      title: "Detail operasi lainnya",
      subtitle: "Riwayat, alur kerja, jadwal, kemampuan, model, dan proses host.",
      recentHistory: "Riwayat terbaru",
      workflows: "Alur kerja",
      capabilities: "Skills, plugin, alat, dan model",
      processes: "Konsumen RAM terbesar",
      argumentsPrivate: "Argumen tidak pernah dikumpulkan.",
      processRowsRejectedOne: "1 baris proses tidak dapat dibaca dan dikecualikan.",
      processRowsRejected: "{count} baris proses tidak dapat dibaca dan dikecualikan.",
      processesShowing: "Menampilkan {shown} terbesar dari {total} proses yang diterima.",
      configuredActive: "Yang dikonfigurasi dan aktif ditampilkan secara terpisah.",
      configured: "Dikonfigurasi",
      notConfigured: "Belum dikonfigurasi",
      active: "Aktif",
      inactive: "Tidak aktif",
      activityUnverified: "Aktivitas belum diverifikasi",
      catalogUnavailable: "Katalog ini tidak dapat dikonfirmasi hingga sumber datanya pulih.",
      catalogShowing: "Menampilkan {shown} dari {total}",
      shadowMode: "Mode bayangan · tanpa perubahan otomatis",
      catalogued: "{count} terkatelogi",
      available: "{count} tersedia",
      needsSetup: "{count} perlu pengaturan",
      availabilityUnverified: "Ketersediaan belum diverifikasi",
      noHistory: "Tidak ada riwayat terbaru yang dicatat.",
      noActivityHistory: "Tidak ada aktivitas tugas yang dicatat dalam snapshot ini.",
      activityHistoryUnavailable: "Aktivitas tugas tidak dapat dikonfirmasi dari snapshot ini.",
      activityHistory: "Aktivitas tugas",
      activityCount: "Grup aktivitas: {count}",
      incidentHistory: "Riwayat insiden",
      incidentCount: "Catatan insiden: {count}",
      historyUnavailable: "Detail insiden tidak tersedia dalam snapshot ini.",
      changed: "Berubah {time}",
      transitionCount: "Transisi tingkat keparahan: {count}",
      historyOverflow:
        "{count} insiden yang lebih lama berada di luar jendela riwayat yang disimpan.",
      historySnapshotBounded: "Snapshot ini mencakup {shown} dari {total} catatan insiden.",
      activitySnapshotBounded: "Cakupan snapshot: {shown} dari {total} grup aktivitas.",
      monitorIssue: "Monitor latar belakang melaporkan masalah",
      monitorStatus: "Monitor: upaya terakhir {attempt}; pindaian berhasil terakhir {success}.",
      noWorkflows: "Tidak ada alur kerja yang dikelola yang dicatat.",
      noProcesses: "Detail sumber daya proses tidak tersedia.",
      processesUnavailable: "Inventaris proses tidak dapat dikonfirmasi dari snapshot ini.",
      processesOmitted: "Inventaris proses tidak disertakan dalam snapshot ini.",
      historySummary: "Temuan historis: {findings} · Catatan insiden: {incidents}",
      workflowSummary: "Total {total} · Aktif {active}",
      showing: "menampilkan {shown}",
      skills: "Skills",
      plugins: "Plugins",
      tools: "Tools",
      models: "Models",
      noSkills: "Tidak ada skills yang ditemukan.",
      noPlugins: "Tidak ada plugins yang ditemukan.",
      noTools: "Tidak ada tools yang ditemukan.",
      noModels: "Tidak ada models yang ditemukan.",
    ...
    actions: {
      details: "Detail",
      detailsFor: "Detail untuk {title}",
      cancel: "Batal",
      cancelWork: "Batalkan {title}",
      cancelWorkflow: "Batalkan alur kerja",
      runSchedule: "Jalankan {title} sekarang",
      pauseSchedule: "Jeda {title}",
      enableSchedule: "Aktifkan {title}",
      unavailable: "Kontrol tidak tersedia hingga data ini segar dan lengkap.",
      cancelled: "Tindakan dibatalkan. Tidak ada perubahan.",
      confirm:
        "{summary}\n\nRisiko: {risk}\n\nTindakan yang dijaga ini kedaluwarsa pada {expires}. Lanjutkan?",
      risks: {
        low: "Rendah",
        medium: "Sedang",
        high: "Tinggi",
    ...
    counts: {
      exact: "{count}",
      shown: "Menampilkan {shown} dari {total}",
      compactShown: "{shown} dari {total}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "Model",
        processes: "Proses",
        eventLoop: "Responsivitas Gateway",
        monitor: "Monitor operasi",
        incidentLedger: "Riwayat insiden",
      },
      categories: {
        agent: "Agen",
        workflow: "Alur kerja",
      ...
      dispositions: {
        needs_user: "Membutuhkan Anda",
        handling: "OpenClaw sedang menangani",
        watching: "Mengawasi",
        historical: "Historis",
      },
    },
    footer: "Hanya pemantauan deterministik. Tidak ada panggilan model atau mutasi otomatis.",
  },
  tabs: {
    agents: "Agen",
    activity: "Aktivitas",
    overview: "Ikhtisar",
    operations: "Ruang Operasi",
    workboard: "Workboard",
    worktrees: "Worktree",
    channels: "Saluran",
    instances: "Instans",
  ...
  subtitles: {
    ...
    operations: "Agen, alur kerja, kemampuan, model, dan sumber daya dalam satu tampilan.",
  ...
  workboard: {
    ...
    dispatch: "Siapkan pekerjaan untuk dikirim",
    dispatchSummary:
  ...
  chat: {
    ...
    prepareVerifiedUpdate: "Siapkan pembaruan terverifikasi",
    preparingVerifiedUpdate: "Menyiapkan pembaruan terverifikasi…",
    installVerifiedUpdate: "Instal pembaruan terverifikasi",
    exactShaApprovalRequired: "Persetujuan SHA yang tepat diperlukan",
    updateProtectionIncomplete: "Perlindungan pembaruan memerlukan perhatian.",
