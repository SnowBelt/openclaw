...
export const uk: TranslationMap = {
  ...
  operationsRoom: {
    ...
    resolution: {
      resolve: "Вирішити",
      preview: "Переглянути рішення",
      resolveFor: "Вирішити {title}",
      previewOnly: "Тільки перегляд.",
      previewOnlyDetail: "Нічого не змінилося.",
      closePreview: "Закрити перегляд — не вносити змін",
    ...
    ownerAcceptance: {
      ...
      subtitle:
        "Таймер запускається лише після натискання кнопки «Розпочати». Прочитайте екран, оберіть відповіді, перегляньте пріоритетне рішення, а потім закрийте його без змін.",
      ...
      resolveQuestion:
        "Перегляньте рішення з найвищим пріоритетом, а потім закрийте його без змін.",
      resolvePending: "Ще не завершено",
      resolveDone: "Попередній перегляд відкрито та безпечно закрито",
