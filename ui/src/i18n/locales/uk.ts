...
export const uk: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "План управління OpenClaw",
    title: "Операційна кімната",
    subtitle: "Що потребує уваги, що працює та як функціонує система.",
    refresh: "Оновити",
    refreshing: "Оновлення…",
    refreshLabel: "Оновити операційну кімнату",
    updated: "Оновлено {time}",
    live: "Наживо",
    stale: "Відомі останні дані",
    partial: "Часткові дані",
    unavailableTitle: "Операційні дані недоступні",
    actionFailedTitle: "Дію не завершено",
    staleTitle: "Не вдалося оновити дані наживо",
    staleDetail: "Показується останній успішний знімок стану від {time}.",
    unavailableSources: "Недоступні джерела: {sources}.",
    fallbackSources: "Резервні джерела даних: {sources}.",
    loading: "Формування поточної картини операцій…",
    empty: "Знімок стану операцій ще недоступний.",
    now: "Зараз",
    briefingUnavailable: "Поточний огляд не підтверджено. Перегляньте статус окремих джерел нижче.",
    lastKnownBriefing: "Показати відомий останній огляд",
    briefingTone: {
      normal: "Актуальний",
    ...
    overallBriefingTone: {
      normal: "Загалом: Актуально",
      attention: "Загалом: Потребує уваги",
      urgent: "Загалом: Терміново",
      unknown: "Загалом: Статус невідомий",
    },
    overviewNav: "Огляд операцій",
    reviewCount: "Перевірити {count}",
    reviewUnconfirmed: "Перевірити —",
    decisionCount: "Потрібні рішення {count}",
    decisionsUnconfirmed: "Потрібні рішення —",
    workingCount: "Працює зараз {count}",
    workingCountBounded: "Працює зараз {count}+",
    workingUnconfirmed: "Працює зараз —",
    agentsWorkingNowCount: "Агентів працює зараз {count}",
    agentsWorkingUnconfirmed: "Агентів працює зараз —",
    openClawWorkCount: "Робота OpenClaw: {count}",
    openClawWorkUnconfirmed: "Робота OpenClaw —",
    allAgentsCount: "Усі агенти {count}",
    agentsUnconfirmed: "Усі агенти —",
    agentsCount: "{count} агентів",
    urgentCount: "{count} термінових",
    activeAgentsCount: "Активні агенти: {count}",
    workingItemsCount: "Активні завдання: {count}",
    showingAgents: "Показано {count}",
    attentionAgentsCount: "{count} потребують уваги",
    agentStatusSummary: "{working} працюють · {attention} потребують уваги",
    automationCount: "Розклади: {total} · Помилки: {failing}",
    automations: "Автоматизації",
    system: "Система",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "Потребує перевірки",
      title: "Увага",
      subtitle: "Спочатку поточні проблеми. Історичні події залишаються в розділі «Більше».",
      needsYou: "Потребує вашої участі",
      handling: "OpenClaw обробляє",
      watching: "Спостереження",
      none: "Нічого не потребує вашої уваги.",
      noCritical: "Немає активних критичних проблем.",
      currentCount: "{count} поточних",
      noneNeedsYou: "Жодне рішення чи втручання не чекає на вас.",
      noneHandling: "Немає активних заходів з усунення проблем.",
      noneWatching: "Нічого не перебуває під спостереженням.",
      impact: "Вплив",
      owner: "Власник",
      you: "Ви",
      unassignedOwner: "Не призначено",
      response: "Реакція",
      nextAction: "Наступна дія",
      nextActionShort: "Далі",
      highestPriority: "Проблема найвищого пріоритету",
      whoOwnsThis: "Хто відповідає за це",
      whatHappensNext: "Що далі",
      continueMonitoring: "Продовжити моніторинг.",
      observed: "Спостерігалося {time}",
      lastKnown: "Останнє відоме",
      unconfirmedTitle: "Статус уваги не підтверджено",
      unconfirmedDetail:
        "Відомі проблеми показано нижче, але неповні або останні відомі дані можуть не містити новіших проблем.",
      unconfirmedShort: "Потребує перевірки",
      showingCurrent:
        "Показано {shown} із {total} поточних проблем у цьому обмеженому знімку. Джерельні види надають пов’язані записи.",
      outsidePreview:
        "{count} поточних проблем знаходяться за межами цього попереднього перегляду. Відкрийте джерельний вид вище.",
      lastProgress: "Останній прогрес",
      nextCheck: "Наступна перевірка",
      remediationTask: "Завдання усунення",
      openRemediation: "Відкрити усунення",
      responseStates: {
        unassigned: "Не призначено",
        in_progress: "У процесі",
        monitoring: "Моніторинг",
        waiting_for_user: "Очікує на вас",
        resolved: "Вирішено",
      },
    },
    resolution: {
      resolve: "Вирішити",
      preview: "Рекомендоване рішення",
      recommendation: "Рекомендоване рішення",
      resolveFor: "Перегляньте рекомендоване рішення для {title}",
      previewOnly: "Тільки рекомендація.",
      previewOnlyDetail: "Нічого не змінюється, доки не буде затверджено відповідний ремонт.",
      closePreview: "Не зараз",
      notNow: "Не зараз",
      recommendedLabel: "Рекомендований виправлення:",
      recommendedFix: "Рекомендований виправлення",
      whyRecommended: "Чому це рекомендовано",
      defaultReason: "Це найбезпечніший наступний крок, підтриманий наявними доказами.",
      confidence: "Довіра",
      confidencePending: "Очікує локального розслідування",
      confidenceValue: "{confidence}% довіри",
      whatHappened: "Що сталося",
      progress: "Прогрес",
      risk: "Ризик проблеми",
      changePreview: "Що зміниться",
      verification: "Як OpenClaw це перевірить",
      verificationPending:
        "Перед запуском будь-яких автоматичних змін потрібен детермінований план верифікації.",
      approval: "Ваше схвалення",
      evidence: "Оновлення прогресу",
      localReview: "Локальний огляд ({confidence}%): {recommendation}",
      judgeReview: "Незалежний огляд безпеки: {decision} — {reason}",
      approved: "Затверджено",
      rejected: "Відхилено",
      rollback: "План відкату",
      undoAvailability: "Доступність скасування",
      undoAvailable: "Доступно через захищений перегляд",
      undoUnavailable: "Пряме скасування недоступне",
      viewRepairDetails: "Переглянути деталі виправлення",
      result: "Результат",
      undo: "Скасувати це виправлення",
      investigate: "Дослідити з локальним ШІ",
      reviewEscalation: "Переглянути з Codex",
      reviewCancellation: "Переглянути скасування",
      fixThis: "Виправити це для мене",
      investigationPreview:
        "Нічого ще не змінюється. Відкривається чернетка розслідування лише для читання, яку ви можете переглянути та надіслати.",
      cancelPreview: "Підготуйте захищений попередній перегляд для скасування «{title}».",
      approvalRequired: "Ви повинні затвердити будь-яку зміну, перш ніж вона відбудеться.",
      oneConfirmation:
        "Потрібне одне лаконічне підтвердження, оскільки це перевірений, зворотний ремонт середнього ризику.",
      automaticPolicy:
        "OpenClaw може автоматично запустити це затверджене виправлення, оскільки воно обмежене та зворотне.",
      evidenceLocation:
        "Прогрес та докази з'являться в цьому питанні, розділі «З моменту вашого останнього візиту» та на Workboard.",
      investigationRollback:
        "Поки не потрібен, оскільки розслідування не вносить змін. Будь-яка запропонована виправлення має містити план відкату.",
      cancelRollback:
        "Скасування не може відновити виконану роботу. Перегляньте точний попередній перегляд змін перед затвердженням.",
      progressLocationLabel: "Де відображається прогрес",
      safeguard:
        "Зміни високого ризику, незворотні, чутливі до безпеки, фінансові, пов’язані з обліковими даними, випуском, руйнівні, нові або невизначені все ще потребують вашого підтвердження.",
      draftNotice: "Відкриття чернетки не відправляє її і не запускає роботу.",
      nextStepUnknown:
        "Безпечний наступний крок не підтверджено. Дослідіть ситуацію, перш ніж щось змінювати.",
      stages: {
        needs_review: "Потребує перевірки",
        openclaw_handling: "OpenClaw обробляє це",
        watching: "OpenClaw спостерігає за цим",
        resolved: "Вирішено",
      },
      risks: {
        low: "Низька",
    ...
    working: {
      ...
      title: "Зараз працює",
      subtitle:
        "Тільки завдання та робочі процеси, керовані OpenClaw. Локальні процеси ШІ відображаються у розділі System.",
      none: "Зараз жоден агент OpenClaw не виконує активну роботу.",
      unconfirmed: "Поточну роботу не можна підтвердити, доки джерела її даних не відновляться.",
      unverified: "Поточна робота не перевірена",
      countsUnconfirmed: "Кількість не може бути підтверджена",
      itemsCount: "{count} активних елементів",
      itemsCountBounded: "Щонайменше {count} активних елементів",
      showingPreview:
        "Показано {shown} останніх зведень роботи. Дошка завдань містить записи про керовані завдання та робочі процеси.",
      openWorkboard: "Відкрити дошку завдань",
      details: "Деталі роботи",
      relatedRuns: "{count} пов’язаних запусків",
      workTotals: "Загальна кількість завдань і робочих процесів",
      tasks: "Завдання",
      taskTotals: "Активні: {active} · Потребують уваги: {failed} · Всього: {total}",
      workflows: "Робочі процеси",
      workflowTotals: "Активні: {active} · Всього: {total}",
    },
    activityComparison: {
      eyebrow: "Активність зараз",
      title: "Що працює",
      subtitle: "Два різні сигнали, показані разом.",
      openClawLabel: "Робота під керуванням OpenClaw",
      openClawCountOne: "1 агент працює",
      openClawCount: "{count} агентів працюють",
      openClawDetail: "Завдання та робочі процеси, якими OpenClaw активно керує.",
      localAiLabel: "Незалежний локальний ШІ",
      localAiCountOne: "1 процес моделі завантажено",
      localAiCount: "{count} процесів моделей завантажено",
      localAiDetail:
        "Моделі, завантажені на цьому Mac. Завантажений процес не обов’язково означає, що він зараз генерує дані.",
      unconfirmed: "Не підтверджено",
    },
    ownerAcceptance: {
      eyebrow: "Підтвердження власником",
      title: "60-секундна перевірка Operations Room",
      subtitle:
        "Таймер запускається лише після натискання кнопки Почати. Прочитайте екран, оберіть відповіді, перегляньте рекомендацію найвищого пріоритету, а потім оберіть Не зараз, не вносячи змін.",
      begin: "Розпочати 60-секундну перевірку",
      secondsLeft: "секунд залишилось",
      statusQuestion: "Який основний стан системи?",
      activityQuestion: "Що працює зараз?",
      activityAnswer: "OpenClaw: {openClaw} · Локальний ШІ: {localAi}",
      issueQuestion: "Хто відповідає за проблему найвищого пріоритету і що станеться далі?",
      issueAnswer: "{owner} — {next}",
      issueUnknown: "Власника або наступного кроку не визначено",
      resolveQuestion:
        "Перегляньте рекомендацію найвищого пріоритету, а потім виберіть «Не зараз».",
      resolvePending: "Ще не завершено",
      resolveDone: "Рекомендацію переглянуто та безпечно відкладено",
      finish: "Завершити та створити квитанцію",
      passed: "Перевірку власника пройдено",
      failed: "Перевірка власника не пройдена",
      elapsed: "Завершено за {seconds} секунд.",
      copyReceipt: "Копіювати квитанцію",
      copied: "Квитанцію скопійовано",
      copyFailed: "Копіювання недоступне. Натомість скористайтеся завантаженням квитанції.",
      downloadReceipt: "Завантажити квитанцію",
    },
    changes: {
      eyebrow: "Останні зміни",
      title: "З моменту вашого останнього візиту",
      none: "З моменту вашого останнього візиту суттєвих змін не було.",
      unconfirmed:
        "Останні зміни не можуть бути підтверджені, доки їхні джерела даних не відновляться.",
      firstVisit: "Останні суттєві зміни",
      incidentResolved: "Проблему вирішено",
      incidentChanged: "Проблему змінено",
      showingNewest:
        "Показано {count} найновіших змін. Відкрийте доступну історію для отримання додаткових деталей.",
      openActivity: "Відкрити доступну історію",
      activitySummaryOne: "1 пов'язаний запуск {runtime} {result}.",
      activitySummary: "{count} пов'язаних запусків {runtime} {result}.",
      outcomes: {
        working: "все ще виконується",
        succeeded: "завершено",
        blocked: "було заблоковано",
        failed: "не вдалося",
        cancelled: "було скасовано",
        unknown: "завершено з невідомим результатом",
      },
      remediationOutcomes: {
        completed: "OpenClaw виправив та підтвердив це питання",
        rolled_back: "OpenClaw автоматично скасував виправлення, яке не пройшло перевірку",
        failed: "Автоматичне виправлення зупинено і потребує огляду",
        approval_required: "OpenClaw зупинився та запросив схвалення",
      },
    },
    agents: {
      eyebrow: "Кімната в реальному часі",
      title: "Агенти",
      subtitle: "Спочатку операційний пріоритет. Готові агенти залишаються згорнутими.",
      searchLabel: "Пошук агентів",
      searchPlaceholder: "Пошук агентів",
      sortLabel: "Сортування агентів",
      sortPriority: "Пріоритет",
      sortName: "Назва",
      sortRecent: "Остання активність",
      noMatches: "Не знайдено агентів, що відповідають цьому пошуку.",
      noShownMatches:
        "Жоден із показаних агентів не відповідає. Спробуйте повний перегляд агентів.",
      searchResultCount: "Показано {count} відповідних агентів.",
      searchResultCountBounded:
        "Показано {count} відповідних агентів. Повний перегляд агентів може містити більше.",
      unconfirmed: "Дію агента не можна підтвердити, доки його джерело даних не відновиться.",
      unconfirmedShort: "Дія не перевірена",
      showing:
        "Показано {shown} із {total} агентів. Спочатку відображаються агенти з терміновими завданнями та активні.",
      openAll: "Відкрити всіх агентів",
      urgent: "Терміново",
      attention: "Потребує уваги",
      working: "Працює",
      waiting: "Очікує або заплановано",
      recent: "Нещодавно змінено",
      ready: "Готово",
      off: "Вимкнено або невідомо",
      pin: "Закріпити {name}",
      unpin: "Відкріпити {name}",
      pinned: "Закріплено",
      openAgent: "Відкрити агента",
      reviewIssue: "Переглянути проблему",
      whatNeedsAttention: "Що потребує уваги",
      blockedTaskNeedsDecision:
        "{count} заблоковане завдання потребує вашого рішення. Перегляньте проблему перед зміною агента.",
      blockedTasksNeedDecision:
        "{count} заблокованих завдань потребують вашого рішення. Перегляньте проблеми перед зміною агента.",
      urgentIssueNeedsDecision: "Термінова проблема потребує вашого рішення.",
      issueBeingHandled: "OpenClaw вирішує проблему для цього агента.",
      issueBeingWatched: "За проблемою цього агента спостерігають.",
      technicalDetails: "Технічні деталі",
      duty: "Посада",
      currentWork: "Поточна робота",
      lastActivity: "Остання активність",
      taskCounts: "Завдання",
      taskCountSummary: "Активні: {active} · Заблоковані: {blocked}",
      model: "Модель",
      fallback: "Резервний",
      heartbeat: "Серцебиття",
      ram: "ОЗУ",
      inheritedDefault: "Спадкове значення за замовчуванням",
      noFallback: "Немає явного резервного варіанта",
      readyForWork: "Готовий до роботи",
      noCurrentWork: "Немає",
      unavailableRam: "Неможливо визначити",
      browserLocalPins: "Закріплені елементи зберігаються в цьому браузері.",
    },
    systemHealth: {
      eyebrow: "Система",
      title: "Стан Mac",
      normal: "Норма",
      memory: "Ємність пам'яті",
      memoryInUse: "{percent}% під навантаженням",
      memoryAvailable: "{percent}% доступно",
      memorySummary: "{percent}% пам'яті",
      memoryAndLocalAiSummary: "{percent}% пам'яті · Процеси локального ШІ: {count}",
      ...
      responseDelay: "Затримка відповіді",
      ...
      memoryBreakdown: "{available} доступно · {free} вільно одразу · {total} всього",
      memoryPressureNote:
    ...
    automationsPanel: {
      ...
      title: "Запланована робота",
      none: "Заплановану роботу не налаштовано.",
      unconfirmed: "Заплановану роботу не можна підтвердити, доки джерело даних не відновиться.",
      openCron: "Відкрити завдання Cron",
      showing:
        "Показано {shown} з {total}. Відкрийте завдання Cron, щоб переглянути всю заплановану роботу.",
      dueNow: "Термін настав",
      noNextRun: "Наступного запуску немає",
      runNow: "Запустити зараз",
      pause: "Призупинити",
      enable: "Увімкнути",
    },
    more: {
      title: "Додаткові деталі операцій",
      subtitle: "Історія, робочі процеси, розклади, можливості, моделі та процеси хоста.",
      recentHistory: "Остання історія",
      workflows: "Робочі процеси",
      capabilities: "Навички, плагіни, інструменти та моделі",
      processes: "Процеси з найбільшим споживанням оперативної пам'яті",
      argumentsPrivate: "Аргументи ніколи не збираються.",
      processRowsRejectedOne: "1 рядок процесу не вдалося прочитати, і його виключено.",
      processRowsRejected: "{count} рядків процесів не вдалося прочитати, і їх виключено.",
      processesShowing: "Показано {shown} найбільших із {total} прийнятих процесів.",
      configuredActive: "Налаштовані та активні показуються окремо.",
      configured: "Налаштовано",
      notConfigured: "Не налаштовано",
      active: "Активний",
      inactive: "Неактивний",
      activityUnverified: "Активність не перевірена",
      catalogUnavailable:
        "Цей каталог не можна підтвердити, доки його джерело даних не відновиться.",
      catalogShowing: "Показано {shown} із {total}",
      shadowMode: "Режим тіні · без автоматичних змін",
      catalogued: "{count} каталогізовано",
      available: "{count} доступно",
      needsSetup: "{count} потребують налаштування",
      availabilityUnverified: "Доступність не перевірена",
      noHistory: "Немає записів недавньої історії.",
      noActivityHistory: "У цьому знімку не записано активності завдань.",
      activityHistoryUnavailable:
        "Активність завдань неможливо підтвердити на основі цього знімка.",
      activityHistory: "Активність завдань",
      activityCount: "Групи активності: {count}",
      incidentHistory: "Історія інцидентів",
      incidentCount: "Записи про інциденти: {count}",
      historyUnavailable: "Деталі інцидентів недоступні в цьому знімку.",
      changed: "Змінено {time}",
      transitionCount: "Переходи критичності: {count}",
      historyOverflow:
        "{count} старіших інцидентів знаходяться за межами збереженого вікна історії.",
      historySnapshotBounded: "Цей знімок містить {shown} із {total} записів про інциденти.",
      activitySnapshotBounded: "Покриття знімка: {shown} із {total} груп активності.",
      monitorIssue: "Фоновий монітор повідомив про проблему",
      monitorStatus: "Монітор: остання спроба {attempt}; останній успішний огляд {success}.",
      noWorkflows: "Не записано жодного керованого робочого процесу.",
      noProcesses: "Деталі ресурсів процесів недоступні.",
      processesUnavailable: "Інвентаризацію процесів неможливо підтвердити на основі цього знімка.",
      processesOmitted: "Інвентаризація процесів не була включена до цього знімка.",
      historySummary: "Історичні дані: {findings} · Записи про інциденти: {incidents}",
      workflowSummary: "Всього: {total} · Активних: {active}",
      ...
      noPlugins: "Плагінів не знайдено.",
    ...
    actions: {
      details: "Деталі",
      detailsFor: "Деталі для {title}",
      cancel: "Скасувати",
      cancelWork: "Скасувати {title}",
      cancelWorkflow: "Скасувати робочий процес",
      runSchedule: "Запустити {title} зараз",
      pauseSchedule: "Призупинити {title}",
      enableSchedule: "Увімкнути {title}",
      unavailable: "Керування недоступне, доки ці дані не стануть актуальними та повними.",
      cancelled: "Дію скасовано. Змін не внесено.",
      confirm: "{summary}\n\nРизик: {risk}\n\nЦя захищена дія діє до {expires}. Продовжити?",
      risks: {
        low: "Низька",
        medium: "Середня",
        high: "Висока",
    ...
    enums: {
      ...
      sources: {
        ...
        models: "Моделі",
        processes: "Процеси",
        eventLoop: "Швидкість реакції Gateway",
        monitor: "Монітор операцій",
        incidentLedger: "Історія інцидентів",
      },
      categories: {
        agent: "Агент",
      ...
      routes: {
        ...
        metered: "За вимірюванням",
        unknown: "Маршрут невідомий",
      },
      processKinds: {
        gateway: "Gateway",
      ...
      dispositions: {
        needs_user: "Потрібна ваша увага",
        handling: "OpenClaw обробляє",
        watching: "Спостереження",
        historical: "Історичний",
      },
    },
    footer: "Тільки детермінований моніторинг. Без викликів моделей або автоматичних змін.",
  },
  tabs: {
    agents: "Агенти",
    activity: "Активність",
  ...
  subtitles: {
    ...
    operations: "Агенти, робочі процеси, можливості, моделі та ресурси в одному огляді.",
  ...
  workboard: {
    ...
    dispatch: "Надіслати готову роботу",
    dispatchSummary:
