...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    musicStudio: "Створюйте за промптом, аранжуйте, відтворюйте й завершуйте оригінальну музику.",
