...
export const zh_TW: TranslationMap = {
  ...
  operationsRoom: {
    ...
    resolution: {
      ...
      resolveFor: "解決 {title}",
      previewOnly: "僅供預覽。",
      previewOnlyDetail: "未進行任何變更。",
      closePreview: "關閉預覽 — 不進行任何變更",
      whatHappened: "發生何事",
      progress: "進度",
      risk: "問題風險",
      changePreview: "變更內容",
    ...
    ownerAcceptance: {
      ...
      title: "60 秒運維室檢查",
      subtitle:
        "計時器僅在您點擊「開始」後啟動。請閱讀畫面、選擇答案、預覽最高優先級的解決方案，然後在不進行任何變更的情況下關閉它。",
      begin: "開始 60 秒檢查",
      secondsLeft: "剩餘秒數",
      ...
      resolveQuestion: "預覽最高優先級的解決方案，然後在不進行任何變更的情況下關閉它。",
      resolvePending: "尚未完成",
      resolveDone: "已開啟預覽並安全關閉",
      finish: "完成並建立收據",
      passed: "擁有者檢查通過",
      failed: "擁有者檢查未通過",
