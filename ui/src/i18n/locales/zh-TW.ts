...
export const zh_TW: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "OpenClaw 控制平面",
    title: "運維中心",
    subtitle: "需要關注的事項、正常運作的情況，以及系統整體狀態。",
    refresh: "重新整理",
    refreshing: "正在重新整理…",
    refreshLabel: "重新整理運維中心",
    updated: "已於 {time} 更新",
    live: "即時",
    stale: "上次已知狀態",
    partial: "部分資料",
    unavailableTitle: "無法取得運維資料",
    actionFailedTitle: "操作未完成",
    staleTitle: "即時更新失敗",
    staleDetail: "顯示來自 {time} 的最後一次成功快照。",
    unavailableSources: "無法使用的來源：{sources}。",
    fallbackSources: "備用資料來源：{sources}。",
    loading: "正在建立目前的運維概況…",
    empty: "目前尚無可用的運維快照。",
    now: "現在",
    briefingUnavailable: "無法確認目前的總覽狀態。請檢視下方的個別來源狀態。",
    lastKnownBriefing: "顯示上次已知的總覽",
    briefingTone: {
      normal: "最新狀態",
      attention: "需要關注",
      urgent: "緊急",
    ...
    overviewNav: "營運總覽",
    reviewCount: "檢視 {count}",
    reviewUnconfirmed: "檢視 —",
    decisionCount: "需要決策 {count}",
    decisionsUnconfirmed: "需要決策 —",
    workingCount: "正在運作 {count}",
    workingCountBounded: "正在運作 {count}+",
    workingUnconfirmed: "正在運作 —",
    agentsWorkingNowCount: "正在工作的代理 {count}",
    agentsWorkingUnconfirmed: "正在工作的代理 —",
    openClawWorkCount: "OpenClaw 工作 {count}",
    openClawWorkUnconfirmed: "OpenClaw 工作 —",
    allAgentsCount: "所有代理 {count}",
    agentsUnconfirmed: "所有代理 —",
    agentsCount: "{count} 個代理",
    urgentCount: "{count} 項緊急",
    activeAgentsCount: "活躍代理：{count}",
    workingItemsCount: "工作項目：{count}",
    showingAgents: "顯示 {count}",
    attentionAgentsCount: "{count} 需要關注",
    agentStatusSummary: "{working} 工作中 · {attention} 需要關注",
    automationCount: "排程：{total} · 失敗：{failing}",
    automations: "自動化",
    system: "系統",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "需要檢視",
      title: "注意",
      subtitle: "優先顯示目前問題。歷史事件保留在「更多」中。",
      needsYou: "需要您處理",
      handling: "OpenClaw 正在處理",
      watching: "監控中",
      none: "沒有需要您注意的事項。",
      noCritical: "目前沒有嚴重的問題。",
      currentCount: "{count} 個目前問題",
      noneNeedsYou: "沒有等待您決策或介入的事項。",
      noneHandling: "沒有正在進行中的修復作業。",
      noneWatching: "沒有正在監控的事項。",
      impact: "影響",
      owner: "負責人",
      you: "您",
      unassignedOwner: "未指派",
      ...
      nextAction: "下一步動作",
      nextActionShort: "下一步",
      highestPriority: "最高優先級問題",
      whoOwnsThis: "負責人",
      whatHappensNext: "後續步驟",
      continueMonitoring: "繼續監控。",
      observed: "{time} 觀察到",
      lastKnown: "最後已知狀態",
      unconfirmedTitle: "無法確認注意狀態",
      unconfirmedDetail: "已知問題如下所示，但不完整或最後已知的資料可能會遺漏較新的問題。",
      unconfirmedShort: "需要驗證",
      showingCurrent: "在此有限快照中顯示 {shown}/{total} 個目前問題。來源檢視提供相關記錄。",
      outsidePreview: "{count} 個目前問題位於此預覽之外。請開啟上方的來源檢視。",
      lastProgress: "最後進度",
      nextCheck: "下次檢查",
      remediationTask: "修復工作",
      openRemediation: "開啟修復",
      responseStates: {
        unassigned: "未指派",
        in_progress: "進行中",
        monitoring: "監控中",
        waiting_for_user: "等待您處理",
        resolved: "已解決",
      },
    },
    resolution: {
      resolve: "解決",
      preview: "建議解決方案",
      recommendation: "建議解決方案",
      resolveFor: "檢視 {title} 的建議解決方案",
      previewOnly: "僅供參考。",
      previewOnlyDetail: "在合格的修復方案獲得批准之前，不會進行任何變更。",
      closePreview: "現在不要",
      notNow: "現在不要",
      recommendedLabel: "建議修復：",
      recommendedFix: "建議修復",
      whyRecommended: "為何建議此項",
      defaultReason: "這是根據目前可用的證據，最安全的下一步。",
      confidence: "信心指數",
      confidencePending: "等待當地調查",
      confidenceValue: "{confidence}% 信心指數",
      whatHappened: "發生何事",
      progress: "進度",
      risk: "問題風險",
      changePreview: "變更內容",
      verification: "OpenClaw 將如何驗證",
      verificationPending: "在執行任何自動變更之前，需要一個確定性的驗證計畫。",
      approval: "您的核准",
      evidence: "進度更新",
      localReview: "本機審查 ({confidence}%): {recommendation}",
      judgeReview: "獨立安全審查：{decision} — {reason}",
      approved: "已核准",
      rejected: "已拒絕",
      rollback: "復原計畫",
      undoAvailability: "復原可用性",
      undoAvailable: "可透過受保護的預覽使用",
      undoUnavailable: "無法直接復原",
      viewRepairDetails: "查看修復詳細資訊",
      result: "結果",
      undo: "復原此修復",
      investigate: "使用本機 AI 調查",
      reviewEscalation: "由 Codex 審查",
      reviewCancellation: "檢視取消",
      fixThis: "幫我修復這個問題",
      investigationPreview: "目前尚無變更。系統將開啟一份唯讀的調查草稿，供您檢視並傳送。",
      cancelPreview: "準備受保護的預覽以取消「{title}」。",
      approvalRequired: "您必須在變更生效前核准任何變更。",
      oneConfirmation: "由於這是經過審查且可逆轉的中風險修復，因此需要一次簡潔的確認。",
      automaticPolicy: "由於此已核准的修復作業範圍有限且可逆，OpenClaw 可能會自動執行。",
      evidenceLocation: "進度與證明將顯示於此問題、「自您上次造訪以來」區段以及 Workboard。",
      investigationRollback:
        "目前尚不需要，因為調查不會進行任何變更。任何建議的修正措施都必須包含復原計畫。",
      cancelRollback: "取消操作無法還原已完成的工作。請在核准前仔細檢視變更預覽。",
      progressLocationLabel: "進度顯示位置",
      safeguard:
        "高風險、不可逆轉、涉及安全、財務、憑證、發布、破壞性、新穎或不確定的變更，仍需您確認。",
      draftNotice: "開啟草稿並不會發送或開始工作。",
      nextStepUnknown: "尚未確認安全的下一步。在進行任何變更前，請先調查。",
      stages: {
        needs_review: "需要檢視",
        openclaw_handling: "OpenClaw 正在處理中",
        watching: "OpenClaw 正在監控此項目",
        resolved: "已解決",
      },
      risks: {
        low: "低",
    ...
    working: {
      eyebrow: "進行中",
      title: "正在處理",
      subtitle: "僅限 OpenClaw 管理的任務和工作流程。本機 AI 程序顯示於「系統」下。",
      none: "目前沒有 OpenClaw 代理正在執行工作。",
      unconfirmed: "在資料來源恢復之前，無法確認目前的工作。",
      unverified: "目前工作未經驗證",
      countsUnconfirmed: "無法確認計數",
      itemsCount: "{count} 個進行中的項目",
      itemsCountBounded: "至少 {count} 個進行中的項目",
      showingPreview: "顯示 {shown} 筆最新的工作摘要。工作板包含受管理的任務和工作流程記錄。",
      openWorkboard: "開啟工作板",
      details: "工作詳細資訊",
      relatedRuns: "{count} 個相關執行",
      workTotals: "任務與工作流程總計",
      tasks: "任務",
      taskTotals: "活躍：{active} · 需要關注：{failed} · 總計：{total}",
      workflows: "工作流程",
      workflowTotals: "活躍：{active} · 總計：{total}",
    },
    activityComparison: {
      eyebrow: "目前活動",
      title: "正在執行的項目",
      subtitle: "兩種不同的訊號，合併顯示。",
      openClawLabel: "OpenClaw 管理的作業",
      openClawCountOne: "1 個工作代理程式",
      openClawCount: "{count} 個工作代理程式",
      openClawDetail: "OpenClaw 正在積極管理的工作與工作流程。",
      localAiLabel: "獨立本機 AI",
      localAiCountOne: "已載入 1 個模型程序",
      localAiCount: "已載入 {count} 個模型程序",
      localAiDetail: "在此 Mac 上載入的模型。已載入的程序不一定代表目前正在生成內容。",
      unconfirmed: "無法確認",
    },
    ownerAcceptance: {
      eyebrow: "擁有者核可",
      title: "60 秒運維室檢查",
      subtitle:
        "計時器僅在您點擊「開始」時啟動。請閱讀畫面內容、選擇答案、檢視最高優先級的建議，然後在不進行任何變更的情況下選擇「現在不要」。",
      begin: "開始 60 秒檢查",
      secondsLeft: "剩餘秒數",
      statusQuestion: "主要系統狀態為何？",
      activityQuestion: "目前正在執行什麼？",
      activityAnswer: "OpenClaw: {openClaw} · 本機 AI: {localAi}",
      issueQuestion: "誰負責最高優先級的問題，下一步是什麼？",
      issueAnswer: "{owner} — {next}",
      issueUnknown: "未知負責人或下一步驟",
      resolveQuestion: "檢視最高優先順序的建議，然後選擇「現在不要」。",
      resolvePending: "尚未完成",
      resolveDone: "已檢視建議並安全延後",
      finish: "完成並建立收據",
      passed: "擁有者檢查通過",
      failed: "擁有者檢查未通過",
      elapsed: "於 {seconds} 秒內完成。",
      copyReceipt: "複製收據",
      copied: "已複製收據",
      copyFailed: "無法複製。請改用「下載收據」。",
    ...
    changes: {
      ...
      title: "自您上次造訪以來",
      none: "自您上次造訪以來沒有重大變更。",
      unconfirmed: "在資料來源恢復之前，無法確認近期的變更。",
      firstVisit: "近期重大變更",
      incidentResolved: "問題已解決",
      incidentChanged: "問題已變更",
      showingNewest: "顯示最新的 {count} 筆變更。開啟可用的歷史記錄以查看詳細資訊。",
      openActivity: "開啟可用歷史記錄",
      activitySummaryOne: "1 個相關的 {runtime} 執行 {result}。",
      activitySummary: "{count} 個相關的 {runtime} 執行結果為 {result}。",
      outcomes: {
        working: "仍在運作中",
        succeeded: "已完成",
        blocked: "已遭封鎖",
      ...
      remediationOutcomes: {
        completed: "OpenClaw 已修復並驗證此問題",
        rolled_back: "OpenClaw 自動復原了未通過驗證的修復",
        failed: "自動修復已停止，需要檢視",
        approval_required: "OpenClaw 已停止並請求核准",
      },
    },
    agents: {
      eyebrow: "即時室",
      title: "代理程式",
      subtitle: "以作業優先順序為主。就緒的代理程式會保持摺疊狀態。",
      searchLabel: "搜尋代理程式",
      searchPlaceholder: "搜尋代理程式",
      sortLabel: "排序代理程式",
      sortPriority: "優先順序",
      sortName: "名稱",
      sortRecent: "最近活動",
      noMatches: "沒有符合此搜尋條件的代理程式。",
      noShownMatches: "顯示的代理程式中沒有符合者。請在完整的「代理程式」視圖中搜尋。",
      searchResultCount: "顯示 {count} 個符合的代理程式。",
      searchResultCountBounded:
        "顯示 {count} 個符合的代理程式。完整的「代理程式」視圖可能包含更多項目。",
      unconfirmed: "在資料來源恢復之前，無法確認代理程式的活動狀態。",
      unconfirmedShort: "活動未驗證",
      showing: "顯示 {shown} / {total} 個代理。緊急與活躍的代理會優先顯示。",
      openAll: "開啟所有代理",
      urgent: "緊急",
      attention: "需要關注",
      working: "工作中",
      ...
      openAgent: "開啟代理",
      reviewIssue: "檢視問題",
      whatNeedsAttention: "需要關注的事項",
      blockedTaskNeedsDecision: "{count} 個受阻任務需要您的決策。在切換代理之前，請先檢視該問題。",
      blockedTasksNeedDecision:
        "{count} 個受阻任務需要您的決策。在切換代理之前，請先檢視這些問題。",
      urgentIssueNeedsDecision: "有一個緊急問題需要您的決策。",
      issueBeingHandled: "OpenClaw 正在處理此代理的問題。",
      issueBeingWatched: "此代理的問題正在被監控中。",
      technicalDetails: "技術詳細資訊",
      duty: "值班",
      currentWork: "目前工作",
      lastActivity: "最後活動",
      taskCounts: "任務",
      taskCountSummary: "活躍：{active} · 受阻：{blocked}",
      model: "模型",
      fallback: "備援",
      heartbeat: "心跳",
      ram: "RAM",
      inheritedDefault: "繼承預設值",
      noFallback: "無明確後援",
      readyForWork: "準備就緒",
      noCurrentWork: "無",
      unavailableRam: "無法歸因",
      browserLocalPins: "釘選項目已儲存於此瀏覽器。",
    },
    systemHealth: {
      eyebrow: "系統",
      title: "Mac 健康狀態",
      normal: "正常",
      memory: "記憶體容量",
      memoryInUse: "{percent}% 處於高負載狀態",
      memoryAvailable: "{percent}% 可用",
      memorySummary: "{percent}% 記憶體",
      memoryAndLocalAiSummary: "{percent}% 記憶體 · 本機 AI 程序：{count}",
      ...
      unavailable: "不可用",
      memoryBreakdown: "{available} 可用 · {free} 立即釋放 · {total} 總計",
      memoryPressureNote:
    ...
    automationsPanel: {
      ...
      title: "排程工作",
      none: "未設定任何排程工作。",
      unconfirmed: "在資料來源恢復之前，無法確認排程工作。",
      openCron: "開啟 Cron Jobs",
      showing: "顯示 {shown} / {total}。開啟 Cron Jobs 以檢視所有排程工作。",
      dueNow: "即將到期",
      noNextRun: "無下次執行時間",
      runNow: "立即執行",
      pause: "暫停",
    ...
    more: {
      title: "更多操作詳細資訊",
      subtitle: "歷史記錄、工作流程、排程、功能、模型與主機程序。",
      recentHistory: "近期歷史記錄",
      workflows: "工作流程",
      capabilities: "Skills、外掛程式、工具與模型",
      processes: "RAM 用量最高的程序",
      argumentsPrivate: "不會收集參數。",
      processRowsRejectedOne: "無法讀取 1 個程序列，已排除。",
      processRowsRejected: "無法讀取 {count} 個程序列，已排除。",
      processesShowing: "顯示 {total} 個已接受程序中最大的 {shown} 個。",
      configuredActive: "已設定與使用中會分別顯示。",
      configured: "已設定",
      notConfigured: "未設定",
      active: "進行中",
      inactive: "非使用中",
      activityUnverified: "活動狀態未驗證",
      catalogUnavailable: "在資料來源恢復之前，無法確認此目錄。",
      catalogShowing: "顯示 {total} 個中的 {shown} 個",
      shadowMode: "陰影模式 · 不會自動變更",
      catalogued: "{count} 個已編目",
      available: "{count} 個可用",
      needsSetup: "{count} 個需要設定",
      availabilityUnverified: "可用性未驗證",
      noHistory: "未記錄近期歷史。",
      noActivityHistory: "此快照中未記錄任何工作活動。",
      activityHistoryUnavailable: "無法從此快照確認工作活動。",
      activityHistory: "工作活動",
      activityCount: "活動群組：{count}",
      incidentHistory: "事件歷史",
      incidentCount: "事件記錄：{count}",
      historyUnavailable: "此快照中無法取得事件詳細資訊。",
      changed: "{time} 變更",
      transitionCount: "嚴重度轉換次數：{count}",
      historyOverflow: "{count} 筆較舊的事件已超出保留的歷史記錄範圍。",
      historySnapshotBounded: "此快照包含 {total} 筆事件記錄中的 {shown} 筆。",
      activitySnapshotBounded: "快照涵蓋範圍：{total} 個活動群組中的 {shown} 個。",
      monitorIssue: "背景監控回報有問題",
      monitorStatus: "監控狀態：上次嘗試時間為 {attempt}；上次成功掃描時間為 {success}。",
      noWorkflows: "未記錄任何受管的工作流程。",
      noProcesses: "無法取得程序資源詳細資訊。",
      processesUnavailable: "無法從此快照確認程序清單。",
      processesOmitted: "此快照未包含程序清單。",
      historySummary: "歷史發現：{findings} · 事件記錄：{incidents}",
      workflowSummary: "總計 {total} · 活躍 {active}",
      showing: "顯示 {shown}",
      skills: "Skills",
      plugins: "Plugins",
      tools: "工具",
    ...
    actions: {
      details: "詳細資訊",
      detailsFor: "{title} 的詳細資訊",
      cancel: "取消",
      cancelWork: "取消 {title}",
      cancelWorkflow: "取消工作流程",
      runSchedule: "立即執行 {title}",
      pauseSchedule: "暫停 {title}",
      enableSchedule: "啟用 {title}",
      unavailable: "在資料新鮮且完整之前，控制項無法使用。",
      cancelled: "動作已取消。未進行任何變更。",
      confirm: "{summary}\n\n風險：{risk}\n\n此受保護的動作將於 {expires} 過期。是否繼續？",
      risks: {
        low: "低",
        medium: "中",
        high: "高",
    ...
    counts: {
      exact: "{count}",
      shown: "顯示 {shown} / {total}",
      compactShown: "{shown} / {total}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "模型",
        processes: "程序",
        eventLoop: "Gateway 回應能力",
        monitor: "作業監控器",
        incidentLedger: "事件歷史記錄",
      },
      categories: {
        agent: "代理程式",
        workflow: "工作流程",
  ...
  chat: {
    ...
    updating: "正在更新…",
    updateNow: "立即更新",
    prepareVerifiedUpdate: "準備已驗證的更新",
    preparingVerifiedUpdate: "正在準備已驗證的更新…",
    installVerifiedUpdate: "安裝已驗證的更新",
    exactShaApprovalRequired: "需要核准確切的 SHA",
    updateProtectionIncomplete: "更新保護需要處理。",
    ...
    modelPicker: {
      ...
      unavailable: "無法使用 —— 請選擇其他模型",
      contentionWarning: "正被另一個活躍代理使用——可能會變慢",
    },
    pairingQrExpired: {
      title: "配對 QR 碼已過期",
