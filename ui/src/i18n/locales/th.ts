...
export const th: TranslationMap = {
  ...
  operationsRoom: {
    ...
    subtitle: "สิ่งที่ต้องการความสนใจ สิ่งที่กำลังทำงานอยู่ และสถานะของระบบ",
    refresh: "รีเฟรช",
    refreshing: "กำลังรีเฟรช…",
    refreshLabel: "รีเฟรช Operations Room",
    updated: "อัปเดตเมื่อ {time}",
    live: "สด",
    stale: "ข้อมูลล่าสุดที่ทราบ",
    partial: "ข้อมูลบางส่วน",
    unavailableTitle: "ไม่พบข้อมูลการดำเนินงาน",
    actionFailedTitle: "ดำเนินการไม่สำเร็จ",
    staleTitle: "อัปเดตแบบสดล้มเหลว",
    staleDetail: "แสดงสแนปช็อตล่าสุดที่สำเร็จจาก {time}",
    unavailableSources: "แหล่งข้อมูลที่ไม่พร้อมใช้งาน: {sources}",
    fallbackSources: "แหล่งข้อมูลสำรอง: {sources}",
    loading: "กำลังสร้างภาพรวมการดำเนินงานปัจจุบัน…",
    empty: "ยังไม่มีสแนปช็อตการดำเนินงานที่พร้อมใช้งาน",
    now: "ตอนนี้",
    briefingUnavailable: "ไม่สามารถยืนยันภาพรวมปัจจุบันได้ โปรดตรวจสอบสถานะเฉพาะแหล่งข้อมูลด้านล่าง",
    lastKnownBriefing: "แสดงภาพรวมล่าสุดที่ทราบ",
    briefingTone: {
      normal: "อัปเดตล่าสุดแล้ว",
      attention: "ต้องการการดูแล",
      urgent: "เร่งด่วน",
      unknown: "ไม่ทราบสถานะ",
    },
    overallBriefingTone: {
      normal: "ภาพรวม: เป็นปัจจุบัน",
      attention: "ภาพรวม: ต้องการความสนใจ",
      urgent: "ภาพรวม: ด่วน",
      unknown: "ภาพรวม: สถานะไม่ทราบ",
    },
    overviewNav: "ภาพรวมการดำเนินงาน",
    reviewCount: "ตรวจสอบ {count}",
    reviewUnconfirmed: "ตรวจสอบ —",
    decisionCount: "ต้องการการตัดสินใจ {count}",
    decisionsUnconfirmed: "ต้องการการตัดสินใจ —",
    workingCount: "กำลังทำงาน {count}",
    workingCountBounded: "กำลังทำงาน {count}+",
    workingUnconfirmed: "กำลังทำงาน —",
    agentsWorkingNowCount: "เอเจนต์กำลังทำงานอยู่ {count}",
    agentsWorkingUnconfirmed: "เอเจนต์กำลังทำงานอยู่ —",
    openClawWorkCount: "งาน OpenClaw {count}",
    openClawWorkUnconfirmed: "งาน OpenClaw —",
    allAgentsCount: "เอเจนต์ทั้งหมด {count}",
    agentsUnconfirmed: "เอเจนต์ทั้งหมด —",
    agentsCount: "{count} เอเจนต์",
    urgentCount: "{count} เร่งด่วน",
    activeAgentsCount: "เอเจนต์ที่ใช้งานอยู่: {count}",
    workingItemsCount: "รายการที่กำลังดำเนินการ: {count}",
    showingAgents: "แสดง {count}",
    attentionAgentsCount: "{count} ต้องการการดูแล",
    agentStatusSummary: "{working} กำลังทำงาน · {attention} ต้องการความสนใจ",
    automationCount: "กำหนดเวลา: {total} · ล้มเหลว: {failing}",
    ...
    attention: {
      eyebrow: "ต้องตรวจสอบ",
      title: "ข้อควรระวัง",
      subtitle: "แสดงปัญหาปัจจุบันก่อน เหตุการณ์ในอดีตจะอยู่ในส่วนเพิ่มเติม",
      needsYou: "ต้องการความช่วยเหลือจากคุณ",
      handling: "OpenClaw กำลังดำเนินการ",
      watching: "กำลังเฝ้าระวัง",
      none: "ไม่มีอะไรที่ต้องให้ความสนใจของคุณ",
      noCritical: "ไม่พบปัญหาวิกฤตที่กำลังเกิดขึ้น",
      currentCount: "{count} รายการปัจจุบัน",
      noneNeedsYou: "ไม่มีคำตัดสินหรือการแทรกแซงใดรอคุณอยู่",
      noneHandling: "ไม่มีการแก้ไขที่ดำเนินการอยู่",
      noneWatching: "ไม่มีอะไรที่กำลังเฝ้าระวัง",
      impact: "ผลกระทบ",
      owner: "เจ้าของ",
      you: "คุณ",
      unassignedOwner: "ยังไม่กำหนด",
      response: "การตอบสนอง",
      nextAction: "ขั้นตอนถัดไป",
      nextActionShort: "ถัดไป",
      highestPriority: "ปัญหาที่มีความสำคัญสูงสุด",
      whoOwnsThis: "ใครเป็นเจ้าของสิ่งนี้",
      whatHappensNext: "ขั้นตอนถัดไปคืออะไร",
      continueMonitoring: "ดำเนินการเฝ้าระวังต่อไป",
      observed: "พบเมื่อ {time}",
      lastKnown: "ทราบล่าสุด",
      unconfirmedTitle: "ไม่สามารถยืนยันสถานะข้อควรระวังได้",
      unconfirmedDetail: "ปัญหาที่ทราบจะแสดงด้านล่าง แต่ข้อมูลที่ไม่สมบูรณ์หรือข้อมูลล่าสุดอาจละเว้นปัญหาใหม่กว่า",
      unconfirmedShort: "ต้องการการตรวจสอบ",
      showingCurrent: "กำลังแสดง {shown} จาก {total} ปัญหาปัจจุบันในภาพรวมนี้ แหล่งข้อมูลให้บันทึกที่เกี่ยวข้อง",
      outsidePreview: "ปัญหาปัจจุบัน {count} รายการอยู่นอกตัวอย่างนี้ เปิดมุมมองแหล่งข้อมูลด้านบน",
      lastProgress: "ความคืบหน้าล่าสุด",
      nextCheck: "การตรวจสอบครั้งถัดไป",
      remediationTask: "งานแก้ไข",
      openRemediation: "เปิดการแก้ไข",
      responseStates: {
        unassigned: "ยังไม่กำหนด",
        in_progress: "กำลังดำเนินการ",
        monitoring: "กำลังตรวจสอบ",
        waiting_for_user: "รอคุณอยู่",
        resolved: "แก้ไขแล้ว",
      },
    },
    resolution: {
      resolve: "แก้ไขแล้ว",
      preview: "วิธีแก้ไขที่แนะนำ",
      recommendation: "วิธีแก้ไขที่แนะนำ",
      resolveFor: "ตรวจสอบวิธีแก้ไขที่แนะนำสำหรับ {title}",
      previewOnly: "เป็นเพียงคำแนะนำเท่านั้น",
      previewOnlyDetail: "จะไม่มีการเปลี่ยนแปลงใดๆ จนกว่าการซ่อมแซมที่มีสิทธิ์จะได้รับการอนุมัติ",
      closePreview: "ไม่ใช่ตอนนี้",
      notNow: "ไม่ใช่ตอนนี้",
      recommendedLabel: "วิธีแก้ไขที่แนะนำ:",
      recommendedFix: "วิธีแก้ไขที่แนะนำ",
      whyRecommended: "เหตุผลที่แนะนำวิธีนี้",
      defaultReason: "นี่คือขั้นตอนถัดไปที่มีความปลอดภัยที่สุด ซึ่งได้รับการสนับสนุนจากหลักฐานที่มีอยู่ในปัจจุบัน",
      confidence: "ระดับความมั่นใจ",
      confidencePending: "รอการตรวจสอบภายในระบบ",
      confidenceValue: "มีความมั่นใจ {confidence}%",
      whatHappened: "เกิดอะไรขึ้น",
      progress: "ความคืบหน้า",
      risk: "ความเสี่ยงของปัญหา",
      changePreview: "สิ่งที่เปลี่ยนแปลง",
      verification: "วิธีที่ OpenClaw จะทำการตรวจสอบ",
      verificationPending:
        "จำเป็นต้องมีแผนการตรวจสอบแบบกำหนดได้ก่อนที่การเปลี่ยนแปลงอัตโนมัติใดๆ จะสามารถดำเนินการได้",
      approval: "การอนุมัติของคุณ",
      evidence: "อัปเดตความคืบหน้า",
      localReview: "การตรวจสอบภายใน ({confidence}%): {recommendation}",
      judgeReview: "การตรวจสอบความปลอดภัยโดยอิสระ: {decision} — {reason}",
      approved: "อนุมัติแล้ว",
      rejected: "ปฏิเสธแล้ว",
      rollback: "แผนการย้อนกลับ",
      undoAvailability: "ความพร้อมใช้งานของการยกเลิก",
      undoAvailable: "พร้อมใช้งานผ่านการดูตัวอย่างที่มีการป้องกัน",
      undoUnavailable: "ไม่มีการยกเลิกโดยตรงที่พร้อมใช้งาน",
      viewRepairDetails: "ดูรายละเอียดการซ่อมแซม",
      result: "ผลลัพธ์",
      undo: "ยกเลิกการซ่อมแซมนี้",
      investigate: "ตรวจสอบด้วย AI ในเครื่อง",
      reviewEscalation: "ตรวจสอบกับ Codex",
      reviewCancellation: "ตรวจสอบการยกเลิก",
      fixThis: "แก้ไขให้ฉัน",
      investigationPreview:
        "ยังไม่มีอะไรเปลี่ยนแปลง ร่างการสอบสวนแบบอ่านอย่างเดียวจะเปิดขึ้นเพื่อให้คุณตรวจสอบและส่ง",
      cancelPreview: 'เตรียมการดูตัวอย่างแบบป้องกันเพื่อยกเลิก "{title}"',
      approvalRequired: "คุณต้องอนุมัติการเปลี่ยนแปลงใดๆ ก่อนที่จะเกิดขึ้น",
      oneConfirmation:
        "จำเป็นต้องมีการยืนยันอย่างกระชับเพียงครั้งเดียว เนื่องจากนี่เป็นการซ่อมแซมที่มีความเสี่ยงปานกลาง ซึ่งได้รับการตรวจสอบแล้วและสามารถย้อนกลับได้",
      automaticPolicy:
        "OpenClaw อาจดำเนินการซ่อมแซมที่อนุมัตินี้โดยอัตโนมัติ เนื่องจากมีขอบเขตจำกัดและสามารถย้อนกลับได้",
      evidenceLocation: "ความคืบหน้าและหลักฐานจะปรากฏในปัญหานี้ ส่วน“ตั้งแต่คุณเข้าใช้ครั้งล่าสุด” และ Workboard",
      investigationRollback:
        "ยังไม่จำเป็น เนื่องจากขั้นตอนการตรวจสอบไม่มีการเปลี่ยนแปลงใดๆ แผนแก้ไขที่เสนอต้องรวมแผนการย้อนกลับไว้ด้วย",
      cancelRollback:
        "การยกเลิกไม่สามารถกู้คืนงานที่เสร็จสมบูรณ์ได้ โปรดตรวจสอบตัวอย่างการเปลี่ยนแปลงอย่างละเอียดก่อนอนุมัติ",
      progressLocationLabel: "ตำแหน่งที่แสดงความคืบหน้า",
      safeguard:
        "การเปลี่ยนแปลงที่มีความเสี่ยงสูง ไม่สามารถย้อนกลับได้ เกี่ยวข้องกับความปลอดภัย การเงิน ข้อมูลประจำตัว การเผยแพร่ ทำลายล้าง เป็นสิ่งใหม่ หรือมีความไม่แน่นอน ยังคงต้องการการยืนยันจากคุณ",
      draftNotice: "การเปิดร่างจะไม่ส่งหรือเริ่มทำงาน",
      nextStepUnknown: "ยังไม่มีการยืนยันขั้นตอนถัดไปที่ปลอดภัย โปรดตรวจสอบก่อนทำการเปลี่ยนแปลงใดๆ",
      stages: {
        needs_review: "ต้องตรวจสอบ",
        openclaw_handling: "OpenClaw กำลังดำเนินการอยู่",
        watching: "OpenClaw กำลังเฝ้าดูสิ่งนี้",
        resolved: "แก้ไขแล้ว",
      },
      risks: {
        low: "ต่ำ",
    ...
    working: {
      ...
      subtitle: "เฉพาะงานและเวิร์กโฟลว์ที่จัดการโดย OpenClaw กระบวนการ AI ในเครื่องจะปรากฏภายใต้ระบบ",
      none: "ไม่มีเอเจนต์ของ OpenClaw ทำงานอยู่ขณะนี้",
      unconfirmed: "ไม่สามารถยืนยันงานปัจจุบันได้จนกว่าแหล่งข้อมูลจะกู้คืน",
      unverified: "งานปัจจุบันยังไม่ได้รับการตรวจสอบ",
      countsUnconfirmed: "ไม่สามารถยืนยันจำนวนได้",
      itemsCount: "รายการที่ทำงานอยู่ {count}",
      itemsCountBounded: "รายการที่ทำงานอยู่อย่างน้อย {count}",
      showingPreview: "แสดงสรุปงานล่าสุด {shown} รายการ Workboard มีบันทึกงานและเวิร์กโฟลว์ที่จัดการแล้ว",
      openWorkboard: "เปิด Workboard",
      details: "รายละเอียดงาน",
      relatedRuns: "การรันที่เกี่ยวข้อง {count}",
      workTotals: "รวมงานและเวิร์กโฟลว์",
      tasks: "งาน",
      taskTotals: "ใช้งานอยู่: {active} · ต้องการความสนใจ: {failed} · รวม: {total}",
      workflows: "เวิร์กโฟลว์",
      workflowTotals: "ใช้งานอยู่: {active} · รวม: {total}",
    },
    activityComparison: {
      eyebrow: "กิจกรรมปัจจุบัน",
      title: "สิ่งที่กำลังทำงานอยู่",
      subtitle: "สัญญาณสองแบบที่แตกต่างกัน แสดงร่วมกัน",
      openClawLabel: "งานที่ OpenClaw จัดการ",
      openClawCountOne: "เอเจนต์ที่กำลังทำงาน 1 ตัว",
      openClawCount: "เอเจนต์ที่กำลังทำงาน {count} ตัว",
      openClawDetail: "งานและเวิร์กโฟลว์ที่ OpenClaw กำลังจัดการอยู่อย่างแข็งขัน",
      localAiLabel: "AI ท้องถิ่นแบบอิสระ",
      localAiCountOne: "โหลดกระบวนการโมเดลแล้ว 1 กระบวนการ",
      localAiCount: "โหลดกระบวนการโมเดลแล้ว {count} กระบวนการ",
      localAiDetail:
        "โมเดลที่โหลดบน Mac เครื่องนี้ การโหลดกระบวนการไม่ได้หมายความว่ากำลังสร้างผลลัพธ์ในขณะนี้เสมอไป",
      unconfirmed: "ไม่สามารถยืนยันได้",
    },
    ownerAcceptance: {
      eyebrow: "การยอมรับจากผู้ดูแลระบบ",
      title: "การตรวจสอบ Operations Room แบบ 60 วินาที",
      subtitle:
        "ตัวจับเวลาจะเริ่มทำงานเมื่อคุณคลิกเริ่มเท่านั้น อ่านหน้าจอ เลือกคำตอบ ตรวจสอบคำแนะนำที่มีลำดับความสำคัญสูงสุด จากนั้นเลือกไม่ใช่ตอนนี้ โดยไม่ทำการเปลี่ยนแปลงใดๆ",
      begin: "เริ่มการตรวจสอบ 60 วินาที",
      secondsLeft: "วินาทีที่เหลือ",
      statusQuestion: "สถานะระบบหลักมีเพียงหนึ่งเดียวคืออะไร?",
      activityQuestion: "อะไรกำลังทำงานอยู่ในขณะนี้?",
      activityAnswer: "OpenClaw: {openClaw} · AI ท้องถิ่น: {localAi}",
      issueQuestion: "ใครเป็นเจ้าของปัญหาที่มีความสำคัญสูงสุด และขั้นตอนต่อไปคืออะไร?",
      issueAnswer: "{owner} — {next}",
      issueUnknown: "ไม่ทราบเจ้าของหรือขั้นตอนต่อไป",
      resolveQuestion: 'ตรวจสอบคำแนะนำที่มีความสำคัญสูงสุด จากนั้นเลือก "ยังไม่ตอนนี้"',
      resolvePending: "ยังไม่เสร็จสมบูรณ์",
      resolveDone: "ตรวจสอบคำแนะนำแล้วและเลื่อนออกไปอย่างปลอดภัย",
      finish: "เสร็จสิ้นและสร้างใบเสร็จรับเงิน",
      passed: "การตรวจสอบเจ้าของผ่าน",
      failed: "การตรวจสอบเจ้าของไม่ผ่าน",
      elapsed: "เสร็จสิ้นใน {seconds} วินาที",
      copyReceipt: "คัดลอกใบเสร็จรับเงิน",
      copied: "คัดลอกใบเสร็จรับเงินแล้ว",
      copyFailed: "ไม่สามารถคัดลอกได้ กรุณาใช้ ดาวน์โหลดใบเสร็จรับเงิน แทน",
      downloadReceipt: "ดาวน์โหลดใบเสร็จรับเงิน",
    },
    changes: {
      eyebrow: "การเปลี่ยนแปลงล่าสุด",
      title: "ตั้งแต่คุณเข้าใช้ครั้งล่าสุด",
      none: "ไม่มีการเปลี่ยนแปลงที่สำคัญตั้งแต่คุณเข้าใช้ครั้งล่าสุด",
      unconfirmed: "ไม่สามารถยืนยันการเปลี่ยนแปลงล่าสุดได้จนกว่าแหล่งข้อมูลจะกู้คืน",
      firstVisit: "การเปลี่ยนแปลงที่สำคัญล่าสุด",
      incidentResolved: "ปัญหาได้รับการแก้ไขแล้ว",
      incidentChanged: "ปัญหาเปลี่ยนไป",
      showingNewest: "แสดงการเปลี่ยนแปลงใหม่ล่าสุด {count} รายการ เปิดประวัติที่มีอยู่เพื่อดูรายละเอียดเพิ่มเติม",
      openActivity: "เปิดประวัติที่มีอยู่",
      activitySummaryOne: "การรัน {runtime} ที่เกี่ยวข้อง 1 รายการ {result}.",
      activitySummary: "การรัน {runtime} ที่เกี่ยวข้อง {count} รายการ {result}.",
      outcomes: {
        working: "กำลังดำเนินการอยู่",
        succeeded: "เสร็จสมบูรณ์",
        blocked: "ถูกบล็อก",
        failed: "ล้มเหลว",
        cancelled: "ถูกยกเลิก",
        unknown: "สิ้นสุดด้วยผลลัพธ์ที่ไม่ทราบ",
      },
      remediationOutcomes: {
        completed: "OpenClaw ซ่อมแซมและตรวจสอบปัญหานี้แล้ว",
        rolled_back: "OpenClaw ย้อนกลับการซ่อมแซมที่ไม่ผ่านการตรวจสอบโดยอัตโนมัติ",
        failed: "การซ่อมแซมอัตโนมัติหยุดทำงานและต้องได้รับการตรวจสอบ",
        approval_required: "OpenClaw หยุดทำงานและขอการอนุมัติ",
      },
    },
    agents: {
      eyebrow: "ห้องปฏิบัติการสด",
      title: "เอเจนต์",
      subtitle: "ลำดับความสำคัญในการดำเนินงานเป็นอันดับแรก เอเจนต์ที่พร้อมใช้งานจะอยู่ในสถานะยุบ",
      searchLabel: "ค้นหาเอเจนต์",
      searchPlaceholder: "ค้นหาเอเจนต์",
      sortLabel: "เรียงลำดับเอเจนต์",
      sortPriority: "ลำดับความสำคัญ",
      sortName: "ชื่อ",
      sortRecent: "กิจกรรมล่าสุด",
      noMatches: "ไม่มีเอเจนต์ที่ตรงกับผลการค้นหา",
      noShownMatches: "ไม่มีเอเจนต์ที่แสดงอยู่ตรงกัน ค้นหาในมุมมองเอเจนต์ทั้งหมด",
      searchResultCount: "แสดงเอเจนต์ที่ตรงกัน {count} รายการ.",
      searchResultCountBounded: "แสดงเอเจนต์ที่ตรงกัน {count} รายการ มุมมองเอเจนต์ทั้งหมดอาจมีมากกว่านี้",
      unconfirmed: "ไม่สามารถยืนยันกิจกรรมของเอเจนต์ได้จนกว่าแหล่งข้อมูลจะกลับมาทำงานปกติ",
      unconfirmedShort: "ยังไม่มีการตรวจสอบกิจกรรม",
      showing: "แสดง {shown} จาก {total} เอเจนต์ เอเจนต์ที่เร่งด่วนและกำลังทำงานจะปรากฏก่อน",
      openAll: "เปิดเอเจนต์ทั้งหมด",
      urgent: "เร่งด่วน",
      attention: "ต้องการความสนใจ",
      working: "กำลังทำงาน",
      waiting: "กำลังรอหรือกำหนดเวลาไว้",
      recent: "มีการเปลี่ยนแปลงเมื่อไม่นานนี้",
      ready: "พร้อม",
      off: "ปิดหรือไม่ทราบสถานะ",
      pin: "ปักหมุด {name}",
      unpin: "ยกเลิกการปักหมุด {name}",
      pinned: "ปักหมุดแล้ว",
      openAgent: "เปิดเอเจนต์",
      reviewIssue: "ตรวจสอบปัญหา",
      whatNeedsAttention: "สิ่งที่ต้องการความสนใจ",
      blockedTaskNeedsDecision:
        "งานที่ติดขัด {count} รายการ ต้องการการตัดสินใจของคุณ โปรดตรวจสอบปัญหาก่อนเปลี่ยนเอเจนต์",
      blockedTasksNeedDecision:
        "งานที่ติดขัด {count} รายการ ต้องการการตัดสินใจของคุณ โปรดตรวจสอบปัญหาก่อนเปลี่ยนเอเจนต์",
      urgentIssueNeedsDecision: "มีปัญหาด่วนที่ต้องการการตัดสินใจของคุณ",
      issueBeingHandled: "OpenClaw กำลังจัดการปัญหาสำหรับเอเจนต์นี้",
      issueBeingWatched: "กำลังติดตามปัญหาสำหรับเอเจนต์นี้",
      technicalDetails: "รายละเอียดทางเทคนิค",
      duty: "หน้าที่",
      currentWork: "งานปัจจุบัน",
      lastActivity: "กิจกรรมล่าสุด",
      taskCounts: "งาน",
      taskCountSummary: "กำลังทำงาน: {active} · ถูกบล็อก: {blocked}",
      model: "โมเดล",
      fallback: "สำรอง",
      heartbeat: "Heartbeat",
      ram: "RAM",
      inheritedDefault: "ค่าเริ่มต้นที่สืบทอดมา",
      noFallback: "ไม่มีค่าสำรองที่ระบุชัดเจน",
      readyForWork: "พร้อมทำงาน",
      noCurrentWork: "ไม่มี",
      unavailableRam: "ไม่สามารถระบุได้",
      browserLocalPins: "Pin จะถูกบันทึกในเบราว์เซอร์นี้",
    },
    systemHealth: {
      eyebrow: "ระบบ",
      title: "สถานะสุขภาพของ Mac",
      normal: "ปกติ",
      memory: "ความจุหน่วยความจำ",
      memoryInUse: "{percent}% อยู่ภายใต้แรงกดดัน",
      memoryAvailable: "มีพื้นที่ว่าง {percent}%",
      memorySummary: "หน่วยความจำ {percent}%",
      memoryAndLocalAiSummary: "หน่วยความจำ {percent}% · กระบวนการ AI ในเครื่อง: {count}",
      ...
      cpu: "CPU",
      load: "โหลด {value}",
      responseDelay: "ความล่าช้าในการตอบสนอง",
      ...
      memoryBreakdown: "{available} พร้อมใช้งาน · {free} ว่างทันที · {total} ทั้งหมด",
      memoryPressureNote:
    ...
    automationsPanel: {
      eyebrow: "การทำงานอัตโนมัติ",
      title: "งานที่จัดกำหนดการ",
      none: "ไม่ได้กำหนดงานที่จัดกำหนดการไว้",
      unconfirmed: "ไม่สามารถยืนยันงานที่จัดกำหนดการได้จนกว่าแหล่งข้อมูลจะกลับมาทำงานปกติ",
      openCron: "เปิด Cron Jobs",
      showing: "แสดง {shown} จาก {total} เปิด Cron Jobs เพื่อดูงานที่จัดกำหนดการทั้งหมด",
      dueNow: "ถึงกำหนดแล้ว",
      noNextRun: "ไม่มีรอบถัดไป",
      runNow: "ทำงานเลย",
      pause: "หยุดชั่วคราว",
      enable: "เปิดใช้งาน",
    },
    more: {
      title: "รายละเอียดการดำเนินการเพิ่มเติม",
      subtitle: "ประวัติ, การทำงานแบบเวิร์กโฟลว์, กำหนดการ, ความสามารถ, โมเดล และกระบวนการโฮสต์",
      recentHistory: "ประวัติล่าสุด",
      workflows: "เวิร์กโฟลว์",
      capabilities: "Skills, plugins, tools, and models",
      processes: "กระบวนการที่ใช้ RAM มากที่สุด",
      argumentsPrivate: "ไม่มีการเก็บรวบรวมอาร์กิวเมนต์",
      processRowsRejectedOne: "ไม่สามารถอ่านแถวกระบวนการได้ 1 แถว และถูกตัดออก",
      processRowsRejected: "ไม่สามารถอ่านแถวกระบวนการได้ {count} แถว และถูกตัดออก",
      processesShowing: "แสดง {shown} จาก {total} กระบวนการที่ยอมรับแล้วซึ่งใช้ RAM มากที่สุด",
      configuredActive: "แสดงค่าที่กำหนดค่าและใช้งานอยู่แยกกัน",
      configured: "กำหนดค่าแล้ว",
      notConfigured: "ไม่ได้กำหนดค่า",
      active: "ใช้งานอยู่",
      inactive: "ไม่ใช้งาน",
      activityUnverified: "กิจกรรมยังไม่ได้รับการยืนยัน",
      catalogUnavailable: "ไม่สามารถยืนยันแคตตาล็อกนี้จนกว่าแหล่งข้อมูลจะกู้คืนได้",
      catalogShowing: "แสดง {shown} จาก {total}",
      shadowMode: "โหมดเงา · ไม่มีการเปลี่ยนแปลงอัตโนมัติ",
      catalogued: "{count} รายการในแคตตาล็อก",
      available: "{count} พร้อมใช้งาน",
      needsSetup: "{count} ต้องการการตั้งค่า",
      availabilityUnverified: "ความพร้อมใช้งานยังไม่ได้รับการยืนยัน",
      noHistory: "ไม่มีการบันทึกประวัติล่าสุด",
      noActivityHistory: "ไม่มีการบันทึกกิจกรรมงานในสแนปช็อตนี้",
      activityHistoryUnavailable: "ไม่สามารถยืนยันกิจกรรมงานจากสแนปช็อตนี้ได้",
      activityHistory: "กิจกรรมงาน",
      activityCount: "กลุ่มกิจกรรม: {count}",
      incidentHistory: "ประวัติเหตุการณ์",
      incidentCount: "บันทึกเหตุการณ์: {count}",
      historyUnavailable: "รายละเอียดเหตุการณ์ไม่พร้อมใช้งานในสแนปช็อตนี้",
      changed: "เปลี่ยนแปลงเมื่อ {time}",
      transitionCount: "การเปลี่ยนระดับความรุนแรง: {count}",
      historyOverflow: "เหตุการณ์เก่า {count} รายการอยู่นอกหน้าต่างประวัติที่เก็บรักษาไว้",
      historySnapshotBounded: "สแนปช็อตนี้รวมบันทึกเหตุการณ์ {shown} จากทั้งหมด {total} รายการ",
      activitySnapshotBounded: "ขอบเขตของสแนปช็อต: กลุ่มกิจกรรม {shown} จากทั้งหมด {total} กลุ่ม",
      monitorIssue: "ตัวตรวจสอบพื้นหลังรายงานปัญหา",
      monitorStatus: "ตัวตรวจสอบ: พยายามล่าสุดเมื่อ {attempt}; การกวาดตรวจสำเร็จล่าสุดเมื่อ {success}",
      noWorkflows: "ไม่มีการบันทึกเวิร์กโฟลว์ที่จัดการ",
      noProcesses: "รายละเอียดทรัพยากรกระบวนการไม่พร้อมใช้งาน",
      processesUnavailable: "ไม่สามารถยืนยันรายการกระบวนการจากสแนปช็อตนี้ได้",
      processesOmitted: "รายการกระบวนการไม่ได้รวมอยู่ในสแนปช็อตนี้",
      historySummary: "ผลการค้นหาทางประวัติศาสตร์: {findings} · บันทึกเหตุการณ์: {incidents}",
      workflowSummary: "ทั้งหมด {total} · กำลังใช้งาน {active}",
      showing: "แสดง {shown}",
      skills: "Skills",
      plugins: "ปลั๊กอิน",
      tools: "เครื่องมือ",
      models: "โมเดล",
      noSkills: "ไม่พบ Skills",
      noPlugins: "ไม่พบปลั๊กอิน",
    ...
    actions: {
      details: "รายละเอียด",
      detailsFor: "รายละเอียดของ {title}",
      cancel: "ยกเลิก",
      cancelWork: "ยกเลิก {title}",
      cancelWorkflow: "ยกเลิก workflow",
      runSchedule: "เรียกใช้ {title} ตอนนี้",
      pauseSchedule: "หยุดชั่วคราว {title}",
      enableSchedule: "เปิดใช้งาน {title}",
      unavailable: "การควบคุมไม่สามารถใช้งานได้จนกว่าข้อมูลนี้จะสดใหม่และสมบูรณ์",
      cancelled: "ยกเลิกการดำเนินการแล้ว ไม่มีการเปลี่ยนแปลงใดๆ",
      confirm:
        "{summary}\n\nความเสี่ยง: {risk}\n\nการดำเนินการที่มีการป้องกันนี้หมดอายุใน {expires} ดำเนินการต่อหรือไม่?",
      risks: {
        low: "ต่ำ",
        medium: "ปานกลาง",
        high: "สูง",
    ...
    enums: {
      ...
      sources: {
        ...
        models: "โมเดล",
        processes: "กระบวนการ",
        eventLoop: "ความตอบสนองของ Gateway",
        monitor: "ตัวตรวจสอบการดำเนินงาน",
        incidentLedger: "ประวัติเหตุการณ์",
      },
      categories: {
        agent: "Agent",
      ...
      routes: {
        ...
        metered: "คิดตามการใช้งาน",
        unknown: "ไม่ทราบเส้นทาง",
      },
      processKinds: {
        gateway: "Gateway",
        local_model: "โมเดลภายใน",
        browser: "เบราว์เซอร์",
        other: "อื่นๆ",
      },
      dispositions: {
        needs_user: "ต้องการความช่วยเหลือจากคุณ",
        handling: "OpenClaw กำลังดำเนินการ",
        watching: "กำลังเฝ้าดู",
        historical: "ประวัติ",
      },
    },
    footer: "การตรวจสอบแบบกำหนดได้เท่านั้น ไม่มีการเรียกใช้โมเดลหรือการเปลี่ยนแปลงอัตโนมัติ",
  },
  tabs: {
    agents: "เอเจนต์",
    activity: "กิจกรรม",
  ...
  subtitles: {
    ...
    operations: "ดูเอเจนต์ เวิร์กโฟลว์ ความสามารถ โมเดล และทรัพยากรได้ในภาพรวม",
  ...
  workboard: {
    ...
    dispatch: "ส่งต่องานที่พร้อมดำเนินการ",
    dispatchSummary:
  ...
  chat: {
    ...
    modelPicker: {
      ...
      unavailable: "ไม่พร้อมใช้งาน — เลือกโมเดลอื่น",
      contentionWarning: "กำลังถูกใช้โดยเอเจนต์ที่ใช้งานอยู่อีกราย — อาจช้าลง",
    },
    pairingQrExpired: {
