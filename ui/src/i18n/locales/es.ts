...
export const es: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "Plano de control de OpenClaw",
    title: "Sala de operaciones",
    subtitle: "Lo que requiere atención, lo que funciona y el estado del sistema.",
    refresh: "Actualizar",
    refreshing: "Actualizando…",
    refreshLabel: "Actualizar sala de operaciones",
    updated: "Actualizado {time}",
    live: "En vivo",
    stale: "Último conocido",
    partial: "Datos parciales",
    unavailableTitle: "Datos de operaciones no disponibles",
    actionFailedTitle: "Acción no completada",
    staleTitle: "Error en la actualización en vivo",
    staleDetail: "Mostrando la última instantánea exitosa de {time}.",
    unavailableSources: "Fuentes no disponibles: {sources}.",
    fallbackSources: "Fuentes de datos alternativas: {sources}.",
    loading: "Generando el panorama actual de operaciones…",
    empty: "Aún no hay ninguna instantánea de operaciones disponible.",
    now: "Ahora",
    briefingUnavailable:
      "No se puede confirmar la vista general actual. Revisa el estado específico de cada fuente a continuación.",
    lastKnownBriefing: "Mostrar última vista general conocida",
    briefingTone: {
      normal: "Actualizado",
    ...
    overallBriefingTone: {
      normal: "General: Al día",
      attention: "General: Requiere atención",
      urgent: "General: Urgente",
      unknown: "General: Estado desconocido",
    },
    overviewNav: "Vista general de operaciones",
    reviewCount: "Revisar {count}",
    reviewUnconfirmed: "Revisar —",
    decisionCount: "Decisiones necesarias {count}",
    decisionsUnconfirmed: "Decisiones necesarias —",
    workingCount: "Trabajando ahora {count}",
    workingCountBounded: "Trabajando ahora {count}+",
    workingUnconfirmed: "Trabajando ahora —",
    agentsWorkingNowCount: "Agentes trabajando ahora {count}",
    agentsWorkingUnconfirmed: "Agentes trabajando ahora —",
    openClawWorkCount: "{count} trabajos de OpenClaw",
    openClawWorkUnconfirmed: "Trabajo de OpenClaw —",
    allAgentsCount: "Todos los agentes {count}",
    agentsUnconfirmed: "Todos los agentes —",
    agentsCount: "{count} agentes",
    urgentCount: "{count} urgentes",
    activeAgentsCount: "Agentes activos: {count}",
    ...
    attention: {
      ...
      title: "Atención",
      subtitle: "Los problemas actuales primero. Los eventos históricos permanecen en Más.",
      needsYou: "Te necesita",
      handling: "OpenClaw está gestionando",
      watching: "Vigilando",
      none: "Nada requiere tu atención.",
      noCritical: "No hay ningún problema crítico activo.",
      currentCount: "{count} actuales",
      noneNeedsYou: "No hay ninguna decisión o intervención esperándote.",
      noneHandling: "No hay ninguna remediación activa en curso.",
      noneWatching: "Nada está siendo vigilado.",
      impact: "Impacto",
      owner: "Propietario",
      you: "Tú",
      unassignedOwner: "No asignado",
      response: "Respuesta",
      nextAction: "Siguiente acción",
      nextActionShort: "Siguiente",
      highestPriority: "Problema de mayor prioridad",
      whoOwnsThis: "Quién es el responsable",
      whatHappensNext: "Qué sucede a continuación",
      continueMonitoring: "Continuar monitoreando.",
      observed: "Observado {time}",
      lastKnown: "Último conocido",
      unconfirmedTitle: "No se puede confirmar el estado de atención",
      unconfirmedDetail:
        "Los problemas conocidos se muestran a continuación, pero los datos incompletos o de última conocida pueden omitir problemas más recientes.",
      unconfirmedShort: "Necesita verificación",
      showingCurrent:
        "Mostrando {shown} de {total} problemas actuales en esta instantánea acotada. Las vistas de origen proporcionan registros relacionados.",
      outsidePreview:
        "{count} problemas actuales están fuera de esta vista previa. Abre una vista de origen arriba.",
      lastProgress: "Último progreso",
      nextCheck: "Próxima comprobación",
      remediationTask: "Tarea de remediación",
      openRemediation: "Abrir remediación",
      responseStates: {
        unassigned: "No asignado",
        in_progress: "En curso",
        monitoring: "Monitoreo",
        waiting_for_user: "Esperando por ti",
        resolved: "Resuelto",
      },
    },
    resolution: {
      resolve: "Resolver",
      preview: "Resolución recomendada",
      recommendation: "Resolución recomendada",
      resolveFor: "Revisar la resolución recomendada para {title}",
      previewOnly: "Solo recomendación.",
      previewOnlyDetail: "No se realizan cambios hasta que se apruebe una reparación elegible.",
      closePreview: "Ahora no",
      notNow: "Ahora no",
      recommendedLabel: "Solución recomendada:",
      recommendedFix: "Solución recomendada",
      whyRecommended: "Por qué se recomienda esto",
      defaultReason:
        "Este es el siguiente paso más seguro respaldado por la evidencia disponible actualmente.",
      confidence: "Confianza",
      confidencePending: "Pendiente de investigación local",
      confidenceValue: "{confidence}% de confianza",
      whatHappened: "Qué sucedió",
      progress: "Progreso",
      risk: "Riesgo del problema",
      changePreview: "Qué cambiará",
      verification: "Cómo OpenClaw lo verificará",
      verificationPending:
        "Se requiere un plan de verificación determinista antes de que se pueda ejecutar cualquier cambio automático.",
      approval: "Tu aprobación",
      evidence: "Actualizaciones de progreso",
      localReview: "Revisión local ({confidence}%): {recommendation}",
      judgeReview: "Revisión de seguridad independiente: {decision} — {reason}",
      approved: "Aprobado",
      rejected: "Rechazado",
      rollback: "Plan de reversión",
      undoAvailability: "Disponibilidad de reversión",
      undoAvailable: "Disponible mediante una vista previa protegida",
      undoUnavailable: "No hay ninguna opción de reversión directa disponible",
      viewRepairDetails: "Ver detalles de la reparación",
      result: "Resultado",
      undo: "Deshacer esta reparación",
      investigate: "Investigar con IA local",
      reviewEscalation: "Revisar con Codex",
      reviewCancellation: "Revisar cancelación",
      fixThis: "Arreglar esto por mí",
      investigationPreview:
        "Nada cambia aún. Se abre un borrador de investigación de solo lectura para que lo revises y envíes.",
      cancelPreview: "Prepara una vista previa protegida para cancelar «{title}».",
      approvalRequired: "Debes aprobar cualquier cambio antes de que se produzca.",
      oneConfirmation:
        "Se requiere una confirmación concisa porque esta es una reparación de riesgo medio revisada y reversible.",
      automaticPolicy:
        "OpenClaw puede ejecutar esta reparación aprobada automáticamente porque está acotada y es reversible.",
      evidenceLocation:
        'El progreso y la prueba aparecerán en este problema, la sección "Desde tu última visita" y Workboard.',
      investigationRollback:
        "No es necesario aún porque la investigación no realiza cambios. Cualquier solución propuesta debe incluir un Plan de reversión.",
      cancelRollback:
        "La cancelación no puede restaurar el trabajo completado. Revise la vista previa exacta del cambio antes de aprobarlo.",
      progressLocationLabel: "Dónde aparece el progreso",
      safeguard:
        "Los cambios de alto riesgo, irreversibles, sensibles a la seguridad, financieros, de credenciales, de lanzamiento, destructivos, novedosos o inciertos siguen requiriendo tu confirmación.",
      draftNotice: "Abrir el borrador no lo envía ni inicia el trabajo.",
      nextStepUnknown:
        "No se ha confirmado ningún siguiente paso seguro. Investiga antes de cambiar nada.",
      stages: {
        needs_review: "Requiere revisión",
        openclaw_handling: "OpenClaw está gestionando esto",
        watching: "OpenClaw está observando esto",
        resolved: "Resuelto",
      },
      risks: {
        low: "Baja",
    ...
    working: {
      ...
      subtitle:
        "Solo tareas y flujos de trabajo gestionados por OpenClaw. Los procesos de IA locales aparecen en Sistema.",
      none: "Ningún agente de OpenClaw está trabajando activamente en este momento.",
      unconfirmed:
        "El trabajo actual no se puede confirmar hasta que sus fuentes de datos se recuperen.",
      unverified: "Trabajo actual no verificado",
      countsUnconfirmed: "No se pueden confirmar los recuentos",
      itemsCount: "{count} elementos en funcionamiento",
      itemsCountBounded: "Al menos {count} elementos en funcionamiento",
      showingPreview:
        "Mostrando {shown} resúmenes de trabajo recientes. El Workboard contiene registros de tareas y flujos de trabajo gestionados.",
      openWorkboard: "Abrir Workboard",
      details: "Detalles del trabajo",
      relatedRuns: "{count} ejecuciones relacionadas",
      workTotals: "Totales de tareas y flujos de trabajo",
      tasks: "Tareas",
      taskTotals: "Activas: {active} · Necesitan atención: {failed} · Total: {total}",
      workflows: "Flujos de trabajo",
      workflowTotals: "Activos: {active} · Total: {total}",
    },
    activityComparison: {
      eyebrow: "Actividad actual",
      title: "Qué se está ejecutando",
      subtitle: "Dos señales diferentes, mostradas juntas.",
      openClawLabel: "Trabajo gestionado por OpenClaw",
      openClawCountOne: "1 agente trabajando",
      openClawCount: "{count} agentes trabajando",
      openClawDetail: "Tareas y flujos de trabajo que OpenClaw está gestionando activamente.",
      localAiLabel: "IA local independiente",
      localAiCountOne: "1 proceso de modelo cargado",
      localAiCount: "{count} procesos de modelo cargados",
      localAiDetail:
        "Modelos cargados en este Mac. Un proceso cargado no significa necesariamente que esté generando en este momento.",
      unconfirmed: "No se puede confirmar",
    },
    ownerAcceptance: {
      eyebrow: "Aceptación del propietario",
      title: "Comprobación de Operations Room de 60 segundos",
      subtitle:
        "El temporizador comienza solo cuando haces clic en Comenzar. Lee la pantalla, elige las respuestas, revisa la recomendación de mayor prioridad y luego elige Ahora no sin realizar ningún cambio.",
      begin: "Iniciar comprobación de 60 segundos",
      secondsLeft: "segundos restantes",
      statusQuestion: "¿Cuál es el estado principal del sistema?",
      activityQuestion: "¿Qué se está ejecutando ahora mismo?",
      activityAnswer: "OpenClaw: {openClaw} · IA local: {localAi}",
      issueQuestion:
        "¿Quién es el responsable del problema de mayor prioridad y qué ocurre a continuación?",
      issueAnswer: "{owner} — {next}",
      issueUnknown: "No se conoce ningún responsable ni paso siguiente",
      resolveQuestion: "Revisa la recomendación de mayor prioridad y luego selecciona No ahora.",
      resolvePending: "Aún no completado",
      resolveDone: "Recomendación revisada y pospuesta de forma segura",
      finish: "Finalizar y crear comprobante",
      passed: "Comprobación del propietario superada",
      failed: "Comprobación del propietario no superada",
      elapsed: "Completado en {seconds} segundos.",
      copyReceipt: "Copiar comprobante",
      copied: "Comprobante copiado",
      copyFailed: "La copia no estaba disponible. Usa Descargar comprobante en su lugar.",
      downloadReceipt: "Descargar comprobante",
    },
    changes: {
      eyebrow: "Cambios recientes",
      title: "Desde tu última visita",
      none: "No hay cambios significativos desde tu última visita.",
      unconfirmed:
        "Los cambios recientes no se pueden confirmar hasta que sus fuentes de datos se recuperen.",
      firstVisit: "Cambios significativos recientes",
      incidentResolved: "Incidente resuelto",
      incidentChanged: "Incidente modificado",
      showingNewest:
        "Mostrando los {count} cambios más recientes. Abre el historial disponible para más detalles.",
      openActivity: "Abrir historial disponible",
      activitySummaryOne: "1 ejecución de {runtime} relacionada con el resultado {result}.",
      activitySummary: "{count} ejecuciones de {runtime} relacionadas con el resultado {result}.",
      outcomes: {
        working: "sigue en proceso",
        succeeded: "completada",
        blocked: "bloqueada",
        failed: "fallida",
        cancelled: "cancelada",
        unknown: "finalizada con un resultado desconocido",
      },
      remediationOutcomes: {
        completed: "OpenClaw reparó y verificó este problema",
        rolled_back: "OpenClaw deshizo automáticamente una reparación que no se verificó",
        failed: "La reparación automática se detuvo y necesita revisión",
        approval_required: "OpenClaw se detuvo y solicitó aprobación",
      },
    },
    agents: {
      eyebrow: "Sala en vivo",
      title: "Agentes",
      subtitle: "Prioridad operativa primero. Los agentes listos permanecen colapsados.",
      ...
      noMatches: "Ningún agente coincide con esta búsqueda.",
      noShownMatches: "Ningún agente mostrado coincide. Busca en la vista completa de Agentes.",
      searchResultCount: "{count} agentes coincidentes mostrados.",
      searchResultCountBounded:
        "{count} agentes coincidentes mostrados. La vista completa de Agentes puede incluir más.",
      unconfirmed:
        "No se puede confirmar la actividad del agente hasta que su fuente de datos se recupere.",
      unconfirmedShort: "Actividad no verificada",
      showing:
        "Mostrando {shown} de {total} agentes. Los agentes urgentes y activos aparecen primero.",
      openAll: "Abrir todos los agentes",
      urgent: "Urgente",
      attention: "Requiere atención",
      working: "Trabajando",
      waiting: "En espera o programado",
      recent: "Cambiados recientemente",
      ready: "Listas",
      off: "Desactivado o desconocido",
      pin: "Fijar {name}",
      unpin: "Desfijar {name}",
      pinned: "Fijadas",
      ...
      blockedTasksNeedDecision:
        "{count} tareas bloqueadas necesitan tu decisión. Revisa los problemas antes de cambiar al agente.",
      urgentIssueNeedsDecision: "Un problema urgente necesita tu decisión.",
      issueBeingHandled: "OpenClaw está gestionando un problema para este agente.",
      issueBeingWatched: "Se está supervisando un problema de este agente.",
      technicalDetails: "Detalles técnicos",
      duty: "Deberes",
      currentWork: "Trabajo actual",
      lastActivity: "Última actividad",
      taskCounts: "Tareas",
      taskCountSummary: "Activas: {active} · Bloqueadas: {blocked}",
      model: "Modelo",
      fallback: "Respaldo",
      heartbeat: "Latido",
      ram: "RAM",
      inheritedDefault: "Predeterminado heredado",
      noFallback: "Sin respaldo explícito",
      readyForWork: "Listo para trabajar",
      noCurrentWork: "Ninguno",
      unavailableRam: "No atribuible",
      browserLocalPins: "Los marcadores se guardan en este navegador.",
    },
    systemHealth: {
      eyebrow: "Sistema",
      title: "Estado del Mac",
      normal: "Normal",
      memory: "Capacidad de memoria",
      memoryInUse: "{percent}% bajo presión",
      memoryAvailable: "{percent}% disponible",
      memorySummary: "{percent}% de memoria",
      memoryAndLocalAiSummary: "{percent}% de memoria · Procesos de IA local: {count}",
      ...
      technicalDetails: "Detalles técnicos",
      gatewayRam: "RAM de Gateway",
      host: "Host",
      logicalCores: "Núcleos lógicos de CPU",
      unavailable: "No disponible",
      memoryBreakdown: "{available} disponible · {free} libre inmediatamente · {total} total",
      memoryPressureNote:
    ...
    automationsPanel: {
      ...
      none: "No hay trabajo programado configurado.",
      unconfirmed:
        "El trabajo programado no se puede confirmar hasta que su origen de datos se recupere.",
      openCron: "Abrir trabajos Cron",
      showing:
        "Mostrando {shown} de {total}. Abra los trabajos Cron para revisar todo el trabajo programado.",
      dueNow: "Vence ahora",
    ...
    more: {
      title: "Más detalles de operaciones",
      subtitle:
        "Historial, flujos de trabajo, programaciones, capacidades, modelos y procesos del host.",
      recentHistory: "Historial reciente",
      workflows: "Flujos de trabajo",
      capabilities: "Skills, complementos, herramientas y modelos",
      processes: "Procesos que más RAM consumen",
      argumentsPrivate: "Los argumentos nunca se recopilan.",
      processRowsRejectedOne: "No se pudo leer 1 fila de proceso y se excluyó.",
      processRowsRejected: "No se pudieron leer {count} filas de procesos y se excluyeron.",
      processesShowing: "Se muestran los {shown} más grandes de {total} procesos aceptados.",
      configuredActive: "Configurado y activo se muestran por separado.",
      configured: "Configurado",
      notConfigured: "No configurado",
      active: "Activo",
      inactive: "Inactivo",
      activityUnverified: "Actividad no verificada",
      catalogUnavailable:
        "Este catálogo no se puede confirmar hasta que su fuente de datos se recupere.",
      catalogShowing: "Se muestran {shown} de {total}",
      shadowMode: "Modo sombra · sin cambios automáticos",
      catalogued: "{count} catalogados",
      available: "{count} disponibles",
      needsSetup: "{count} necesitan configuración",
      availabilityUnverified: "Disponibilidad no verificada",
      noHistory: "No se ha registrado historial reciente.",
      noActivityHistory: "No se registra actividad de tareas en esta instantánea.",
      activityHistoryUnavailable:
        "No se puede confirmar la actividad de tareas a partir de esta instantánea.",
      activityHistory: "Actividad de tareas",
      activityCount: "Grupos de actividad: {count}",
      incidentHistory: "Historial de incidentes",
      incidentCount: "Registros de incidentes: {count}",
      historyUnavailable: "Los detalles del incidente no están disponibles en esta instantánea.",
      changed: "Cambiado {time}",
      transitionCount: "Transiciones de gravedad: {count}",
      historyOverflow:
        "{count} incidentes anteriores están fuera del período de retención del historial.",
      historySnapshotBounded:
        "Esta instantánea incluye {shown} de {total} registros de incidentes.",
      activitySnapshotBounded:
        "Cobertura de la instantánea: {shown} de {total} grupos de actividad.",
      monitorIssue: "El monitor en segundo plano informó un problema",
      monitorStatus: "Monitor: último intento {attempt}; última exploración exitosa {success}.",
      noWorkflows: "No se registran flujos de trabajo gestionados.",
      noProcesses: "Los detalles del recurso de proceso no están disponibles.",
      processesUnavailable:
        "No se puede confirmar el inventario de procesos a partir de esta instantánea.",
      processesOmitted: "El inventario de procesos no se incluyó en esta instantánea.",
      historySummary: "Hallazgos históricos: {findings} · Registros de incidentes: {incidents}",
      workflowSummary: "{total} total · {active} activos",
      showing: "mostrando {shown}",
      skills: "Skills",
      plugins: "Plugins",
      tools: "Herramientas",
      models: "Modelos",
      noSkills: "No se han detectado skills.",
      noPlugins: "No se han detectado plugins.",
      noTools: "No se han detectado herramientas.",
      noModels: "No se han detectado modelos.",
    ...
    actions: {
      details: "Detalles",
      detailsFor: "Detalles de {title}",
      cancel: "Cancelar",
      cancelWork: "Cancelar {title}",
      cancelWorkflow: "Cancelar flujo de trabajo",
      runSchedule: "Ejecutar {title} ahora",
      pauseSchedule: "Pausar {title}",
      enableSchedule: "Habilitar {title}",
      unavailable:
        "Los controles no están disponibles hasta que estos datos estén actualizados y completos.",
      cancelled: "Acción cancelada. No se han realizado cambios.",
      confirm: "{summary}\n\nRiesgo: {risk}\n\nEsta acción protegida expira {expires}. ¿Continuar?",
      risks: {
        low: "Baja",
        medium: "Media",
        high: "Alta",
    ...
    enums: {
      ...
      sources: {
        ...
        models: "Modelos",
        processes: "Procesos",
        eventLoop: "Capacidad de respuesta del Gateway",
        monitor: "Monitor de operaciones",
        incidentLedger: "Historial de incidentes",
      },
      categories: {
        agent: "Agente",
      ...
      dispositions: {
        needs_user: "Te necesita a ti",
        handling: "OpenClaw está gestionando",
        watching: "Vigilando",
        historical: "Histórico",
      },
    },
    footer: "Solo monitorización determinista. Sin llamadas al modelo ni mutaciones automáticas.",
  },
  tabs: {
    agents: "Agentes",
    activity: "Actividad",
    overview: "Resumen",
    operations: "Sala de operaciones",
  ...
  subtitles: {
    ...
    operations: "Agentes, flujos de trabajo, capacidades, modelos y recursos de un vistazo.",
  ...
  workboard: {
    ...
    dispatch: "Despachar trabajo listo",
    dispatchSummary:
  ...
  chat: {
    ...
    prepareVerifiedUpdate: "Preparar actualización verificada",
    preparingVerifiedUpdate: "Preparando actualización verificada…",
    installVerifiedUpdate: "Instalar actualización verificada",
    exactShaApprovalRequired: "Se requiere aprobación del SHA exacto",
    updateProtectionIncomplete: "La protección de actualizaciones requiere atención.",
    ...
    modelPicker: {
      ...
      unavailable: "No disponible — elija otro modelo",
      contentionWarning: "Utilizado por otra agente activa — puede ser más lento",
    },
    pairingQrExpired: {
