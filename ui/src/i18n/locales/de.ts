...
export const de: TranslationMap = {
  ...
  operationsRoom: {
    ...
    subtitle: "Was Aufmerksamkeit erfordert, was funktioniert und wie der Systemstatus ist.",
    refresh: "Aktualisieren",
    refreshing: "Wird aktualisiert…",
    refreshLabel: "Operations Room aktualisieren",
    updated: "Aktualisiert {time}",
    live: "Live",
    stale: "Letzte bekannte Daten",
    partial: "Teilweise Daten",
    unavailableTitle: "Betriebsdaten nicht verfügbar",
    actionFailedTitle: "Aktion nicht abgeschlossen",
    staleTitle: "Live-Aktualisierung fehlgeschlagen",
    staleDetail: "Anzeige des letzten erfolgreichen Snapshots von {time}.",
    unavailableSources: "Nicht verfügbare Quellen: {sources}.",
    fallbackSources: "Ausweichdatenquellen: {sources}.",
    loading: "Aktuelles Betriebsbild wird erstellt…",
    empty: "Es ist noch kein Betriebssnapshot verfügbar.",
    now: "Jetzt",
    briefingUnavailable:
      "Die aktuelle Übersicht kann nicht bestätigt werden. Überprüfen Sie den quellenspezifischen Status unten.",
    lastKnownBriefing: "Letzte bekannte Übersicht anzeigen",
    briefingTone: {
      normal: "Aktuell",
    ...
    overallBriefingTone: {
      normal: "Gesamt: Auf dem neuesten Stand",
      attention: "Gesamt: Benötigt Aufmerksamkeit",
      urgent: "Gesamt: Dringend",
      unknown: "Gesamt: Status unbekannt",
    },
    overviewNav: "Betriebsübersicht",
    reviewCount: "{count} überprüfen",
    reviewUnconfirmed: "Überprüfen —",
    decisionCount: "{count} Entscheidungen erforderlich",
    decisionsUnconfirmed: "Entscheidungen erforderlich —",
    workingCount: "Aktiv {count}",
    workingCountBounded: "Aktiv {count}+",
    ...
    activeAgentsCount: "Aktive Agenten: {count}",
    workingItemsCount: "Aktive Aufgaben: {count}",
    showingAgents: "{count} anzeigen",
    attentionAgentsCount: "{count} benötigen Aufmerksamkeit",
    agentStatusSummary: "{working} aktiv · {attention} benötigen Aufmerksamkeit",
    automationCount: "Zeitpläne: {total} · Fehlerhaft: {failing}",
    automations: "Automatisierungen",
    system: "System",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "Muss überprüft werden",
      title: "Achtung",
      subtitle: "Aktuelle Probleme zuerst. Historische Ereignisse bleiben in Mehr.",
      needsYou: "Benötigt Sie",
      handling: "OpenClaw bearbeitet",
      watching: "Beobachtung",
      none: "Nichts benötigt Ihre Aufmerksamkeit.",
      noCritical: "Kein kritisches Problem ist aktiv.",
      currentCount: "{count} aktuell",
      noneNeedsYou: "Es wartet keine Entscheidung oder Intervention auf Sie.",
      noneHandling: "Keine aktive Behebung ist im Gange.",
      noneWatching: "Nichts wird beobachtet.",
      impact: "Auswirkung",
      ...
      highestPriority: "Problem mit höchster Priorität",
      whoOwnsThis: "Wer ist dafür verantwortlich",
      whatHappensNext: "Was passiert als Nächstes",
      continueMonitoring: "Überwachung fortsetzen.",
      observed: "{time} beobachtet",
      lastKnown: "Zuletzt bekannt",
      unconfirmedTitle: "Achtungsstatus kann nicht bestätigt werden",
      unconfirmedDetail:
        "Bekannte Probleme werden unten angezeigt, jedoch können unvollständige oder veraltete Daten neuere Probleme übersehen.",
      unconfirmedShort: "Bestätigung erforderlich",
      showingCurrent:
        "Es werden {shown} von {total} aktuellen Problemen in diesem begrenzten Snapshot angezeigt. Die Quellansichten bieten verwandte Datensätze.",
      outsidePreview:
        "{count} aktuelle Probleme liegen außerhalb dieser Vorschau. Öffnen Sie oben eine Quellansicht.",
      lastProgress: "Letzter Fortschritt",
      nextCheck: "Nächste Überprüfung",
      remediationTask: "Behebungsaufgabe",
      openRemediation: "Behebung öffnen",
      responseStates: {
        unassigned: "Nicht zugewiesen",
        in_progress: "In Bearbeitung",
        monitoring: "Überwachung",
        waiting_for_user: "Warten auf Sie",
        resolved: "Gelöst",
      },
    },
    resolution: {
      ...
      judgeReview: "Unabhängige Sicherheitsüberprüfung: {decision} — {reason}",
      approved: "Genehmigt",
      rejected: "Abgelehnt",
      rollback: "Rollback-Plan",
      undoAvailability: "Verfügbarkeit von Rückgängig",
      undoAvailable: "Über eine geschützte Vorschau verfügbar",
      undoUnavailable: "Kein direktes Rückgängigmachen verfügbar",
      viewRepairDetails: "Reparaturdetails anzeigen",
      result: "Ergebnis",
      undo: "Diese Reparatur rückgängig machen",
    ...
    working: {
      ...
      countsUnconfirmed: "Anzahlen können nicht bestätigt werden",
      itemsCount: "{count} aktive Elemente",
      itemsCountBounded: "Mindestens {count} aktive Elemente",
      showingPreview:
        "Anzeige von {shown} aktuellen Arbeitszusammenfassungen. Das Workboard enthält verwaltete Aufgaben- und Workflowdatensätze.",
      openWorkboard: "Workboard öffnen",
      details: "Arbeitsdetails",
      relatedRuns: "{count} zugehörige Ausführungen",
      workTotals: "Aufgaben- und Workflowgesamtwerte",
      tasks: "Aufgaben",
      taskTotals: "Aktiv: {active} · Benötigt Aufmerksamkeit: {failed} · Gesamt: {total}",
      workflows: "Workflows",
      workflowTotals: "Aktiv: {active} · Gesamt: {total}",
    },
    activityComparison: {
      eyebrow: "Aktivität jetzt",
      title: "Was läuft gerade",
      subtitle: "Zwei verschiedene Signale, gemeinsam dargestellt.",
      openClawLabel: "Von OpenClaw verwaltete Arbeit",
      openClawCountOne: "1 arbeitender Agent",
      openClawCount: "{count} arbeitende Agenten",
      openClawDetail: "Aufgaben und Workflows, die OpenClaw aktiv verwaltet.",
      localAiLabel: "Unabhängige lokale KI",
      localAiCountOne: "1 Modellprozess geladen",
      localAiCount: "{count} Modellprozesse geladen",
      localAiDetail:
        "Auf diesem Mac geladene Modelle. Ein geladener Prozess bedeutet nicht zwangsläufig, dass er gerade generiert.",
      unconfirmed: "Kann nicht bestätigt werden",
    },
    ownerAcceptance: {
      ...
      activityQuestion: "Was läuft gerade?",
      activityAnswer: "OpenClaw: {openClaw} · Lokale KI: {localAi}",
      issueQuestion:
        "Wer ist für das Problem mit der höchsten Priorität verantwortlich und was passiert als Nächstes?",
      ...
      elapsed: "In {seconds} Sekunden abgeschlossen.",
      copyReceipt: "Quittung kopieren",
      copied: "Quittung kopiert",
      copyFailed: "Kopieren nicht verfügbar. Verwenden Sie stattdessen Quittung herunterladen.",
      downloadReceipt: "Quittung herunterladen",
    },
    changes: {
      eyebrow: "Neueste Änderungen",
      title: "Seit Ihrem letzten Besuch",
      none: "Keine wesentlichen Änderungen seit Ihrem letzten Besuch.",
      unconfirmed:
        "Neueste Änderungen können erst bestätigt werden, wenn ihre Datenquellen wiederhergestellt sind.",
      firstVisit: "Neueste wesentliche Änderungen",
      incidentResolved: "Problem behoben",
      incidentChanged: "Problem geändert",
      showingNewest:
        "Anzeige der {count} neuesten Änderungen. Öffnen Sie den verfügbaren Verlauf für weitere Details.",
      openActivity: "Verfügbaren Verlauf öffnen",
      activitySummaryOne: "1 zugehöriger {runtime}-Lauf {result}.",
      activitySummary: "{count} zugehörige {runtime}-Läufe {result}.",
      outcomes: {
        working: "läuft noch",
        ...
        unknown: "endete mit einem unbekannten Ergebnis",
      },
      remediationOutcomes: {
        completed: "OpenClaw hat dieses Problem behoben und überprüft",
        rolled_back:
          "OpenClaw hat eine nicht verifizierte Reparatur automatisch rückgängig gemacht",
        failed: "Automatische Reparatur wurde gestoppt und muss überprüft werden",
        approval_required: "OpenClaw wurde angehalten und hat um Genehmigung gebeten",
      },
    },
    agents: {
      eyebrow: "Live-Raum",
      title: "Agenten",
      subtitle: "Operative Priorität zuerst. Bereitschaftsagenten bleiben eingeklappt.",
      searchLabel: "Agenten durchsuchen",
      searchPlaceholder: "Agenten durchsuchen",
      sortLabel: "Agenten sortieren",
      sortPriority: "Priorität",
      sortName: "Name",
      sortRecent: "Letzte Aktivität",
      noMatches: "Keine Agenten entsprechen dieser Suche.",
      noShownMatches:
        "Keine angezeigten Agenten entsprechen. Durchsuchen Sie die vollständige Agentenansicht.",
      searchResultCount: "{count} passende Agenten angezeigt.",
      searchResultCountBounded:
        "{count} passende angezeigte Agenten. Die vollständige Agentenansicht kann weitere enthalten.",
      unconfirmed:
        "Agent-Aktivität kann nicht bestätigt werden, bis die Datenquelle wiederhergestellt ist.",
      unconfirmedShort: "Aktivität nicht verifiziert",
      showing:
        "{shown} von {total} Agents anzeigen. Dringende und aktive Agents werden zuerst angezeigt.",
      openAll: "Alle Agents öffnen",
      urgent: "Dringend",
      attention: "Benötigt Aufmerksamkeit",
      working: "Arbeitsbereit",
      waiting: "Wartend oder geplant",
      recent: "Kürzlich geändert",
      ready: "Bereit",
      off: "Ausgeschaltet oder unbekannt",
      pin: "{name} anheften",
      unpin: "{name} lösen",
      pinned: "Angeheftet",
      openAgent: "Agent öffnen",
      reviewIssue: "Problem überprüfen",
      whatNeedsAttention: "Was benötigt Aufmerksamkeit",
      blockedTaskNeedsDecision:
        "{count} blockierte Aufgabe erfordert Ihre Entscheidung. Überprüfen Sie das Problem, bevor Sie den Agenten ändern.",
      blockedTasksNeedDecision:
        "{count} blockierte Aufgaben erfordern Ihre Entscheidung. Überprüfen Sie die Probleme, bevor Sie den Agenten ändern.",
      urgentIssueNeedsDecision: "Ein dringendes Problem erfordert Ihre Entscheidung.",
      issueBeingHandled: "OpenClaw bearbeitet ein Problem für diesen Agenten.",
      issueBeingWatched: "Ein Problem für diesen Agenten wird überwacht.",
      technicalDetails: "Technische Details",
      duty: "Dienst",
      currentWork: "Aktuelle Arbeit",
      lastActivity: "Letzte Aktivität",
      taskCounts: "Aufgaben",
      taskCountSummary: "Aktiv: {active} · Blockiert: {blocked}",
      model: "Modell",
      fallback: "Ausweichlösung",
      heartbeat: "Herzschlag",
      ram: "RAM",
      inheritedDefault: "Vererbter Standardwert",
      noFallback: "Kein expliziter Fallback",
      readyForWork: "Arbeitsbereit",
      noCurrentWork: "Keine",
      unavailableRam: "Nicht zurechenbar",
      browserLocalPins: "Anker werden in diesem Browser gespeichert.",
    },
    systemHealth: {
      eyebrow: "System",
      ...
      agentRamNote:
        "Der RAM pro Agent ist nicht verfügbar, wenn Agents den Gateway-Prozess teilen.",
    },
    automationsPanel: {
      eyebrow: "Automatisierungen",
      title: "Geplante Aufgaben",
      none: "Keine geplanten Aufgaben konfiguriert.",
      unconfirmed:
        "Geplante Aufgaben können nicht bestätigt werden, bis die Datenquelle wiederhergestellt ist.",
      openCron: "Cron-Jobs öffnen",
      showing:
        "{shown} von {total} angezeigt. Cron-Jobs öffnen, um alle geplanten Aufgaben zu überprüfen.",
      dueNow: "Fällig jetzt",
    ...
    more: {
      title: "Weitere Operationsdetails",
      subtitle: "Verlauf, Workflows, Zeitpläne, Fähigkeiten, Modelle und Host-Prozesse.",
      recentHistory: "Letzte Aktivitäten",
      workflows: "Workflows",
      capabilities: "Skills, Plugins, Tools und Modelle",
      processes: "Größte RAM-Verbraucher",
      argumentsPrivate: "Argumente werden niemals gesammelt.",
      processRowsRejectedOne: "1 Prozesszeile konnte nicht gelesen und wurde ausgeschlossen.",
      processRowsRejected: "{count} Prozesszeilen konnten nicht gelesen und wurden ausgeschlossen.",
      processesShowing:
        "Es werden die {shown} größten von {total} akzeptierten Prozessen angezeigt.",
      configuredActive: "Konfiguriert und aktiv werden separat angezeigt.",
      configured: "Konfiguriert",
      notConfigured: "Nicht konfiguriert",
      active: "Aktiv",
      inactive: "Inaktiv",
      activityUnverified: "Aktivität nicht verifiziert",
      catalogUnavailable:
        "Dieser Katalog kann erst bestätigt werden, wenn seine Datenquelle wiederhergestellt ist.",
      catalogShowing: "Es werden {shown} von {total} angezeigt",
      shadowMode: "Shadow-Modus · keine automatischen Änderungen",
      catalogued: "{count} katalogisiert",
      available: "{count} verfügbar",
      needsSetup: "{count} müssen eingerichtet werden",
      availabilityUnverified: "Verfügbarkeit nicht verifiziert",
      noHistory: "Kein aktueller Verlauf aufgezeichnet.",
      noActivityHistory: "In diesem Snapshot ist keine Task-Aktivität aufgezeichnet.",
      activityHistoryUnavailable:
        "Task-Aktivitäten können aus diesem Snapshot nicht bestätigt werden.",
      activityHistory: "Task-Aktivität",
      activityCount: "Aktivitätsgruppen: {count}",
      incidentHistory: "Vorfallverlauf",
      incidentCount: "Vorfalldatensätze: {count}",
      historyUnavailable: "Vorfallsdetails sind in diesem Snapshot nicht verfügbar.",
      changed: "Geändert {time}",
      transitionCount: "Schweregradübergänge: {count}",
      historyOverflow:
        "{count} ältere Vorfälle liegen außerhalb des gespeicherten Verlaufszeitraums.",
      historySnapshotBounded: "Dieser Snapshot enthält {shown} von {total} Vorfalldatensätzen.",
      activitySnapshotBounded: "Snapshot-Abdeckung: {shown} von {total} Aktivitätsgruppen.",
      monitorIssue: "Der Hintergrundmonitor hat ein Problem gemeldet",
      monitorStatus:
        "Monitor: letzter Versuch {attempt}; letzte erfolgreiche Überprüfung {success}.",
      noWorkflows: "Keine verwalteten Workflows aufgezeichnet.",
      noProcesses: "Details zu Prozessressourcen sind nicht verfügbar.",
      processesUnavailable: "Prozessinventar kann aus diesem Snapshot nicht bestätigt werden.",
      processesOmitted: "Das Prozessinventar war in diesem Snapshot nicht enthalten.",
      historySummary: "Historische Ergebnisse: {findings} · Vorfalldatensätze: {incidents}",
      workflowSummary: "{total} gesamt · {active} aktiv",
      showing: "{shown} anzeigen",
      skills: "Skills",
      plugins: "Plugins",
      tools: "Tools",
      models: "Modelle",
    ...
    actions: {
      details: "Details",
      detailsFor: "Details für {title}",
      cancel: "Abbrechen",
      cancelWork: "{title} abbrechen",
      cancelWorkflow: "Workflow abbrechen",
      runSchedule: "{title} jetzt ausführen",
      pauseSchedule: "{title} pausieren",
      enableSchedule: "{title} aktivieren",
      unavailable:
        "Steuerungselemente sind nicht verfügbar, bis diese Daten aktuell und vollständig sind.",
      cancelled: "Aktion abgebrochen. Es wurde nichts geändert.",
      confirm:
        "{summary}\n\nRisiko: {risk}\n\nDiese geschützte Aktion läuft um {expires} ab. Fortfahren?",
      risks: {
        low: "Niedrig",
        medium: "Mittel",
        high: "Hoch",
    ...
    counts: {
      exact: "{count}",
      shown: "Zeige {shown} von {total}",
      compactShown: "{shown} von {total}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "Modelle",
        processes: "Prozesse",
        eventLoop: "Gateway-Antwortzeit",
        monitor: "Betriebsmonitor",
        incidentLedger: "Vorfallverlauf",
      },
      categories: {
        agent: "Agent",
        workflow: "Workflow",
      ...
      dispositions: {
        needs_user: "Benötigt Sie",
        handling: "OpenClaw bearbeitet",
        watching: "Beobachtung",
        historical: "Historisch",
      },
    },
    footer: "Nur deterministische Überwachung. Keine Modellaufrufe oder automatische Mutationen.",
  },
  tabs: {
    agents: "Agenten",
    activity: "Aktivität",
    overview: "Übersicht",
    operations: "Operationszentrale",
  ...
  subtitles: {
    ...
    operations: "Agenten, Arbeitsabläufe, Funktionen, Modelle und Ressourcen auf einen Blick.",
  ...
  chat: {
    ...
    prepareVerifiedUpdate: "Verifiziertes Update vorbereiten",
    preparingVerifiedUpdate: "Verifiziertes Update wird vorbereitet…",
    installVerifiedUpdate: "Verifiziertes Update installieren",
    exactShaApprovalRequired: "Freigabe der exakten SHA erforderlich",
    updateProtectionIncomplete: "Der Update-Schutz erfordert Aufmerksamkeit.",
    ...
    modelPicker: {
      ...
      unavailable: "Nicht verfügbar – wählen Sie ein anderes Modell aus",
      contentionWarning: "Wird von einem anderen aktiven Agenten verwendet – kann langsamer sein",
    },
    pairingQrExpired: {
