...
export const en: TranslationMap = {
  ...
  operationsRoom: {
    ...
    resolution: {
      ...
      previewOnlyDetail: "Nothing has changed.",
      closePreview: "Close preview — make no changes",
    ...
    ownerAcceptance: {
      ...
      subtitle:
        "The timer starts only when you click Begin. Read the screen, choose the answers, preview the highest-priority resolution, then close it without changes.",
      ...
      resolveQuestion: "Preview the highest-priority resolution, then close it without changes.",
      resolvePending: "Not completed yet",
      resolveDone: "Preview opened and safely closed",
