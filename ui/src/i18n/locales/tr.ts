...
export const tr: TranslationMap = {
  ...
  operationsRoom: {
    eyebrow: "OpenClaw kontrol düzlemi",
    title: "Operasyonlar Odası",
    subtitle: "Dikkat gerektirenler, çalışanlar ve sistemin durumu.",
    refresh: "Yenile",
    refreshing: "Yenileniyor…",
    refreshLabel: "Operasyonlar Odasını Yenile",
    updated: "Güncellendi {time}",
    live: "Canlı",
    stale: "Son bilinen",
    partial: "Kısmi veri",
    unavailableTitle: "Operasyon verileri kullanılamıyor",
    actionFailedTitle: "Eylem tamamlanmadı",
    staleTitle: "Canlı güncelleme başarısız oldu",
    staleDetail: "{time} tarihindeki son başarılı anlık görüntü gösteriliyor.",
    unavailableSources: "Kullanılamayan kaynaklar: {sources}.",
    fallbackSources: "Yedek veri kaynakları: {sources}.",
    loading: "Mevcut operasyon durumu oluşturuluyor…",
    empty: "Henüz bir operasyon anlık görüntüsü mevcut değil.",
    now: "Şimdi",
    briefingUnavailable:
      "Mevcut genel bakış doğrulanamıyor. Aşağıdaki kaynak özel durumlarını inceleyin.",
    lastKnownBriefing: "Son bilinen genel bakışı göster",
    briefingTone: {
      normal: "Güncel",
    ...
    overallBriefingTone: {
      normal: "Genel: Güncel",
      attention: "Genel: Dikkat gerektiriyor",
      urgent: "Genel: Acil",
      unknown: "Genel: Durum bilinmiyor",
    },
    overviewNav: "Operasyon genel bakışı",
    reviewCount: "{count} incele",
    reviewUnconfirmed: "İncele —",
    decisionCount: "{count} karar gerekli",
    decisionsUnconfirmed: "Karar gerekli —",
    workingCount: "Şimdi çalışıyor {count}",
    workingCountBounded: "Şimdi çalışıyor {count}+",
    workingUnconfirmed: "Şimdi çalışıyor —",
    agentsWorkingNowCount: "Şu anda çalışan ajanlar {count}",
    agentsWorkingUnconfirmed: "Şu anda çalışan ajanlar —",
    openClawWorkCount: "{count} OpenClaw işi",
    openClawWorkUnconfirmed: "OpenClaw işi —",
    allAgentsCount: "Tüm ajanlar {count}",
    agentsUnconfirmed: "Tüm ajanlar —",
    agentsCount: "{count} ajan",
    urgentCount: "{count} acil",
    activeAgentsCount: "Aktif ajanlar: {count}",
    workingItemsCount: "Çalışılan öğeler: {count}",
    showingAgents: "{count} gösteriliyor",
    attentionAgentsCount: "{count} dikkat gerektiriyor",
    agentStatusSummary: "{working} çalışıyor · {attention} dikkat gerektiriyor",
    automationCount: "Zamanlamalar: {total} · Başarısız: {failing}",
    automations: "Otomasyonlar",
    system: "Sistem",
    openClaw: "OpenClaw",
    attention: {
      eyebrow: "İnceleme gerekiyor",
      title: "Dikkat",
      subtitle: "Mevcut sorunlar önce gelir. Geçmiş olaylar Daha Fazla bölümünde kalır.",
      needsYou: "Sizin müdahaleniz gerekiyor",
      handling: "OpenClaw hallediyor",
      watching: "Gözlemleniyor",
      none: "Dikkatinizi gerektiren bir şey yok.",
      noCritical: "Aktif kritik bir sorun yok.",
      currentCount: "{count} mevcut",
      noneNeedsYou: "Karar veya müdahale bekleyen bir durum yok.",
      noneHandling: "Devam eden aktif bir iyileştirme işlemi yok.",
      noneWatching: "Gözlemlenen bir şey yok.",
      impact: "Etki",
      owner: "Sorumlu",
      you: "Siz",
      unassignedOwner: "Atanmamış",
      response: "Yanıt",
      nextAction: "Sonraki işlem",
      nextActionShort: "Sonraki",
      highestPriority: "En yüksek öncelikli sorun",
      whoOwnsThis: "Bu sorundan kim sorumlu",
      whatHappensNext: "Sırada ne var",
      continueMonitoring: "İzlemeye devam edin.",
      observed: "{time} tarihinde gözlemlendi",
      lastKnown: "Son bilinen",
      unconfirmedTitle: "Dikkat durumu doğrulanamıyor",
      unconfirmedDetail:
        "Bilinen sorunlar aşağıda gösterilmektedir, ancak eksik veya son bilinen veriler daha yeni sorunları içermeyebilir.",
      unconfirmedShort: "Doğrulama gerekiyor",
      showingCurrent:
        "Bu sınırlı anlık görüntüdeki {total} güncel sorundan {shown} tanesi gösteriliyor. Kaynak görünümler ilgili kayıtları sağlar.",
      outsidePreview:
        "{count} güncel sorun bu önizlemenin dışında. Yukarıda bir kaynak görünüm açın.",
      lastProgress: "Son ilerleme",
      nextCheck: "Sonraki kontrol",
      remediationTask: "Giderme görevi",
      openRemediation: "Gidermeyi aç",
      responseStates: {
        unassigned: "Atanmamış",
        in_progress: "Devam ediyor",
        monitoring: "İzleniyor",
        waiting_for_user: "Sizin için bekliyor",
        resolved: "Çözüldü",
      },
    },
    resolution: {
      ...
      judgeReview: "Bağımsız güvenlik incelemesi: {decision} — {reason}",
      approved: "Onaylandı",
      rejected: "Reddedildi",
      rollback: "Geri alma planı",
      undoAvailability: "Geri alma kullanılabilirliği",
      undoAvailable: "Korumalı önizleme aracılığıyla kullanılabilir",
      undoUnavailable: "Doğrudan Geri Alma mevcut değil",
      viewRepairDetails: "Onarım ayrıntılarını görüntüle",
      result: "Sonuç",
      undo: "Bu onarımı geri al",
      ...
      evidenceLocation:
        'İlerleme ve kanıtlar bu sorun, "Son ziyaretinizden beri" bölümü ve Workboard\'da görünecektir.',
      ...
      nextStepUnknown:
        "Güvenli bir sonraki adım doğrulanmadı. Herhangi bir değişiklik yapmadan önce inceleyin.",
      stages: {
        needs_review: "İnceleme gerekiyor",
        openclaw_handling: "OpenClaw bunu hallediyor",
        watching: "OpenClaw bunu izliyor",
        resolved: "Çözüldü",
      },
      risks: {
        low: "Düşük",
    ...
    working: {
      ...
      title: "Şu anda çalışılıyor",
      subtitle:
        "Sadece OpenClaw tarafından yönetilen görevler ve iş akışları. Yerel AI işlemleri Sistem altında görünür.",
      none: "Şu anda aktif olarak çalışan bir OpenClaw aracı yok.",
      unconfirmed: "Veri kaynakları kurtarılmadan önceki mevcut iş doğrulanamaz.",
      unverified: "Mevcut iş doğrulanmadı",
      countsUnconfirmed: "Sayılar doğrulanamıyor",
      itemsCount: "{count} çalışan öğe",
      itemsCountBounded: "En az {count} çalışan öğe",
      showingPreview:
        "Son {shown} çalışma özeti gösteriliyor. Çalışma panosu yönetilen görev ve iş akışı kayıtlarını içerir.",
      openWorkboard: "Çalışma Panosunu Aç",
      details: "Çalışma detayları",
      relatedRuns: "{count} ilgili çalıştırma",
      workTotals: "Görev ve iş akışı toplamları",
      tasks: "Görevler",
      taskTotals: "Aktif: {active} · Dikkat gerektiren: {failed} · Toplam: {total}",
      workflows: "İş Akışları",
      workflowTotals: "Aktif: {active} · Toplam: {total}",
    },
    activityComparison: {
      eyebrow: "Şu anki etkinlik",
      title: "Çalışanlar",
      subtitle: "Birlikte gösterilen iki farklı sinyal.",
      openClawLabel: "OpenClaw tarafından yönetilen işler",
      openClawCountOne: "1 çalışan ajan",
      openClawCount: "{count} çalışan ajan",
      openClawDetail: "OpenClaw'ın aktif olarak yönettiği görevler ve iş akışları.",
      localAiLabel: "Bağımsız yerel AI",
      localAiCountOne: "1 model işlemi yüklü",
      localAiCount: "{count} model işlemi yüklü",
      localAiDetail:
        "Bu Mac'te yüklenen modeller. Yüklü bir işlemin şu anda içerik ürettiği anlamına gelmeyebilir.",
      unconfirmed: "Doğrulanamıyor",
    },
    ownerAcceptance: {
      eyebrow: "Sahip onayı",
      ...
      activityQuestion: "Şu anda ne çalışıyor?",
      activityAnswer: "OpenClaw: {openClaw} · Yerel AI: {localAi}",
      ...
      elapsed: "{seconds} saniye içinde tamamlandı.",
      copyReceipt: "Makbuzu kopyala",
      copied: "Makbuz kopyalandı",
      copyFailed: "Kopyalama kullanılamadı. Bunun yerine Makbuzu indir'i kullanın.",
      downloadReceipt: "Makbuzu indir",
    },
    changes: {
      eyebrow: "Son değişiklikler",
      title: "Son ziyaretinizden beri",
      none: "Son ziyaretinizden beri anlamlı bir değişiklik yok.",
      unconfirmed: "Veri kaynakları kurtarılmadan önce son değişiklikler doğrulanamaz.",
      firstVisit: "Son anlamlı değişiklikler",
      incidentResolved: "Sorun çözüldü",
      incidentChanged: "Sorun değişti",
      showingNewest:
        "En yeni {count} değişiklik gösteriliyor. Daha fazla detay için mevcut geçmişi açın.",
      openActivity: "Mevcut geçmişi aç",
      activitySummaryOne: "1 ilgili {runtime} çalıştırma {result}.",
      activitySummary: "{count} ilgili {runtime} çalıştırma {result}.",
      outcomes: {
        working: "hala çalışıyor",
        succeeded: "tamamlandı",
        blocked: "engellendi",
        failed: "başarısız oldu",
        cancelled: "iptal edildi",
        unknown: "bilinmeyen bir sonuçla sona erdi",
      },
      remediationOutcomes: {
        completed: "OpenClaw bu sorunu onardı ve doğruladı",
        rolled_back: "OpenClaw doğrulanmayan bir onarımı otomatik olarak geri aldı",
        failed: "Otomatik onarım durdu ve gözden geçirilmeye ihtiyaç duyuyor",
        approval_required: "OpenClaw durdu ve onay talep etti",
      },
    },
    agents: {
      eyebrow: "Canlı oda",
      title: "Ajanlar",
      subtitle: "İşlemsel öncelik ilk sırada. Hazır ajanlar daraltılmış durumda kalır.",
      searchLabel: "Ajanları ara",
      searchPlaceholder: "Ajanları ara",
      sortLabel: "Ajanları sırala",
      sortPriority: "Öncelik",
      sortName: "Ad",
      sortRecent: "Son etkinlik",
      noMatches: "Bu aramaya uyan ajan yok.",
      noShownMatches: "Görüntülenen ajanlar arasında eşleşme yok. Tam Ajanlar görünümünü arayın.",
      searchResultCount: "{count} eşleşen ajan görüntüleniyor.",
      searchResultCountBounded:
        "{count} eşleşen görüntülenen ajan. Tam Ajanlar görünümü daha fazlasını içerebilir.",
      unconfirmed: "Veri kaynağı kurtarılmadan aracı etkinliği doğrulanamaz.",
      unconfirmedShort: "Etkinlik doğrulanmadı",
      showing: "{total} aracının {shown}'ü gösteriliyor. Acil ve aktif araçlar önce görünür.",
      openAll: "Tüm araçları aç",
      urgent: "Acil",
      attention: "Dikkat gerektiriyor",
      working: "Çalışıyor",
      waiting: "Bekliyor veya planlanmış",
      recent: "Son değiştirilenler",
      ready: "Hazır",
      off: "Kapalı veya bilinmiyor",
      pin: "{name} sabitle",
      unpin: "{name} sabitlemesini kaldır",
      pinned: "Sabitlenmiş",
      openAgent: "Aracı aç",
      reviewIssue: "Sorunu incele",
      whatNeedsAttention: "Ne dikkat gerektiriyor",
      blockedTaskNeedsDecision:
        "{count} engellenmiş görev kararınızı bekliyor. Ajanı değiştirmeden önce sorunu inceleyin.",
      blockedTasksNeedDecision:
        "{count} engellenmiş görev kararınızı bekliyor. Ajanı değiştirmeden önce sorunları inceleyin.",
      urgentIssueNeedsDecision: "Acil bir sorun kararınızı bekliyor.",
      issueBeingHandled: "OpenClaw, bu ajan için bir sorunu hallediyor.",
      issueBeingWatched: "Bu ajan için bir sorun izleniyor.",
      technicalDetails: "Teknik ayrıntılar",
      duty: "Görev",
      currentWork: "Mevcut iş",
      lastActivity: "Son etkinlik",
      taskCounts: "Görevler",
      taskCountSummary: "Aktif: {active} · Engellenmiş: {blocked}",
      model: "Model",
      fallback: "Yedek",
      heartbeat: "Kalp atışı",
      ram: "RAM",
      inheritedDefault: "Devralınan varsayılan",
      noFallback: "Açık bir yedek yok",
      readyForWork: "Çalışmaya hazır",
      noCurrentWork: "Yok",
      unavailableRam: "Atfedilemeyen",
      browserLocalPins: "Sabitlemeler bu tarayıcıda kaydedilir.",
    },
    systemHealth: {
      eyebrow: "Sistem",
      title: "Mac sağlığı",
      normal: "Normal",
      memory: "Bellek kapasitesi",
      memoryInUse: "%{percent} baskı altında",
      memoryAvailable: "%{percent} kullanılabilir",
      memorySummary: "%{percent} bellek",
      memoryAndLocalAiSummary: "%{percent} bellek · Yerel AI işlemleri: {count}",
      ...
      memoryBreakdown: "{available} kullanılabilir · {free} hemen boş · {total} toplam",
      memoryPressureNote:
    ...
    automationsPanel: {
      ...
      none: "Hiçbir zamanlanmış iş yapılandırılmamış.",
      unconfirmed: "Veri kaynağı kurtarılmadan zamanlanmış işler doğrulanamaz.",
      openCron: "Cron İşlerini Aç",
      showing:
        "{total} içinde {shown} gösteriliyor. Tüm zamanlanmış işleri incelemek için Cron İşlerini açın.",
      dueNow: "Şimdi vadesi doluyor",
      noNextRun: "Sonraki çalıştırma yok",
      runNow: "Şimdi çalıştır",
      pause: "Duraklat",
      enable: "Etkinleştir",
    },
    more: {
      title: "Daha fazla işlemler detayı",
      subtitle:
        "Geçmiş, iş akışları, zamanlamalar, yetenekler, modeller ve ana bilgisayar işlemleri.",
      recentHistory: "Son geçmiş",
      workflows: "İş akışları",
      capabilities: "Beceriler, eklentiler, araçlar ve modeller",
      processes: "En yüksek RAM tüketicileri",
      argumentsPrivate: "Argümanlar asla toplanmaz.",
      processRowsRejectedOne: "1 işlem satırı okunamadı ve dışlandı.",
      processRowsRejected: "{count} işlem satırı okunamadı ve dışlandı.",
      processesShowing: "{total} kabul edilen işlemden en büyük {shown} tanesi gösteriliyor.",
      configuredActive: "Yapılandırılmış ve aktif durumlar ayrı ayrı gösterilir.",
      configured: "Yapılandırılmış",
      notConfigured: "Yapılandırılmamış",
      active: "Aktif",
      inactive: "Pasif",
      activityUnverified: "Etkinlik doğrulanmadı",
      catalogUnavailable: "Veri kaynağı kurtarılmadan bu katalog onaylanamaz.",
      catalogShowing: "{total} içinden {shown} gösteriliyor",
      shadowMode: "Gölge modu · otomatik değişiklik yok",
      catalogued: "{count} kataloglandı",
      available: "{count} mevcut",
      needsSetup: "{count} kurulum gerektiriyor",
      availabilityUnverified: "Mevcutluk doğrulanmadı",
      noHistory: "Son geçmiş kaydı yok.",
      noActivityHistory: "Bu anlık görüntüde görev etkinliği kaydedilmemiştir.",
      activityHistoryUnavailable: "Görev etkinliği bu anlık görüntüden doğrulanamıyor.",
      activityHistory: "Görev etkinliği",
      activityCount: "Etkinlik grupları: {count}",
      incidentHistory: "Olay geçmişi",
      incidentCount: "Olay kayıtları: {count}",
      historyUnavailable: "Olay ayrıntıları bu anlık görüntüde mevcut değil.",
      changed: "{time} tarihinde değiştirildi",
      transitionCount: "Ciddiyet geçişleri: {count}",
      historyOverflow: "{count} eski olay, tutulan geçmiş penceresinin dışında.",
      historySnapshotBounded: "Bu anlık görüntü, {total} olay kaydından {shown}'sünü içeriyor.",
      activitySnapshotBounded: "Anlık görüntü kapsamı: {total} etkinlik grubundan {shown}.",
      monitorIssue: "Arka plan izleyicisi bir sorun bildirdi",
      monitorStatus: "İzleyici: son deneme {attempt}; son başarılı tarama {success}.",
      noWorkflows: "Yönetilen iş akışı kaydedilmemiş.",
      noProcesses: "Süreç kaynak ayrıntıları mevcut değil.",
      processesUnavailable: "Süreç envanteri bu anlık görüntüden doğrulanamıyor.",
      processesOmitted: "Süreç envanteri bu anlık görüntüye dahil edilmedi.",
      historySummary: "Tarihsel bulgular: {findings} · Olay kayıtları: {incidents}",
      workflowSummary: "{total} toplam · {active} aktif",
      showing: "{shown} gösteriliyor",
      skills: "Beceriler",
      plugins: "Eklentiler",
      tools: "Araçlar",
      models: "Modeller",
      noSkills: "Hiç beceri bulunamadı.",
      noPlugins: "Hiç eklenti bulunamadı.",
      noTools: "Hiç araç bulunamadı.",
      noModels: "Hiç model bulunamadı.",
    ...
    actions: {
      details: "Ayrıntılar",
      detailsFor: "{title} için ayrıntılar",
      cancel: "İptal",
      cancelWork: "{title} işlemini iptal et",
      cancelWorkflow: "İş akışını iptal et",
      runSchedule: "{title} planını şimdi çalıştır",
      pauseSchedule: "{title} planını duraklat",
      enableSchedule: "{title} planını etkinleştir",
      unavailable: "Bu veriler güncel ve eksiksiz olana kadar kontroller kullanılamaz.",
      cancelled: "İşlem iptal edildi. Hiçbir değişiklik yapılmadı.",
      confirm:
        "{summary}\n\nRisk: {risk}\n\nBu korumalı işlem {expires} tarihinde sona erer. Devam edilsin mi?",
      risks: {
        low: "Düşük",
        medium: "Orta",
        high: "Yüksek",
    ...
    counts: {
      exact: "{count}",
      shown: "{total} sonuçtan {shown} tanesi gösteriliyor",
      compactShown: "{total} sonuçtan {shown}",
      atLeast: "{count}+",
    },
    enums: {
      severity: {
      ...
      sources: {
        ...
        models: "Modeller",
        processes: "İşlemler",
        eventLoop: "Gateway yanıt verimi",
        monitor: "Operasyon izleyicisi",
        incidentLedger: "Olay geçmişi",
      },
      categories: {
        agent: "Aracı",
        workflow: "İş akışı",
      ...
      dispositions: {
        needs_user: "Sizin müdahaleniz gerekiyor",
        handling: "OpenClaw hallediyor",
        watching: "Gözlem altında",
        historical: "Geçmiş",
      },
    },
    footer: "Sadece deterministik izleme. Model çağrıları veya otomatik değişiklikler yapılmaz.",
  },
  tabs: {
    agents: "Aracılar",
    activity: "Etkinlik",
  ...
  subtitles: {
    ...
    operations: "Temsilciler, iş akışları, yetenekler, modeller ve kaynaklar tek bakışta.",
  ...
  chat: {
    ...
    prepareVerifiedUpdate: "Doğrulanmış güncellemeyi hazırla",
    preparingVerifiedUpdate: "Doğrulanmış güncelleme hazırlanıyor…",
    installVerifiedUpdate: "Doğrulanmış güncellemeyi yükle",
    exactShaApprovalRequired: "Tam SHA onayı gerekli",
    updateProtectionIncomplete: "Güncelleme koruması ilgilenilmesini gerektiriyor.",
