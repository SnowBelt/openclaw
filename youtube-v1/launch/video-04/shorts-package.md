# Pattern Lab Shorts Package: Video 04
...
- Hook: Detroit makes more sense when you stop with the skyline and start with the map.
- Proof visual: lost-neighborhood source ledger with one visible clue circled
...
- Proof visual: source, place, date, visible clue, meaning, and consequence columns from the lost-neighborhood source ledger
...
- Proof visual: accepted versus rejected rows in the lost-neighborhood source ledger
